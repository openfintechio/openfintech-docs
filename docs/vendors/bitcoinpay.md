...
: [EN]  Bitcoinpay.com (Confirmo LTD) is one of the fastest growing companies in Bitcoin commerce headquartered in London. BitcoinPay provides global and instantaneous payment gateway build on top of the peer-to-peer virtual currency Bitcoin.  
...
**Address:** 
street:  135 King's Street London United Kingdom  

...
# DalPay 
![dalpay](https://static.openfintech.io/vendors/dalpay/logo.svg?w=400&c=v0.59.26#w200)  
...
: [EN]  DalPay Internet Billing (dalpay.is) is a PCI Level 1 authorized processing gateway and payment service provider for a number of Internet merchants, including DalPay Retail. Registered ISO, IPSP, DSE and TPP with it's main office in Dalvik Iceland.  
...
**Links:** 
: website [http://www.dalpay.is](http://www.dalpay.is) 
 
**Contacts:** 
phone: +354 412 2600**Address:** 
street:  Postholf 76620 DalvíkIceland  
...
```
https://static.openfintech.io/vendors/dalpay/logo.svg?w=400&c=v0.59.26#w200
```  

### Icon 
 
![dalpay](https://static.openfintech.io/vendors/dalpay/icon.svg?w=278&c=v0.59.26#w100)  

```
https://static.openfintech.io/vendors/dalpay/icon.svg?w=278&c=v0.59.26#w100
```  

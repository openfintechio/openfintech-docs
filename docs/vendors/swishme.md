...
# Swish Payments Ltd 
![swishme](https://static.openfintech.io/vendors/swishme/logo.png?w=400&c=v0.59.26#w200)  
...
: [EN]  Swish Payments Ltd is a regulated Financial Institution licensed by the MFSA. We provide merchant account and card acquiring services to businesses of all sizes, from micro-merchants to large enterprises.  
...
```
https://static.openfintech.io/vendors/swishme/logo.png?w=400&c=v0.59.26#w200
```  

### Icon 
 
![swishme](https://static.openfintech.io/vendors/swishme/icon.png?w=278&c=v0.59.26#w100)  

```
https://static.openfintech.io/vendors/swishme/icon.png?w=278&c=v0.59.26#w100
```  

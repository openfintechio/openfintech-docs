...
# CoinGate 
![coingate](https://static.openfintech.io/vendors/coingate/logo.svg?w=400&c=v0.59.26#w200)  
...
: [EN]  Buy, Sell & Accept Bitcoin with CoinGate  
...
**Address:** 
street:  Ukmergės g. 315BLT-06306 VilniusLithuania  
...
```
https://static.openfintech.io/vendors/coingate/logo.svg?w=400&c=v0.59.26#w200
```  

### Icon 
 
![coingate](https://static.openfintech.io/vendors/coingate/icon.svg?w=278&c=v0.59.26#w100)  

```
https://static.openfintech.io/vendors/coingate/icon.svg?w=278&c=v0.59.26#w100
```  

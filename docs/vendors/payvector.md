...
# PayVector 
![payvector](https://static.openfintech.io/vendors/payvector/logo.svg?w=400&c=v0.59.26#w200)  
...
: [EN]  Used by more than 35,000 merchants worldwide PayVector is the proven solution for ‘card-not-present’ payments including e-Commerce, Telephone & Mail Order and Mobile. Unlike some of our competitors our track record is impeccable with a 100% reliability record since inception in 2007, meaning maximum uptime for your business.  
...
**Contacts:** 
email: hello@payvector.co.ukphone: 020 8819 3470**Address:** 
street:  4 Blake MewsTW9 3GA LondonUnited Kingdom  
...
```
https://static.openfintech.io/vendors/payvector/logo.svg?w=400&c=v0.59.26#w200
```  

### Icon 
 
![payvector](https://static.openfintech.io/vendors/payvector/icon.svg?w=278&c=v0.59.26#w100)  

```
https://static.openfintech.io/vendors/payvector/icon.svg?w=278&c=v0.59.26#w100
```  

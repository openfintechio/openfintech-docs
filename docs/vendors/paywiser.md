...
: [EN]  PayWiser system offers complete services to integrate card and mobile payments into webpages and mobile applications. It will be most used to collect payments over internet, SMS and telephone, both for single and recurring payments (subscriptions, memeberships...). Additionally there is available also virtual terminal for physical points of sales.   PayWiser covers complete service, from merchant acquiring, integration and implementation to payment processing. We cooperate with companies which want to offer their clienst something more and want to have partner relationship with payment system provider.   PayWiser supports payment with prepaid and postpaid versions of Visa and MasterCard, Moneta and Maestro.  
...
**Contacts:** 
email: info@paywiser.euphone: +38630704444**Address:** 
street:  Vrhovčeva 141000 LjubljanaSlovenia  

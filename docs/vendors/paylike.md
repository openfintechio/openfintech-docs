...
# Paylike 
![paylike](https://static.openfintech.io/vendors/paylike/logo.png?w=400&c=v0.59.26#w200)  
...
: [EN]  Paylike is a one-stop payment solution with a zero-hassle, instant setup process. Currently, we are targeting developers, SaaS companies and tech startups with a super elegant API for integration. Concurrently we are working on several shopping carts to expand to more regular webshops.  
...
**Contacts:** 
email: hello@paylike.iophone: +45 71 99 38 68**Address:** 
street:  Grønningen 5DK-8000 AarhusDenmark  
...
```
https://static.openfintech.io/vendors/paylike/logo.png?w=400&c=v0.59.26#w200
```  

### Icon 
 
![paylike](https://static.openfintech.io/vendors/paylike/icon.png?w=278&c=v0.59.26#w100)  

```
https://static.openfintech.io/vendors/paylike/icon.png?w=278&c=v0.59.26#w100
```  
...
```json
{
  ...
  "contacts":{
    "email":"hello@paylike.io",
    "phone":"+45 71 99 38 68"
  },
  "address":{
    "street":" Gr\u00f8nningen 5DK-8000 AarhusDenmark "
  },

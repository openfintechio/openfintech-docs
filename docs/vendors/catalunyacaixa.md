...
: [EN]  Founded in July 2010, CatalunyaCaixa is an enterprising bank with a project based on quality retail banking. It delivers personalised service in which all its customers have their own financial adviser. Closeness to its customers and a community approach are the two cornerstones of the operations of the bank, which has more than 7,200 employees and almost 1,200 branches throughout Spain, especially in Catalonia, Madrid and the Levante. CX has more than 4.1 million customers and over 76 billion in consolidated assets.  

...
# SlimPay 
![slimpay](https://static.openfintech.io/vendors/slimpay/logo.svg?w=400&c=v0.59.26#w200)  
...
: [EN]  SlimPay is a pioneering payment platform for repeat and recurring payments based on direct debit. The solution enables merchants to automate and digitalise the entire payment process, creating a frictionless online transaction journey for end customers, and a fast, secure route to collecting payments for businesses.   Services include: ·       Contract signing ·       Omnichannel mandate acquisition, hosting and management ·       Order preparation and transaction execution ·       R-Transaction management ·       Real time reporting   In addition, SlimPay also offers an innovative risk and fraud management tool, which assigns a safety score to each potential customer based on numerous criteria. After assigning the safety sc  
...
**Contacts:** 
email: info@slimpay.comphone: +33 (0)1 47 70 15 34**Address:** 
street:  10 rue du Faubourg Poissonnière75010 ParisFrance  
...
```
https://static.openfintech.io/vendors/slimpay/logo.svg?w=400&c=v0.59.26#w200
```  

### Icon 
 
![slimpay](https://static.openfintech.io/vendors/slimpay/icon.svg?w=278&c=v0.59.26#w100)  

```
https://static.openfintech.io/vendors/slimpay/icon.svg?w=278&c=v0.59.26#w100
```  
...
```json
{
  ...
  "contacts":{
    "email":"info@slimpay.com",
    "phone":"+33 (0)1 47 70 15 34"
  },
  "address":{
    "street":" 10 rue du Faubourg Poissonni\u00e8re75010 ParisFrance "
  },

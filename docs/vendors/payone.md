...
# PAYONE 
![payone](https://static.openfintech.io/vendors/payone/logo.png?w=400&c=v0.59.26#w200)  
...
: [EN]  PAYONE offers solutions (SaaS) to companies for the fully automated and comprehensive handling of all payments in e-commerce. The payment service provider is a company of the Savings Banks Finance Group and is approved as a payment institution by the Federal Financial Supervisory Authority. The range of services includes receiving and handling national and international payment types, cash and risk management and all financial services. Standardised interfaces and extensions allow for simple integration into existing e-commerce and IT systems with maximum security standards. PAYONE is one of the 50 fastest-growing technology companies in Germany and has more than 3000 e-commerce customers from a variety of sectors and countries. This list includes well-known companies such as Immonet, Globetrotter Ausrüstung, HD PLUS, Fujitsu, Zalando, Hawesko, Sony Music and Hallhuber. PAYONE has around 100 employees.  
...
**Contacts:** 
email: sales@payone.dephone: +49 431 25968-400fax: +49 431 25968-1400**Address:** 
street:  Fraunhoferstraße 2-424118 KielGermany  
...
```
https://static.openfintech.io/vendors/payone/logo.png?w=400&c=v0.59.26#w200
```  

### Icon 
 
![payone](https://static.openfintech.io/vendors/payone/icon.png?w=278&c=v0.59.26#w100)  

```
https://static.openfintech.io/vendors/payone/icon.png?w=278&c=v0.59.26#w100
```  

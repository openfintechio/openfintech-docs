...
: [EN]  Acceptance is the Lufthansa AirPlus brand for transaction management. Thanks to Lufthansa AirPlus’ many years of experience in the international payment industry, you and your customers are able to benefit from our state-of-the-art all-in-one solutions and our comprehensive card-settling service systems – one-stop solutions that provide the security of comprehensive credit card acceptance.     To process transactions we use reliable systems developed by Lufthansa AirPlus. Acceptance offers you reliable all-in-one solutions for your business: with Visa, MasterCard, JCB and many debit card systems, we offer you all the major one-stop payment systems. Since we accommodate a large variety of data formats, our electronic invoices can be processed automatically in virtually all accounting systems. Equally trouble-free, our settlement software can be integrated into cash register, back-office or enterprise resource planning systems.   

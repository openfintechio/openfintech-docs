...
# Worldpay 
![worldpay](https://static.openfintech.io/vendors/worldpay/logo.svg?w=400&c=v0.59.26#w200)  
...
: [EN]  Worldpay serves a diverse set of merchants across a variety of end-markets, sizes and geographies. On a typical day, we process approx. 31 million mobile, online and in-store transactions worldwide, offering access to 326 payment methods, in 126 currencies across 146 countries, supporting over 400,000 merchants across the world. We partner with innovative and fast-growing ecommerce businesses, including many of the world's most renowned and dynamic online brands.  
...
**Links:** 
: website [http://www.worldpay.com/global](http://www.worldpay.com/global) 
...
```
https://static.openfintech.io/vendors/worldpay/logo.svg?w=400&c=v0.59.26#w200
```  

### Icon 
 
![worldpay](https://static.openfintech.io/vendors/worldpay/icon.svg?w=278&c=v0.59.26#w100)  

```
https://static.openfintech.io/vendors/worldpay/icon.svg?w=278&c=v0.59.26#w100
```  

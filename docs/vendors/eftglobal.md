...
# EFT Global 
![eftglobal](https://static.openfintech.io/vendors/eftglobal/logo.svg?w=400&c=v0.59.26#w200)  
...
: [EN]  EFT Global develops, maintains and delivers global online electronic transaction processing technologies such as customised electronic payment and direct debit collection processing solutions with specialised user friendly customer reports. The company, through its solutions, enables businesses to accept and process single or recurring customer transactions from business bank accounts globally. The company offers verification services, which query a database of originators to safeguard acceptance, as well as offering clients the ability to query customer details for valid accounts and fund availability.  
...
**Contacts:** 
email: info@eftglobal.comphone: + 356 2713 1565 / +356 2759 3444**Address:** 
...
```
https://static.openfintech.io/vendors/eftglobal/logo.svg?w=400&c=v0.59.26#w200
```  

### Icon 
 
![eftglobal](https://static.openfintech.io/vendors/eftglobal/icon.svg?w=278&c=v0.59.26#w100)  

```
https://static.openfintech.io/vendors/eftglobal/icon.svg?w=278&c=v0.59.26#w100
```  

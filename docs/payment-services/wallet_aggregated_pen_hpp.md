...
![wallet_aggregated_pen_hpp](https://static.openfintech.io/payment_methods/wallet_aggregated_pen_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
1. **`channel`** 
	...
	Hint:  
	: [EN] Enter wallet channel (e.g. Plin, Yape) 
	: [RU] Введите канал кошелька (напр. Plin, Yape) 
	: [UK] Введіть канал гаманця (напр. Plin, Yape) 

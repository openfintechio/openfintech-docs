...
# OCBC Bank (Malaysia) (FPX), Malaysia (service) 
![ocbc_bank_fpx_myr_hpp](https://static.openfintech.io/payment_methods/ocbc_bank_fpx_myr_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Method:** `ocbc_bank_fpx` 
 [show -->](/payment-methods/ocbc_bank_fpx/) 

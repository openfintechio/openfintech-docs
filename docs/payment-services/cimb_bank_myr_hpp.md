...
![cimb_bank_myr_hpp](https://static.openfintech.io/payment_methods/cimb_bank_myr_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Amount limits:** from `0.01` to `2500000000` MYR 

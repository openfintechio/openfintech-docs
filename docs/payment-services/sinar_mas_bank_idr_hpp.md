...
![sinar_mas_bank_idr_hpp](https://static.openfintech.io/payment_methods/sinar_mas_bank_idr_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Method:** `sinar_mas_bank` 
 [show -->](/payment-methods/sinar_mas_bank/) 

...
![land_and_houses_bank_thb_hpp](https://static.openfintech.io/payment_methods/land_and_houses_bank_thb_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Method:** `land_and_houses_bank` 
 [show -->](/payment-methods/land_and_houses_bank/) 

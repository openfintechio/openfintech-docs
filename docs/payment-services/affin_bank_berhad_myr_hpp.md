...
![affin_bank_berhad_myr_hpp](https://static.openfintech.io/payment_methods/affin_bank_berhad_myr_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Method:** `affin_bank_berhad` 
 [show -->](/payment-methods/affin_bank_berhad/) 

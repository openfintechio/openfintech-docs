...
![laxmi_vilas_bank_inr_hpp](https://static.openfintech.io/payment_methods/laxmi_vilas_bank_inr_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Method:** `laxmi_vilas_bank` 
 [show -->](/payment-methods/laxmi_vilas_bank/) 

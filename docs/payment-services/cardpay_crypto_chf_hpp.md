...
![cardpay_crypto_chf_hpp](https://static.openfintech.io/payment_methods/cardpay_crypto_chf_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Amount limits:** from `0.01` to `91000` CHF 

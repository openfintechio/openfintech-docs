...
![krungthai_bank_thb_hpp](https://static.openfintech.io/payment_methods/krungthai_bank_thb_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Method:** `krungthai_bank` 
 [show -->](/payment-methods/krungthai_bank/) 

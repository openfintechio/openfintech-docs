...
![cardpay_crypto_hkd_hpp](https://static.openfintech.io/payment_methods/cardpay_crypto_hkd_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Amount limits:** from `0.08` to `780000` HKD 

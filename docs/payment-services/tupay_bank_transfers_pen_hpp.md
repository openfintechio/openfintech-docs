...
# Tupay Bank Transfers (service) 
![tupay_bank_transfers_pen_hpp](https://static.openfintech.io/payment_methods/tupay_bank_transfers_pen_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Method:** `tupay_bank_transfers` 
 [show -->](/payment-methods/tupay_bank_transfers/) 

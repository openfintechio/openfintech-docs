...
![sepa_transfer_crypto_eur_hpp](https://static.openfintech.io/payment_methods/sepa_transfer_crypto_eur_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Method:** `sepa_transfer_crypto` 
 [show -->](/payment-methods/sepa_transfer_crypto/) 

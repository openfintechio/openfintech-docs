...
![government_savings_bank_thb_hpp](https://static.openfintech.io/payment_methods/government_savings_bank_thb_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Method:** `government_savings_bank` 
 [show -->](/payment-methods/government_savings_bank/) 

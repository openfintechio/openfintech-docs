...
![kien_long_bank_vnd_hpp](https://static.openfintech.io/payment_methods/kien_long_bank_vnd_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Method:** `kien_long_bank` 
 [show -->](/payment-methods/kien_long_bank/) 

...
# PayID (service) 
![pay_id_crypto_aud_hpp](https://static.openfintech.io/payment_methods/pay_id_crypto_aud_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Method:** `pay_id_crypto` 
 [show -->](/payment-methods/pay_id_crypto/) 

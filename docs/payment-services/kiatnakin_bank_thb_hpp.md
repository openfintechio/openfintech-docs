...
![kiatnakin_bank_thb_hpp](https://static.openfintech.io/payment_methods/kiatnakin_bank_thb_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Method:** `kiatnakin_bank` 
 [show -->](/payment-methods/kiatnakin_bank/) 

...
![cardpay_crypto_pab_hpp](https://static.openfintech.io/payment_methods/cardpay_crypto_pab_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Amount limits:** from `0.01` to `100000` PAB 

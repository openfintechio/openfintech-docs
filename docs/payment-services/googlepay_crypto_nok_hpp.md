...
# Google Pay (service) 
![googlepay_crypto_nok_hpp](https://static.openfintech.io/payment_methods/googlepay_crypto_nok_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Amount limits:** from `0.1` to `1084360` NOK 

...
# India Bank Selection (service) 
![india_bank_selection_inr_hpp](https://static.openfintech.io/payment_methods/india_bank_selection_inr_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Method:** `india_bank_selection` 
 [show -->](/payment-methods/india_bank_selection/) 

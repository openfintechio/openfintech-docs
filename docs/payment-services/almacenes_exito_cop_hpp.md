...
# Almacenes Exito (service) 
![almacenes_exito_cop_hpp](https://static.openfintech.io/payment_methods/almacenes_exito_cop_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Method:** `almacenes_exito` 
 [show -->](/payment-methods/almacenes_exito/) 

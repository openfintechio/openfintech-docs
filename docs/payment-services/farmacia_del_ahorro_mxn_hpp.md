...
# Farmacia del Ahorro (service) 
![farmacia_del_ahorro_mxn_hpp](https://static.openfintech.io/payment_methods/farmacia_del_ahorro_mxn_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Method:** `farmacia_del_ahorro` 
 [show -->](/payment-methods/farmacia_del_ahorro/) 

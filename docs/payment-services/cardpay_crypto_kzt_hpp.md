...
![cardpay_crypto_kzt_hpp](https://static.openfintech.io/payment_methods/cardpay_crypto_kzt_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Amount limits:** from `4.5` to `45000000` KZT 

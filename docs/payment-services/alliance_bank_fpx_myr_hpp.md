...
# Alliance Bank (FPX), Malaysia (service) 
![alliance_bank_fpx_myr_hpp](https://static.openfintech.io/payment_methods/alliance_bank_fpx_myr_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Method:** `alliance_bank_fpx` 
 [show -->](/payment-methods/alliance_bank_fpx/) 

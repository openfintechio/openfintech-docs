...
![crypto_aggregated_sgd_hpp](https://static.openfintech.io/payment_methods/crypto_aggregated_sgd_hpp/logo.svg?w=400&c=v0.59.26#w200)  

## General 
 
**Code:** `crypto_aggregated_sgd_hpp` 

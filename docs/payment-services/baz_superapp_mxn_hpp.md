...
# BAZ SuperApp (service) 
![baz_superapp_mxn_hpp](https://static.openfintech.io/payment_methods/baz_superapp_mxn_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Method:** `baz_superapp` 
 [show -->](/payment-methods/baz_superapp/) 

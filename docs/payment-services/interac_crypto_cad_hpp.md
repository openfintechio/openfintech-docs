...
![interac_crypto_cad_hpp](https://static.openfintech.io/payment_methods/interac_crypto_cad_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Method:** `interac_crypto` 
 [show -->](/payment-methods/interac_crypto/) 
...
**Amount limits:** from `0.01` to `500000` CAD 

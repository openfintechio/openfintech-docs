...
![nagad_wallet_p2p_bdt_invoice](https://static.openfintech.io/payment_methods/nagad_wallet_p2p_bdt_invoice/logo.svg?w=400&c=v0.59.26#w200)  

## General 
 
**Code:** `nagad_wallet_p2p_bdt_invoice` 

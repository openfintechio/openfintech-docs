...
![mobile_money_kes_hpp](https://static.openfintech.io/payment_methods/mobile_money_kes_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Amount limits:** from `1` to `11000000` KES 
...
|`document_id`|✗|`string`|`/^[a-zA-Z0-9]{7,12}$/`| 

...
# Banco Ripley (service) 
![banco_ripley_pen_hpp](https://static.openfintech.io/payment_methods/banco_ripley_pen_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Method:** `banco_ripley` 
 [show -->](/payment-methods/banco_ripley/) 

...
# AmBank (service) 
![ambank_berhad_myr_hpp](https://static.openfintech.io/payment_methods/ambank_berhad_myr_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Method:** `ambank_berhad` 
 [show -->](/payment-methods/ambank_berhad/) 

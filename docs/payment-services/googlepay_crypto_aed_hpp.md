...
# Google Pay (service) 
![googlepay_crypto_aed_hpp](https://static.openfintech.io/payment_methods/googlepay_crypto_aed_hpp/logo.svg?w=400&c=v0.59.26#w200)  

## General 
 
**Code:** `googlepay_crypto_aed_hpp` 

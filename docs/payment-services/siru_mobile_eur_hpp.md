...
# Siru Mobile (service) 
![siru_mobile_eur_hpp](https://static.openfintech.io/payment_methods/siru_mobile_eur_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
|:---:|:---:|:---:|:---:| 
|`personal_id`|✗|`string`|`/^(\d{8})\|(\d{6}-[0-9A-Za-z]{4})$/`| 

...
# Afirme online banking (service) 
![afirme_online_banking_mxn_hpp](https://static.openfintech.io/payment_methods/afirme_online_banking_mxn_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Method:** `afirme_online_banking` 
 [show -->](/payment-methods/afirme_online_banking/) 

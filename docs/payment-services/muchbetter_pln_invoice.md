...
# MuchBetter (service) 
![muchbetter_pln_invoice](https://static.openfintech.io/payment_methods/muchbetter_pln_invoice/logo.svg?w=400&c=v0.59.26#w200)  
...
**Amount limits:** from `0.01` to `999999` PLN 

...
![maritime_bank_vnd_hpp](https://static.openfintech.io/payment_methods/maritime_bank_vnd_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Method:** `maritime_bank` 
 [show -->](/payment-methods/maritime_bank/) 

...
# Zen wallet (service) 
![zen_wallet_eur_invoice](https://static.openfintech.io/payment_methods/zen_wallet_eur_invoice/logo.svg?w=400&c=v0.59.26#w200)  
...
**Amount limits:** from `1` to `100000000` EUR 

...
![crypto_aggregated_twd_hpp](https://static.openfintech.io/payment_methods/crypto_aggregated_twd_hpp/logo.svg?w=400&c=v0.59.26#w200)  

## General 
 
**Code:** `crypto_aggregated_twd_hpp` 
 
**Method:** `crypto_aggregated` 
 [show -->](/payment-methods/crypto_aggregated/) 
 
**Currency:** `TWD` [show -->](/currencies/TWD/) 
...
**Amount limits:** from `0.32` to `3200000` TWD 

...
# Standard Chartered Bank (FPX) (service) 
![standard_chartered_bank_malaysia_fpx_myr_hpp](https://static.openfintech.io/payment_methods/standard_chartered_bank_malaysia_fpx_myr_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Method:** `standard_chartered_bank_malaysia_fpx` 
 [show -->](/payment-methods/standard_chartered_bank_malaysia_fpx/) 

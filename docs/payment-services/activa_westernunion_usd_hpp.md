...
# Activa WesternUnion (service) 
![activa_westernunion_usd_hpp](https://static.openfintech.io/payment_methods/activa_westernunion_usd_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Method:** `activa_westernunion` 
 [show -->](/payment-methods/activa_westernunion/) 

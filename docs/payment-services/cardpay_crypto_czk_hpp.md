...
![cardpay_crypto_czk_hpp](https://static.openfintech.io/payment_methods/cardpay_crypto_czk_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Amount limits:** from `0.23` to `2300000` CZK 

...
![boleto_bancario_brl_invoice](https://static.openfintech.io/payment_methods/boleto_bancario_brl_invoice/logo.svg?w=400&c=v0.59.26#w200)  

## General 
 
**Code:** `boleto_bancario_brl_invoice` 

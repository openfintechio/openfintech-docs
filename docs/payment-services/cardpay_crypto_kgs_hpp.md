...
![cardpay_crypto_kgs_hpp](https://static.openfintech.io/payment_methods/cardpay_crypto_kgs_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Amount limits:** from `0.9` to `9000000` KGS 

...
# Ambank (FPX), Malaysia (service) 
![ambank_fpx_myr_hpp](https://static.openfintech.io/payment_methods/ambank_fpx_myr_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Method:** `ambank_fpx` 
 [show -->](/payment-methods/ambank_fpx/) 

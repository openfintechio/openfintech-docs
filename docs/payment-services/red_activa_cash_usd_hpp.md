...
# Red Activa (service) 
![red_activa_cash_usd_hpp](https://static.openfintech.io/payment_methods/red_activa_cash_usd_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Method:** `red_activa_cash` 
 [show -->](/payment-methods/red_activa_cash/) 

...
# Santander SuperNet (service) 
![santander_supernet_mxn_hpp](https://static.openfintech.io/payment_methods/santander_supernet_mxn_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Method:** `santander_supernet` 
 [show -->](/payment-methods/santander_supernet/) 

...
![cardpay_crypto_pln_hpp](https://static.openfintech.io/payment_methods/cardpay_crypto_pln_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Amount limits:** from `0.04` to `400000` PLN 

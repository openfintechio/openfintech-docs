...
![crypto_aggregated_ron_hpp](https://static.openfintech.io/payment_methods/crypto_aggregated_ron_hpp/logo.svg?w=400&c=v0.59.26#w200)  

## General 
 
**Code:** `crypto_aggregated_ron_hpp` 
...
**Amount limits:** from `0.01` to `400000` RON 

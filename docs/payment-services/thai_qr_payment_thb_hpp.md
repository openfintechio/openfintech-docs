...
![thai_qr_payment_thb_hpp](https://static.openfintech.io/payment_methods/thai_qr_payment_thb_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Method:** `thai_qr_payment` 
 [show -->](/payment-methods/thai_qr_payment/) 

...
# PayPal (service) 
![paypal_crypto_pln_hpp](https://static.openfintech.io/payment_methods/paypal_crypto_pln_hpp/logo.svg?w=400&c=v0.59.26#w200)  

## General 
 
**Code:** `paypal_crypto_pln_hpp` 
 
**Method:** `paypal_crypto` 
 [show -->](/payment-methods/paypal_crypto/) 
...
**Amount limits:** from `0.01` to `376000` PLN 

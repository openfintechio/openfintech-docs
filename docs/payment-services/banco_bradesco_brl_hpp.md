...
# Banco Bradesco S.A. (service) 
![banco_bradesco_brl_hpp](https://static.openfintech.io/payment_methods/banco_bradesco_brl_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Method:** `banco_bradesco` 
 [show -->](/payment-methods/banco_bradesco/) 

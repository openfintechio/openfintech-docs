...
# SPEI (service) 
![spei_mxn_hpp](https://static.openfintech.io/payment_methods/spei_mxn_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Amount limits:** from `1` to `1000000` MXN 
...
|:---:|:---:|:---:|:---:| 
|`cpf_number`|✗|`string`|`/^(([A-Z][AEIOUX][A-Z]{2}\d{2}(?:0[1-9]\|1[0-2])(?:0[1-9]\|[12]\d\|3[01])[HM](?:AS\|B[CS]\|C[CLMSH]\|D[FG]\|G[TR]\|HG\|JC\|M[CNS]\|N[ETL]\|OC\|PL\|Q[TR]\|S[PLR]\|T[CSL]\|VZ\|YN\|ZS)[B-DF-HJ-NP-TV-Z]{3}[A-Z\d])(\d))$\|^[0-9\.\-]{1,13}$\|^[A-Z&Ñ]{3,4}\d{6}[A-Z0-9]{3}$/`| 

...
# Bodega Aurrera (service) 
![bodega_aurrera_mxn_hpp](https://static.openfintech.io/payment_methods/bodega_aurrera_mxn_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Method:** `bodega_aurrera` 
 [show -->](/payment-methods/bodega_aurrera/) 

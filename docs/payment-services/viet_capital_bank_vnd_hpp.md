...
![viet_capital_bank_vnd_hpp](https://static.openfintech.io/payment_methods/viet_capital_bank_vnd_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Method:** `viet_capital_bank` 
 [show -->](/payment-methods/viet_capital_bank/) 

...
![bank_transfer_sar_hpp](https://static.openfintech.io/payment_methods/bank_transfer_sar_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Amount limits:** from `1` to `375000` SAR 

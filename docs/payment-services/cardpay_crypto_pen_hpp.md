...
![cardpay_crypto_pen_hpp](https://static.openfintech.io/payment_methods/cardpay_crypto_pen_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Amount limits:** from `0.04` to `380000` PEN 

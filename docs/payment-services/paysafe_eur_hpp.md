...
# Paysafe (service) 
![paysafe_eur_hpp](https://static.openfintech.io/payment_methods/paysafe_eur_hpp/logo.svg?w=400&c=v0.59.26#w200)  

## General 
 
**Code:** `paysafe_eur_hpp` 
 
**Method:** `paysafe_card` 
 [show -->](/payment-methods/paysafe_card/) 
...
**Amount limits:** from `1` to `50000` EUR 

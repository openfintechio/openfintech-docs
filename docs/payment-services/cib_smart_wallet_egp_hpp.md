...
![cib_smart_wallet_egp_hpp](https://static.openfintech.io/payment_methods/cib_smart_wallet_egp_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Method:** `cib_smart_wallet` 
 [show -->](/payment-methods/cib_smart_wallet/) 

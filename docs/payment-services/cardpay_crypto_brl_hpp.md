...
![cardpay_crypto_brl_hpp](https://static.openfintech.io/payment_methods/cardpay_crypto_brl_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Amount limits:** from `0.05` to `500000` BRL 

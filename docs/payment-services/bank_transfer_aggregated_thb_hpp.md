...
![bank_transfer_aggregated_thb_hpp](https://static.openfintech.io/payment_methods/bank_transfer_aggregated_thb_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Amount limits:** from `1` to `3500000` THB 

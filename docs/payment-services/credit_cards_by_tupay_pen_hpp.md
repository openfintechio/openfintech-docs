...
# Credit Cards by Tupay (service) 
![credit_cards_by_tupay_pen_hpp](https://static.openfintech.io/payment_methods/credit_cards_by_tupay_pen_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Method:** `credit_cards_by_tupay` 
 [show -->](/payment-methods/credit_cards_by_tupay/) 

...
![cardpay_crypto_jpy_hpp](https://static.openfintech.io/payment_methods/cardpay_crypto_jpy_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Amount limits:** from `1` to `15000000` JPY 

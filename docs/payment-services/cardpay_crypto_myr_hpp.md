...
![cardpay_crypto_myr_hpp](https://static.openfintech.io/payment_methods/cardpay_crypto_myr_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Amount limits:** from `0.05` to `470000` MYR 

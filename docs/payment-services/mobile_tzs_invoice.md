...
# Mobile (service) 
![mobile_tzs_invoice](https://static.openfintech.io/payment_methods/mobile_tzs_invoice/logo.svg?w=400&c=v0.59.26#w200)  
...
**Amount limits:** from `24` to `244000000` TZS 

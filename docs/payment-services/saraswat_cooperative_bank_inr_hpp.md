...
# Saraswat Cooperative Bank (service) 
![saraswat_cooperative_bank_inr_hpp](https://static.openfintech.io/payment_methods/saraswat_cooperative_bank_inr_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Method:** `saraswat_cooperative_bank` 
 [show -->](/payment-methods/saraswat_cooperative_bank/) 

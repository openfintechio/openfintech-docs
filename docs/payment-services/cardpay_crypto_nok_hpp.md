...
![cardpay_crypto_nok_hpp](https://static.openfintech.io/payment_methods/cardpay_crypto_nok_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Amount limits:** from `0.11` to `1100000` NOK 

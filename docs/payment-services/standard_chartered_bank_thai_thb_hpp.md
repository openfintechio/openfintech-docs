...
![standard_chartered_bank_thai_thb_hpp](https://static.openfintech.io/payment_methods/standard_chartered_bank_thai_thb_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Method:** `standard_chartered_bank_thai` 
 [show -->](/payment-methods/standard_chartered_bank_thai/) 

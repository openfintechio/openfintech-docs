...
# Maybank (service) 
![maybank_berhad_idr_hpp](https://static.openfintech.io/payment_methods/maybank_berhad_idr_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Method:** `maybank_berhad` 
 [show -->](/payment-methods/maybank_berhad/) 

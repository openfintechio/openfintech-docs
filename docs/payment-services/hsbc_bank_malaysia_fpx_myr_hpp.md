...
# HSBC Bank Malaysia (FPX), Malaysia (service) 
![hsbc_bank_malaysia_fpx_myr_hpp](https://static.openfintech.io/payment_methods/hsbc_bank_malaysia_fpx_myr_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Method:** `hsbc_bank_malaysia_fpx` 
 [show -->](/payment-methods/hsbc_bank_malaysia_fpx/) 

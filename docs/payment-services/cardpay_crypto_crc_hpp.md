...
![cardpay_crypto_crc_hpp](https://static.openfintech.io/payment_methods/cardpay_crypto_crc_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Amount limits:** from `5` to `50000000` CRC 

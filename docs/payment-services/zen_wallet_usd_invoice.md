...
# Zen wallet (service) 
![zen_wallet_usd_invoice](https://static.openfintech.io/payment_methods/zen_wallet_usd_invoice/logo.svg?w=400&c=v0.59.26#w200)  
...
**Method:** `zen_wallet` 
 [show -->](/payment-methods/zen_wallet/) 
...
**Amount limits:** from `1` to `100000000` USD 

...
![cardpay_crypto_thb_hpp](https://static.openfintech.io/payment_methods/cardpay_crypto_thb_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Amount limits:** from `0.36` to `3600000` THB 

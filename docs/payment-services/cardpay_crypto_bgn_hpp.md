...
![cardpay_crypto_bgn_hpp](https://static.openfintech.io/payment_methods/cardpay_crypto_bgn_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Amount limits:** from `0.02` to `180000` BGN 

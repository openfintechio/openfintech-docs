...
![artha_graha_bank_idr_hpp](https://static.openfintech.io/payment_methods/artha_graha_bank_idr_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Method:** `artha_graha_bank` 
 [show -->](/payment-methods/artha_graha_bank/) 

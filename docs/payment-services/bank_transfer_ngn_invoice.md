...
![bank_transfer_ngn_invoice](https://static.openfintech.io/payment_methods/bank_transfer_ngn_invoice/logo.svg?w=400&c=v0.59.26#w200)  
...
**Amount limits:** from `1` to `68800000` NGN 

...
![industrial_bank_hanoi_vnd_hpp](https://static.openfintech.io/payment_methods/industrial_bank_hanoi_vnd_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Method:** `industrial_bank_hanoi` 
 [show -->](/payment-methods/industrial_bank_hanoi/) 

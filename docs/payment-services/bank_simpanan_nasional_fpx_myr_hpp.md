...
# Bank Simpanan Nasional (FPX), Malaysia (service) 
![bank_simpanan_nasional_fpx_myr_hpp](https://static.openfintech.io/payment_methods/bank_simpanan_nasional_fpx_myr_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Method:** `bank_simpanan_nasional_fpx` 
 [show -->](/payment-methods/bank_simpanan_nasional_fpx/) 

...
![payment_card_crypto_aed_hpp](https://static.openfintech.io/payment_methods/payment_card_crypto_aed_hpp/logo.svg?w=400&c=v0.59.26#w200)  

## General 
 
**Code:** `payment_card_crypto_aed_hpp` 
...
**Amount limits:** from `0.04` to `367000` AED 

...
![cardpay_crypto_vnd_hpp](https://static.openfintech.io/payment_methods/cardpay_crypto_vnd_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Amount limits:** from `250` to `2500000000` VND 

...
![etisalat_cash_egp_hpp](https://static.openfintech.io/payment_methods/etisalat_cash_egp_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Method:** `etisalat_cash` 
 [show -->](/payment-methods/etisalat_cash/) 

...
![cardpay_crypto_omr_hpp](https://static.openfintech.io/payment_methods/cardpay_crypto_omr_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Amount limits:** from `0.004` to `39000` OMR 

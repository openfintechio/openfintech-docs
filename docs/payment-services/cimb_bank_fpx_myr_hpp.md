...
# CIMB Bank (FPX) (service) 
![cimb_bank_fpx_myr_hpp](https://static.openfintech.io/payment_methods/cimb_bank_fpx_myr_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Method:** `cimb_bank_fpx` 
 [show -->](/payment-methods/cimb_bank_fpx/) 

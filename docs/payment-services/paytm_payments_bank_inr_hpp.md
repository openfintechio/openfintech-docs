...
![paytm_payments_bank_inr_hpp](https://static.openfintech.io/payment_methods/paytm_payments_bank_inr_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Method:** `paytm_payments_bank` 
 [show -->](/payment-methods/paytm_payments_bank/) 

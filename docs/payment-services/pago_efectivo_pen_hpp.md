...
# Pago Efectivo (service) 
![pago_efectivo_pen_hpp](https://static.openfintech.io/payment_methods/pago_efectivo_pen_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Method:** `pago_efectivo` 
 [show -->](/payment-methods/pago_efectivo/) 

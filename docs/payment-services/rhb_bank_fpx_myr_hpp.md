...
# RHB Bank (FPX) (service) 
![rhb_bank_fpx_myr_hpp](https://static.openfintech.io/payment_methods/rhb_bank_fpx_myr_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Method:** `rhb_bank_fpx` 
 [show -->](/payment-methods/rhb_bank_fpx/) 

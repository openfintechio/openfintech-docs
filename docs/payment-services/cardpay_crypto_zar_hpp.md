...
![cardpay_crypto_zar_hpp](https://static.openfintech.io/payment_methods/cardpay_crypto_zar_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Amount limits:** from `0.19` to `1900000` ZAR 

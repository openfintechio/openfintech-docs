...
# Mobile (service) 
![mobile_gnf_invoice](https://static.openfintech.io/payment_methods/mobile_gnf_invoice/logo.svg?w=400&c=v0.59.26#w200)  
...
**Amount limits:** from `100` to `860000000` GNF 

...
![crypto_aggregated_huf_hpp](https://static.openfintech.io/payment_methods/crypto_aggregated_huf_hpp/logo.svg?w=400&c=v0.59.26#w200)  

## General 
 
**Code:** `crypto_aggregated_huf_hpp` 
...
**Amount limits:** from `0.01` to `32000000` HUF 

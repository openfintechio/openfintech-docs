...
# Bank Transfer MPX (service) 
![bank_transfer_mpx_ars_hpp](https://static.openfintech.io/payment_methods/bank_transfer_mpx_ars_hpp/logo.svg?w=400&c=v0.59.26#w200)  

## General 
 
**Code:** `bank_transfer_mpx_ars_hpp` 
 
**Method:** `bank_transfer_mpx` 
 [show -->](/payment-methods/bank_transfer_mpx/) 
 
**Currency:** `ARS` [show -->](/currencies/ARS/) 
 
**Name:** 
 
:	[EN] Bank Transfer MPX 

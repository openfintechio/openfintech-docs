...
# Farmacia la mas barata (service) 
![farmacia_la_mas_barata_mxn_hpp](https://static.openfintech.io/payment_methods/farmacia_la_mas_barata_mxn_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Method:** `farmacia_la_mas_barata` 
 [show -->](/payment-methods/farmacia_la_mas_barata/) 

...
# Banco de Antigua (service) 
![banco_de_antigua_cash_gtq_hpp](https://static.openfintech.io/payment_methods/banco_de_antigua_cash_gtq_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Method:** `banco_de_antigua_cash` 
 [show -->](/payment-methods/banco_de_antigua_cash/) 

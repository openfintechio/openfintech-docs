...
![cimb_thai_bank_thb_hpp](https://static.openfintech.io/payment_methods/cimb_thai_bank_thb_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Method:** `cimb_thai_bank` 
 [show -->](/payment-methods/cimb_thai_bank/) 

...
![cardpay_crypto_dkk_hpp](https://static.openfintech.io/payment_methods/cardpay_crypto_dkk_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Amount limits:** from `0.07` to `690000` DKK 

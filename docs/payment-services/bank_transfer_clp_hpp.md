...
![bank_transfer_clp_hpp](https://static.openfintech.io/payment_methods/bank_transfer_clp_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Amount limits:** from `1` to `88500000` CLP 

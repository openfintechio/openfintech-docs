...
![cardpay_crypto_php_hpp](https://static.openfintech.io/payment_methods/cardpay_crypto_php_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Amount limits:** from `0.56` to `5600000` PHP 

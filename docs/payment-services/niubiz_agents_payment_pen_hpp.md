...
# Niubiz Agents Payment (service) 
![niubiz_agents_payment_pen_hpp](https://static.openfintech.io/payment_methods/niubiz_agents_payment_pen_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Method:** `niubiz_agents_payment` 
 [show -->](/payment-methods/niubiz_agents_payment/) 

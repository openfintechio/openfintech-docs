...
![cardpay_crypto_mxn_hpp](https://static.openfintech.io/payment_methods/cardpay_crypto_mxn_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Amount limits:** from `0.17` to `1700000` MXN 

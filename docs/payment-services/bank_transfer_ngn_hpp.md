...
![bank_transfer_ngn_hpp](https://static.openfintech.io/payment_methods/bank_transfer_ngn_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Amount limits:** from `15` to `100000000` NGN 
...
|`account`|✗|`string`|`/^.{1,50}$/`| 
|`document_id`|✗|`string`|`/^[a-zA-Z0-9]{9,12}$/`| 

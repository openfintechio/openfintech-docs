...
# Fawry (service) 
![fawry_crypto_egp_hpp](https://static.openfintech.io/payment_methods/fawry_crypto_egp_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Method:** `fawry_crypto` 
 [show -->](/payment-methods/fawry_crypto/) 
...
**Amount limits:** from `0.01` to `1000000000` EGP 

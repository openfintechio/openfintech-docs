...
![hong_kong_shanghai_bank_thb_hpp](https://static.openfintech.io/payment_methods/hong_kong_shanghai_bank_thb_hpp/logo.svg?w=400&c=v0.59.26#w200)  
...
**Method:** `hong_kong_shanghai_bank` 
 [show -->](/payment-methods/hong_kong_shanghai_bank/) 

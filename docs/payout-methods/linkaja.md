...
The list of [Payout Services](/payout-services/) based on the _PT Fintek Karya Nusantara Linkaja e-wallet_ 

|Icon|Name|Code| 
|:---:|:---:|:---:| 
|![linkaja](https://static.openfintech.io/payout_methods/linkaja/icon.svg?w=278&c=v0.59.26#w40) |[linkaja_idr](/payout-services/linkaja_idr/)|`linkaja_idr`| 

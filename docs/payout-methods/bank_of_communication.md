...
The list of [Payout Services](/payout-services/) based on the _Bank of Communications_ 

|Icon|Name|Code| 
|:---:|:---:|:---:| 
|![bank_of_communication](https://static.openfintech.io/payout_methods/bank_of_communication/icon.svg?w=278&c=v0.59.26#w40) |[bank_of_communication_cny](/payout-services/bank_of_communication_cny/)|`bank_of_communication_cny`| 
 

## Payment Providers 
 
The list of [Payment Providers](/payment-providers/) that support the _Bank of Communications_ 

...
The list of [Payout Services](/payout-services/) based on the _IndusInd Bank_ 

|Icon|Name|Code| 
|:---:|:---:|:---:| 
|![indusind_bank](https://static.openfintech.io/payout_methods/indusind_bank/icon.svg?w=278&c=v0.59.26#w40) |[indusind_bank_inr](/payout-services/indusind_bank_inr/)|`indusind_bank_inr`| 

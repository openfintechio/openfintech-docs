...
# Paysera LT 
![paysera](https://static.openfintech.io/payment_providers/paysera/logo.png?w=400&c=v0.59.26#w100)  
...
```
https://static.openfintech.io/payment_providers/paysera/logo.png?w=400&c=v0.59.26#w100
```  

### Icon 
 
![paysera](https://static.openfintech.io/payment_providers/paysera/icon.png?w=278&c=v0.59.26#w100)  

```
https://static.openfintech.io/payment_providers/paysera/icon.png?w=278&c=v0.59.26#w100
```  

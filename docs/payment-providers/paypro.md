...
# PayPro 
![paypro](https://static.openfintech.io/payment_providers/paypro/logo.png?w=400&c=v0.59.26#w100)  
...
```
https://static.openfintech.io/payment_providers/paypro/logo.png?w=400&c=v0.59.26#w100
```  

### Icon 
 
![paypro](https://static.openfintech.io/payment_providers/paypro/icon.png?w=278&c=v0.59.26#w100)  

```
https://static.openfintech.io/payment_providers/paypro/icon.png?w=278&c=v0.59.26#w100
```  

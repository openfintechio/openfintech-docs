...
# Gate2Play 
![gate2play](https://static.openfintech.io/payment_providers/gate2play/logo.svg?w=400&c=v0.59.26#w100)  

## General 
 
**Code:** `gate2play` 
 
**Vendor:** `gate2play` [show -->](/vendors/gate2play/) 
...
```
https://static.openfintech.io/payment_providers/gate2play/logo.svg?w=400&c=v0.59.26#w100
```  

### Icon 
 
![gate2play](https://static.openfintech.io/payment_providers/gate2play/icon.svg?w=278&c=v0.59.26#w100)  

```
https://static.openfintech.io/payment_providers/gate2play/icon.svg?w=278&c=v0.59.26#w100
```  

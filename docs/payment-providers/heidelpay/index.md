...
# Heidelpay 
![heidelpay](https://static.openfintech.io/payment_providers/heidelpay/logo.png?w=400&c=v0.59.26#w100)  
...
```
https://static.openfintech.io/payment_providers/heidelpay/logo.png?w=400&c=v0.59.26#w100
```  

### Icon 
 
![heidelpay](https://static.openfintech.io/payment_providers/heidelpay/icon.png?w=278&c=v0.59.26#w100)  

```
https://static.openfintech.io/payment_providers/heidelpay/icon.png?w=278&c=v0.59.26#w100
```  
...
|[billpay](/payment-methods/billpay)| 

...
# PayXpert 
![payxpert](https://static.openfintech.io/payment_providers/payxpert/logo.svg?w=400&c=v0.59.26#w100)  

## General 
 
**Code:** `payxpert` 
 
**Vendor:** `payxpert` [show -->](/vendors/payxpert/) 
...
```
https://static.openfintech.io/payment_providers/payxpert/logo.svg?w=400&c=v0.59.26#w100
```  

### Icon 
 
![payxpert](https://static.openfintech.io/payment_providers/payxpert/icon.svg?w=278&c=v0.59.26#w100)  

```
https://static.openfintech.io/payment_providers/payxpert/icon.svg?w=278&c=v0.59.26#w100
```  

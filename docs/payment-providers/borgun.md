...
# Borgun 
![borgun](https://static.openfintech.io/payment_providers/borgun/logo.png?w=400&c=v0.59.26#w100)  

## General 
 
**Code:** `borgun` 
 
**Vendor:** `borgun` [show -->](/vendors/borgun/) 
...
```
https://static.openfintech.io/payment_providers/borgun/logo.png?w=400&c=v0.59.26#w100
```  

### Icon 
 
![borgun](https://static.openfintech.io/payment_providers/borgun/icon.png?w=278&c=v0.59.26#w100)  

```
https://static.openfintech.io/payment_providers/borgun/icon.png?w=278&c=v0.59.26#w100
```  

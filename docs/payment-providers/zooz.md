...
# Zooz, Inc 
![zooz](https://static.openfintech.io/payment_providers/zooz/logo.svg?w=400&c=v0.59.26#w100)  

## General 
 
**Code:** `zooz` 
 
**Vendor:** `zooz` [show -->](/vendors/zooz/) 
...
```
https://static.openfintech.io/payment_providers/zooz/logo.svg?w=400&c=v0.59.26#w100
```  

### Icon 
 
![zooz](https://static.openfintech.io/payment_providers/zooz/icon.svg?w=278&c=v0.59.26#w100)  

```
https://static.openfintech.io/payment_providers/zooz/icon.svg?w=278&c=v0.59.26#w100
```  

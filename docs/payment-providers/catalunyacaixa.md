...
# CatalunyaCaixa 
![catalunyacaixa](https://static.openfintech.io/payment_providers/catalunyacaixa/logo.svg?w=400&c=v0.59.26#w100)  

## General 
 
**Code:** `catalunyacaixa` 
 
**Vendor:** `catalunyacaixa` [show -->](/vendors/catalunyacaixa/) 
...
```
https://static.openfintech.io/payment_providers/catalunyacaixa/logo.svg?w=400&c=v0.59.26#w100
```  

### Icon 
 
![catalunyacaixa](https://static.openfintech.io/payment_providers/catalunyacaixa/icon.svg?w=278&c=v0.59.26#w100)  

```
https://static.openfintech.io/payment_providers/catalunyacaixa/icon.svg?w=278&c=v0.59.26#w100
```  
...
```json
{
  ...
  "payout_method":null,
  "metadata":{
    "about_payments_code":"catalunyacaixa"
  },
  "name":{
    "en":"CatalunyaCaixa"
  }

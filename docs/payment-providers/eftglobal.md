...
# EFT Global 
![eftglobal](https://static.openfintech.io/payment_providers/eftglobal/logo.svg?w=400&c=v0.59.26#w100)  

## General 
 
**Code:** `eftglobal` 
 
**Vendor:** `eftglobal` [show -->](/vendors/eftglobal/) 
...
```
https://static.openfintech.io/payment_providers/eftglobal/logo.svg?w=400&c=v0.59.26#w100
```  

### Icon 
 
![eftglobal](https://static.openfintech.io/payment_providers/eftglobal/icon.svg?w=278&c=v0.59.26#w100)  

```
https://static.openfintech.io/payment_providers/eftglobal/icon.svg?w=278&c=v0.59.26#w100
```  

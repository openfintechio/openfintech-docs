...
# Secure Trading 
![securetrading](https://static.openfintech.io/payment_providers/securetrading/logo.png?w=400&c=v0.59.26#w100)  
...
```
https://static.openfintech.io/payment_providers/securetrading/logo.png?w=400&c=v0.59.26#w100
```  

### Icon 
 
![securetrading](https://static.openfintech.io/payment_providers/securetrading/icon.png?w=278&c=v0.59.26#w100)  

```
https://static.openfintech.io/payment_providers/securetrading/icon.png?w=278&c=v0.59.26#w100
```  

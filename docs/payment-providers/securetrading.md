...
# Secure Trading 
![securetrading](https://static.openfintech.io/payment_providers/securetrading/logo.svg?w=400&c=v0.59.26#w100)  

## General 
 
**Code:** `securetrading` 
 
**Vendor:** `securetrading` [show -->](/vendors/securetrading/) 
...
```
https://static.openfintech.io/payment_providers/securetrading/logo.svg?w=400&c=v0.59.26#w100
```  

### Icon 
 
![securetrading](https://static.openfintech.io/payment_providers/securetrading/icon.svg?w=278&c=v0.59.26#w100)  

```
https://static.openfintech.io/payment_providers/securetrading/icon.svg?w=278&c=v0.59.26#w100
```  
...
```json
{
  ...
  "payout_method":null,
  "metadata":{
    "about_payments_code":"securetrading"
  },
  "name":{
    "en":"Secure Trading"
  }

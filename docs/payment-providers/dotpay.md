...
# Dotpay 
![dotpay](https://static.openfintech.io/payment_providers/dotpay/logo.svg?w=400&c=v0.59.26#w100)  
...
```
https://static.openfintech.io/payment_providers/dotpay/logo.svg?w=400&c=v0.59.26#w100
```  

### Icon 
 
![dotpay](https://static.openfintech.io/payment_providers/dotpay/icon.svg?w=278&c=v0.59.26#w100)  

```
https://static.openfintech.io/payment_providers/dotpay/icon.svg?w=278&c=v0.59.26#w100
```  

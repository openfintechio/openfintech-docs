...
# ICEPAY 
![icepay](https://static.openfintech.io/payment_providers/icepay/logo.svg?w=400&c=v0.59.26#w100)  

## General 
 
**Code:** `icepay` 
 
**Vendor:** `icepay` [show -->](/vendors/icepay/) 
...
```
https://static.openfintech.io/payment_providers/icepay/logo.svg?w=400&c=v0.59.26#w100
```  

### Icon 
 
![icepay](https://static.openfintech.io/payment_providers/icepay/icon.svg?w=278&c=v0.59.26#w100)  

```
https://static.openfintech.io/payment_providers/icepay/icon.svg?w=278&c=v0.59.26#w100
```  

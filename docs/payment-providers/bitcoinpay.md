...
# BitcoinPay 
![bitcoinpay](https://static.openfintech.io/payment_providers/bitcoinpay/logo.svg?w=400&c=v0.59.26#w100)  

## General 
 
**Code:** `bitcoinpay` 
 
**Vendor:** `bitcoinpay` [show -->](/vendors/bitcoinpay/) 
...
```
https://static.openfintech.io/payment_providers/bitcoinpay/logo.svg?w=400&c=v0.59.26#w100
```  

### Icon 
 
![bitcoinpay](https://static.openfintech.io/payment_providers/bitcoinpay/icon.svg?w=278&c=v0.59.26#w100)  

```
https://static.openfintech.io/payment_providers/bitcoinpay/icon.svg?w=278&c=v0.59.26#w100
```  
...
```json
{
  ...
  "payout_method":null,
  "metadata":{
    "about_payments_code":"bitcoinpay"
  },
  "name":{
    "en":"BitcoinPay"
  }

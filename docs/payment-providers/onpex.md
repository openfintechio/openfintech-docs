...
# ONPEX 
![onpex](https://static.openfintech.io/payment_providers/onpex/logo.png?w=400&c=v0.59.26#w100)  

## General 
 
**Code:** `onpex` 
 
**Vendor:** `onpex` [show -->](/vendors/onpex/) 
...
```
https://static.openfintech.io/payment_providers/onpex/logo.png?w=400&c=v0.59.26#w100
```  

### Icon 
 
![onpex](https://static.openfintech.io/payment_providers/onpex/icon.png?w=278&c=v0.59.26#w100)  

```
https://static.openfintech.io/payment_providers/onpex/icon.png?w=278&c=v0.59.26#w100
```  

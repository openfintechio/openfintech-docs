...
# Bank Frick 
![bankfrick](https://static.openfintech.io/payment_providers/bankfrick/logo.svg?w=400&c=v0.59.26#w100)  

## General 
 
**Code:** `bankfrick` 
 
**Vendor:** `bankfrick` [show -->](/vendors/bankfrick/) 
...
```
https://static.openfintech.io/payment_providers/bankfrick/logo.svg?w=400&c=v0.59.26#w100
```  

### Icon 
 
![bankfrick](https://static.openfintech.io/payment_providers/bankfrick/icon.svg?w=278&c=v0.59.26#w100)  

```
https://static.openfintech.io/payment_providers/bankfrick/icon.svg?w=278&c=v0.59.26#w100
```  

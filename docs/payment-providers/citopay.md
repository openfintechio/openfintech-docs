...
![citopay](https://static.openfintech.io/payment_providers/citopay/logo.svg?w=400&c=v0.59.26#w100)  

## General 
 
**Code:** `citopay` 
 
**Vendor:** `citopay` [show -->](/vendors/citopay/) 
...
```
https://static.openfintech.io/payment_providers/citopay/logo.svg?w=400&c=v0.59.26#w100
```  

### Icon 
 
![citopay](https://static.openfintech.io/payment_providers/citopay/icon.svg?w=278&c=v0.59.26#w100)  

```
https://static.openfintech.io/payment_providers/citopay/icon.svg?w=278&c=v0.59.26#w100
```  

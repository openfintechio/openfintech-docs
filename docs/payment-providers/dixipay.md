...
# DIXIPAY 
![dixipay](https://static.openfintech.io/payment_providers/dixipay/logo.png?w=400&c=v0.59.26#w100)  

## General 
 
**Code:** `dixipay` 
 
**Vendor:** `dixipay` [show -->](/vendors/dixipay/) 
...
```
https://static.openfintech.io/payment_providers/dixipay/logo.png?w=400&c=v0.59.26#w100
```  

### Icon 
 
![dixipay](https://static.openfintech.io/payment_providers/dixipay/icon.png?w=278&c=v0.59.26#w100)  

```
https://static.openfintech.io/payment_providers/dixipay/icon.png?w=278&c=v0.59.26#w100
```  

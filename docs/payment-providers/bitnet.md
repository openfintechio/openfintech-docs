...
![bitnet](https://static.openfintech.io/payment_providers/bitnet/logo.svg?w=400&c=v0.59.26#w100)  

## General 
 
**Code:** `bitnet` 
 
**Vendor:** `bitnet` [show -->](/vendors/bitnet/) 
...
```
https://static.openfintech.io/payment_providers/bitnet/logo.svg?w=400&c=v0.59.26#w100
```  

### Icon 
 
![bitnet](https://static.openfintech.io/payment_providers/bitnet/icon.svg?w=278&c=v0.59.26#w100)  

```
https://static.openfintech.io/payment_providers/bitnet/icon.svg?w=278&c=v0.59.26#w100
```  

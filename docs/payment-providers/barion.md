...
# Barion Payments 
![barion](https://static.openfintech.io/payment_providers/barion/logo.png?w=400&c=v0.59.26#w100)  

## General 
 
**Code:** `barion` 
 
**Vendor:** `barion` [show -->](/vendors/barion/) 
...
```
https://static.openfintech.io/payment_providers/barion/logo.png?w=400&c=v0.59.26#w100
```  

### Icon 
 
![barion](https://static.openfintech.io/payment_providers/barion/icon.png?w=278&c=v0.59.26#w100)  

```
https://static.openfintech.io/payment_providers/barion/icon.png?w=278&c=v0.59.26#w100
```  

...
# Xpate New 
![xpatenew](https://static.openfintech.io/payment_providers/xpatenew/logo.svg?w=400&c=v0.59.26#w100)  

## General 
 
**Code:** `xpatenew` 
 
**Vendor:** `xpatenew` [show -->](/vendors/xpatenew/) 
...
```
https://static.openfintech.io/payment_providers/xpatenew/logo.svg?w=400&c=v0.59.26#w100
```  

### Icon 
 
![xpatenew](https://static.openfintech.io/payment_providers/xpatenew/icon.svg?w=278&c=v0.59.26#w100)  

```
https://static.openfintech.io/payment_providers/xpatenew/icon.svg?w=278&c=v0.59.26#w100
```  

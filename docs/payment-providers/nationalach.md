...
# NationalACH 
![nationalach](https://static.openfintech.io/payment_providers/nationalach/logo.svg?w=400&c=v0.59.26#w100)  

## General 
 
**Code:** `nationalach` 
 
**Vendor:** `nationalach` [show -->](/vendors/nationalach/) 
...
```
https://static.openfintech.io/payment_providers/nationalach/logo.svg?w=400&c=v0.59.26#w100
```  

### Icon 
 
![nationalach](https://static.openfintech.io/payment_providers/nationalach/icon.svg?w=278&c=v0.59.26#w100)  

```
https://static.openfintech.io/payment_providers/nationalach/icon.svg?w=278&c=v0.59.26#w100
```  
...
```json
{
  ...
  "payout_method":null,
  "metadata":{
    "about_payments_code":"nationalach"
  },
  "name":{
    "en":"NationalACH"
  }

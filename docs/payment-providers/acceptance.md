...
# Acceptance 
![acceptance](https://static.openfintech.io/payment_providers/acceptance/logo.svg?w=400&c=v0.59.26#w100)  

## General 
 
**Code:** `acceptance` 
 
**Vendor:** `acceptance` [show -->](/vendors/acceptance/) 
...
```
https://static.openfintech.io/payment_providers/acceptance/logo.svg?w=400&c=v0.59.26#w100
```  

### Icon 
 
![acceptance](https://static.openfintech.io/payment_providers/acceptance/icon.svg?w=278&c=v0.59.26#w100)  

```
https://static.openfintech.io/payment_providers/acceptance/icon.svg?w=278&c=v0.59.26#w100
```  

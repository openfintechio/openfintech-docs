...
# eMerchantPay Ltd 
![emerchantpay](https://static.openfintech.io/payment_providers/emerchantpay/logo.png?w=400&c=v0.59.26#w100)  
...
```
https://static.openfintech.io/payment_providers/emerchantpay/logo.png?w=400&c=v0.59.26#w100
```  

### Icon 
 
![emerchantpay](https://static.openfintech.io/payment_providers/emerchantpay/icon.png?w=278&c=v0.59.26#w100)  

```
https://static.openfintech.io/payment_providers/emerchantpay/icon.png?w=278&c=v0.59.26#w100
```  
...
```json
{
  ...
  "payout_method":null,
  "metadata":{
    "about_payments_code":"emerchantpay"
  },
  "name":{
    "en":"eMerchantPay Ltd"
  }

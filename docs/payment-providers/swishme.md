...
# Swish Payments Ltd 
![swishme](https://static.openfintech.io/payment_providers/swishme/logo.png?w=400&c=v0.59.26#w100)  

## General 
 
**Code:** `swishme` 
 
**Vendor:** `swishme` [show -->](/vendors/swishme/) 
...
```
https://static.openfintech.io/payment_providers/swishme/logo.png?w=400&c=v0.59.26#w100
```  

### Icon 
 
![swishme](https://static.openfintech.io/payment_providers/swishme/icon.png?w=278&c=v0.59.26#w100)  

```
https://static.openfintech.io/payment_providers/swishme/icon.png?w=278&c=v0.59.26#w100
```  

...
# DalPay 
![dalpay](https://static.openfintech.io/payment_providers/dalpay/logo.png?w=400&c=v0.59.26#w100)  

## General 
 
**Code:** `dalpay` 
 
**Vendor:** `dalpay` [show -->](/vendors/dalpay/) 
...
```
https://static.openfintech.io/payment_providers/dalpay/logo.png?w=400&c=v0.59.26#w100
```  

### Icon 
 
![dalpay](https://static.openfintech.io/payment_providers/dalpay/icon.png?w=278&c=v0.59.26#w100)  

```
https://static.openfintech.io/payment_providers/dalpay/icon.png?w=278&c=v0.59.26#w100
```  

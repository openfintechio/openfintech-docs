...
# Paysera LT 
![paysera](https://static.openfintech.io/payment_providers/paysera/logo.svg?w=400&c=v0.59.26#w100)  

## General 
 
**Code:** `paysera` 
 
**Vendor:** `paysera` [show -->](/vendors/paysera/) 
...
```
https://static.openfintech.io/payment_providers/paysera/logo.svg?w=400&c=v0.59.26#w100
```  

### Icon 
 
![paysera](https://static.openfintech.io/payment_providers/paysera/icon.svg?w=278&c=v0.59.26#w100)  

```
https://static.openfintech.io/payment_providers/paysera/icon.svg?w=278&c=v0.59.26#w100
```  

...
# ICEPAY 
![icepay](https://static.openfintech.io/payment_providers/icepay/logo.png?w=400&c=v0.59.26#w100)  
...
```
https://static.openfintech.io/payment_providers/icepay/logo.png?w=400&c=v0.59.26#w100
```  

### Icon 
 
![icepay](https://static.openfintech.io/payment_providers/icepay/icon.png?w=278&c=v0.59.26#w100)  

```
https://static.openfintech.io/payment_providers/icepay/icon.png?w=278&c=v0.59.26#w100
```  

...
# Vantage Payments 
![vantagepayments](https://static.openfintech.io/payment_providers/vantagepayments/logo.png?w=400&c=v0.59.26#w100)  

## General 
 
**Code:** `vantagepayments` 
 
**Vendor:** `vantagepayments` [show -->](/vendors/vantagepayments/) 
...
```
https://static.openfintech.io/payment_providers/vantagepayments/logo.png?w=400&c=v0.59.26#w100
```  

### Icon 
 
![vantagepayments](https://static.openfintech.io/payment_providers/vantagepayments/icon.png?w=278&c=v0.59.26#w100)  

```
https://static.openfintech.io/payment_providers/vantagepayments/icon.png?w=278&c=v0.59.26#w100
```  
...
```json
{
  ...
  "payout_method":null,
  "metadata":{
    "about_payments_code":"vantagepayments"
  },
  "name":{
    "en":"Vantage Payments"
  }

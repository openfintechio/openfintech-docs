...
# Magnius 
![magnius](https://static.openfintech.io/payment_providers/magnius/logo.svg?w=400&c=v0.59.26#w100)  

## General 
 
**Code:** `magnius` 
 
**Vendor:** `magnius` [show -->](/vendors/magnius/) 
...
```
https://static.openfintech.io/payment_providers/magnius/logo.svg?w=400&c=v0.59.26#w100
```  

### Icon 
 
![magnius](https://static.openfintech.io/payment_providers/magnius/icon.svg?w=278&c=v0.59.26#w100)  

```
https://static.openfintech.io/payment_providers/magnius/icon.svg?w=278&c=v0.59.26#w100
```  

...
# CoinGate 
![coingate](https://static.openfintech.io/payment_providers/coingate/logo.svg?w=400&c=v0.59.26#w100)  
...
```
https://static.openfintech.io/payment_providers/coingate/logo.svg?w=400&c=v0.59.26#w100
```  

### Icon 
 
![coingate](https://static.openfintech.io/payment_providers/coingate/icon.svg?w=278&c=v0.59.26#w100)  

```
https://static.openfintech.io/payment_providers/coingate/icon.svg?w=278&c=v0.59.26#w100
```  
...
|Code| 
|:---| 
|[bitcoin_cash](/payment-methods/bitcoin_cash)| 
|[litecoin](/payment-methods/litecoin)| 
|[coingate](/payment-methods/coingate)| 
|[bitcoin](/payment-methods/bitcoin)| 
|[ethereum](/payment-methods/ethereum)| 

...
# Flocash 
![flocash](https://static.openfintech.io/payment_providers/flocash/logo.svg?w=400&c=v0.59.26#w100)  
...
```
https://static.openfintech.io/payment_providers/flocash/logo.svg?w=400&c=v0.59.26#w100
```  

### Icon 
 
![flocash](https://static.openfintech.io/payment_providers/flocash/icon.svg?w=278&c=v0.59.26#w100)  

```
https://static.openfintech.io/payment_providers/flocash/icon.svg?w=278&c=v0.59.26#w100
```  

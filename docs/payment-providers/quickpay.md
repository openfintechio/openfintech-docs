...
# QuickPay 
![quickpay](https://static.openfintech.io/payment_providers/quickpay/logo.svg?w=400&c=v0.59.26#w100)  

## General 
 
**Code:** `quickpay` 
 
**Vendor:** `quickpay` [show -->](/vendors/quickpay/) 
...
```
https://static.openfintech.io/payment_providers/quickpay/logo.svg?w=400&c=v0.59.26#w100
```  

### Icon 
 
![quickpay](https://static.openfintech.io/payment_providers/quickpay/icon.svg?w=278&c=v0.59.26#w100)  

```
https://static.openfintech.io/payment_providers/quickpay/icon.svg?w=278&c=v0.59.26#w100
```  

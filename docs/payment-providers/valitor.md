...
# Valitor 
![valitor](https://static.openfintech.io/payment_providers/valitor/logo.png?w=400&c=v0.59.26#w100)  

## General 
 
**Code:** `valitor` 
 
**Vendor:** `valitor` [show -->](/vendors/valitor/) 
...
```
https://static.openfintech.io/payment_providers/valitor/logo.png?w=400&c=v0.59.26#w100
```  

### Icon 
 
![valitor](https://static.openfintech.io/payment_providers/valitor/icon.png?w=278&c=v0.59.26#w100)  

```
https://static.openfintech.io/payment_providers/valitor/icon.png?w=278&c=v0.59.26#w100
```  

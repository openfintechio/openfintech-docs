...
# NationalACH 
![nationalach](https://static.openfintech.io/payment_providers/nationalach/logo.png?w=400&c=v0.59.26#w100)  
...
```
https://static.openfintech.io/payment_providers/nationalach/logo.png?w=400&c=v0.59.26#w100
```  

### Icon 
 
![nationalach](https://static.openfintech.io/payment_providers/nationalach/icon.png?w=278&c=v0.59.26#w100)  

```
https://static.openfintech.io/payment_providers/nationalach/icon.png?w=278&c=v0.59.26#w100
```  

...
# Paylike 
![paylike](https://static.openfintech.io/payment_providers/paylike/logo.png?w=400&c=v0.59.26#w100)  

## General 
 
**Code:** `paylike` 
 
**Vendor:** `paylike` [show -->](/vendors/paylike/) 
...
```
https://static.openfintech.io/payment_providers/paylike/logo.png?w=400&c=v0.59.26#w100
```  

### Icon 
 
![paylike](https://static.openfintech.io/payment_providers/paylike/icon.png?w=278&c=v0.59.26#w100)  

```
https://static.openfintech.io/payment_providers/paylike/icon.png?w=278&c=v0.59.26#w100
```  

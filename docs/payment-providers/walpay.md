...
# WalPay 
![walpay](https://static.openfintech.io/payment_providers/walpay/logo.png?w=400&c=v0.59.26#w100)  

## General 
 
**Code:** `walpay` 
 
**Vendor:** `walpay` [show -->](/vendors/walpay/) 
...
```
https://static.openfintech.io/payment_providers/walpay/logo.png?w=400&c=v0.59.26#w100
```  

### Icon 
 
![walpay](https://static.openfintech.io/payment_providers/walpay/icon.png?w=278&c=v0.59.26#w100)  

```
https://static.openfintech.io/payment_providers/walpay/icon.png?w=278&c=v0.59.26#w100
```  

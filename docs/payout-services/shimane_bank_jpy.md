...
# Shimane Bank (service) 
![shimane_bank_jpy](https://static.openfintech.io/payout_methods/shimane_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `shimane_bank_jpy` 
 
**Method:** `shimane_bank` [show -->](/payout-methods/shimane_bank/) 

...
# Hiroshima Bank (service) 
![hiroshima_bank_jpy](https://static.openfintech.io/payout_methods/hiroshima_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `hiroshima_bank_jpy` 
 
**Method:** `hiroshima_bank` [show -->](/payout-methods/hiroshima_bank/) 

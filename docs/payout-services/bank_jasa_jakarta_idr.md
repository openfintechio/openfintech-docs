...
# Bank Jasa Jakarta (service) 
![bank_jasa_jakarta_idr](https://static.openfintech.io/payout_methods/bank_jasa_jakarta_idr/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `bank_jasa_jakarta_idr` 
 
**Method:** `bank_jasa_jakarta` [show -->](/payout-methods/bank_jasa_jakarta/) 

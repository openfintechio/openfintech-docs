...
![bank_transfer_pln](https://static.openfintech.io/payout_methods/bank_transfer_pln/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `bank_transfer_pln` 
...
**Amount limits:** from `0.01` to `1000000.00` PLN 

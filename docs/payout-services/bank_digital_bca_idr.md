...
# Bank Digital BCA (Blu) / Bank Royal (service) 
![bank_digital_bca_idr](https://static.openfintech.io/payout_methods/bank_digital_bca_idr/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `bank_digital_bca_idr` 
 
**Method:** `bank_digital_bca` [show -->](/payout-methods/bank_digital_bca/) 

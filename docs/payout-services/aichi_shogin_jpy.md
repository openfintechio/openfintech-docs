...
# Aichi Shogin (service) 
![aichi_shogin_jpy](https://static.openfintech.io/payout_methods/aichi_shogin_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `aichi_shogin_jpy` 
 
**Method:** `aichi_shogin` [show -->](/payout-methods/aichi_shogin/) 

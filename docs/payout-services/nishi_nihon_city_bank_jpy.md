...
# Nishi Nihon City Bank (service) 
![nishi_nihon_city_bank_jpy](https://static.openfintech.io/payout_methods/nishi_nihon_city_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `nishi_nihon_city_bank_jpy` 
 
**Method:** `nishi_nihon_city_bank` [show -->](/payout-methods/nishi_nihon_city_bank/) 

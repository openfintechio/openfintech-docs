...
# Prima Master Bank (service) 
![prima_master_bank_idr](https://static.openfintech.io/payout_methods/prima_master_bank_idr/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `prima_master_bank_idr` 
 
**Method:** `prima_master_bank` [show -->](/payout-methods/prima_master_bank/) 

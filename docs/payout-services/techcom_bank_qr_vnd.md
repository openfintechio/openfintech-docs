...
![techcom_bank_qr_vnd](https://static.openfintech.io/payout_methods/techcom_bank_qr_vnd/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `techcom_bank_qr_vnd` 
 
**Method:** `techcom_bank_qr` [show -->](/payout-methods/techcom_bank_qr/) 

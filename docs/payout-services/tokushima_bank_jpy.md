...
# Tokushima Bank (service) 
![tokushima_bank_jpy](https://static.openfintech.io/payout_methods/tokushima_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `tokushima_bank_jpy` 
 
**Method:** `tokushima_bank` [show -->](/payout-methods/tokushima_bank/) 

...
# Türkiye Halk Bankası A.Ş. (service) 
![halk_bank_try](https://static.openfintech.io/payout_methods/halk_bank_try/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `halk_bank_try` 
 
**Method:** `halk_bank` [show -->](/payout-methods/halk_bank/) 

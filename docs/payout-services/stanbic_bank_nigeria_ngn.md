...
# Stanbic IBTC Bank, Nigeria (service) 
![stanbic_bank_nigeria_ngn](https://static.openfintech.io/payout_methods/stanbic_bank_nigeria_ngn/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `stanbic_bank_nigeria_ngn` 
 
**Method:** `stanbic_bank_nigeria` [show -->](/payout-methods/stanbic_bank_nigeria/) 

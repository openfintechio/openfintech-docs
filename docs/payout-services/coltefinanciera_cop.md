...
# COLTEFINANCIERA (service) 
![coltefinanciera_cop](https://static.openfintech.io/payout_methods/coltefinanciera_cop/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `coltefinanciera_cop` 
 
**Method:** `coltefinanciera` [show -->](/payout-methods/coltefinanciera/) 

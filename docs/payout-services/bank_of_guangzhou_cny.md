...
# Bank of Guangzhou (service) 
![bank_of_guangzhou_cny](https://static.openfintech.io/payout_methods/bank_of_guangzhou_cny/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `bank_of_guangzhou_cny` 
 
**Method:** `bank_of_guangzhou` [show -->](/payout-methods/bank_of_guangzhou/) 

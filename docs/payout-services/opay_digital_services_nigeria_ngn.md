...
# OPay Digital Services (service) 
![opay_digital_services_nigeria_ngn](https://static.openfintech.io/payout_methods/opay_digital_services_nigeria_ngn/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `opay_digital_services_nigeria_ngn` 
 
**Method:** `opay_digital_services_nigeria` [show -->](/payout-methods/opay_digital_services_nigeria/) 

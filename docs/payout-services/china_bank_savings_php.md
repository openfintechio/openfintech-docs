...
# Chinabank Savings (service) 
![china_bank_savings_php](https://static.openfintech.io/payout_methods/china_bank_savings_php/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `china_bank_savings_php` 
 
**Method:** `china_bank_savings` [show -->](/payout-methods/china_bank_savings/) 

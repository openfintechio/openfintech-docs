...
# Bank of China Jakarta Branch (service) 
![bank_of_china_jakarta_branch_idr](https://static.openfintech.io/payout_methods/bank_of_china_jakarta_branch_idr/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `bank_of_china_jakarta_branch_idr` 
 
**Method:** `bank_of_china_jakarta_branch` [show -->](/payout-methods/bank_of_china_jakarta_branch/) 

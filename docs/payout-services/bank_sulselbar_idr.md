...
# Bank Sulselbar (service) 
![bank_sulselbar_idr](https://static.openfintech.io/payout_methods/bank_sulselbar_idr/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `bank_sulselbar_idr` 
 
**Method:** `bank_sulselbar` [show -->](/payout-methods/bank_sulselbar/) 

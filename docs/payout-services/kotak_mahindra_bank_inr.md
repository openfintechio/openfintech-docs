...
![kotak_mahindra_bank_inr](https://static.openfintech.io/payout_methods/kotak_mahindra_bank_inr/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `kotak_mahindra_bank_inr` 
 
**Method:** `kotak_mahindra_bank` [show -->](/payout-methods/kotak_mahindra_bank/) 

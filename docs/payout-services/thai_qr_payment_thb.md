...
# Thai QR Payment (service) 
![thai_qr_payment_thb](https://static.openfintech.io/payout_methods/thai_qr_payment_thb/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `thai_qr_payment_thb` 
 
**Method:** `thai_qr_payment` [show -->](/payout-methods/thai_qr_payment/) 

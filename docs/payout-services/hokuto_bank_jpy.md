...
# Hokuto Bank (service) 
![hokuto_bank_jpy](https://static.openfintech.io/payout_methods/hokuto_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `hokuto_bank_jpy` 
 
**Method:** `hokuto_bank` [show -->](/payout-methods/hokuto_bank/) 

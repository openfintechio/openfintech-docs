...
# Yapı ve Kredi Bankası A.Ş. (service) 
![yapi_kredi_bank_try](https://static.openfintech.io/payout_methods/yapi_kredi_bank_try/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `yapi_kredi_bank_try` 
 
**Method:** `yapi_kredi_bank` [show -->](/payout-methods/yapi_kredi_bank/) 

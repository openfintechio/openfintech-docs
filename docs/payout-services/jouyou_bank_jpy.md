...
# Jouyou Bank (service) 
![jouyou_bank_jpy](https://static.openfintech.io/payout_methods/jouyou_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `jouyou_bank_jpy` 
 
**Method:** `jouyou_bank` [show -->](/payout-methods/jouyou_bank/) 

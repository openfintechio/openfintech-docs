...
# Japan Post Bank (service) 
![japan_post_bank_jpy](https://static.openfintech.io/payout_methods/japan_post_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `japan_post_bank_jpy` 
 
**Method:** `japan_post_bank` [show -->](/payout-methods/japan_post_bank/) 

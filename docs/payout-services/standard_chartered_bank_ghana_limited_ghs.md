...
# Standard Chartered Bank Ghana Limited (service) 
![standard_chartered_bank_ghana_limited_ghs](https://static.openfintech.io/payout_methods/standard_chartered_bank_ghana_limited_ghs/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `standard_chartered_bank_ghana_limited_ghs` 
 
**Method:** `standard_chartered_bank_ghana_limited` [show -->](/payout-methods/standard_chartered_bank_ghana_limited/) 
...
**Amount limits:** from `0.11` to `109250` GHS 

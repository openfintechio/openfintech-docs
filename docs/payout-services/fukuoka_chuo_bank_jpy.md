...
# Fukuoka Chuo Bank (service) 
![fukuoka_chuo_bank_jpy](https://static.openfintech.io/payout_methods/fukuoka_chuo_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `fukuoka_chuo_bank_jpy` 
 
**Method:** `fukuoka_chuo_bank` [show -->](/payout-methods/fukuoka_chuo_bank/) 

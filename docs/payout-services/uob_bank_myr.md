...
# UOB Bank (service) 
![uob_bank_myr](https://static.openfintech.io/payout_methods/uob_bank_myr/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `uob_bank_myr` 
 
**Method:** `uob_bank` [show -->](/payout-methods/uob_bank/) 
...
**Amount limits:** from `0.01` to `450000` MYR 

...
![bank_transfer_idr](https://static.openfintech.io/payout_methods/bank_transfer_idr/logo.svg?w=400&c=v0.59.26#w24)  
...
**Amount limits:** from `0.01` to `100000.00` IDR 

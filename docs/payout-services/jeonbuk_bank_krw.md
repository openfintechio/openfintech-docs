...
# The Jeonbuk Bank Ltd (service) 
![jeonbuk_bank_krw](https://static.openfintech.io/payout_methods/jeonbuk_bank_krw/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `jeonbuk_bank_krw` 
 
**Method:** `jeonbuk_bank` [show -->](/payout-methods/jeonbuk_bank/) 

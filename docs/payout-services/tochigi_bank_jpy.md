...
# Tochigi Bank (service) 
![tochigi_bank_jpy](https://static.openfintech.io/payout_methods/tochigi_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `tochigi_bank_jpy` 
 
**Method:** `tochigi_bank` [show -->](/payout-methods/tochigi_bank/) 

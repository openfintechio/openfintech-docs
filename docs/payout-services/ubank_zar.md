...
# Ubank LTD, South Africa (service) 
![ubank_zar](https://static.openfintech.io/payout_methods/ubank_zar/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `ubank_zar` 
 
**Method:** `ubank` [show -->](/payout-methods/ubank/) 

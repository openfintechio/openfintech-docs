...
# Kochi Bank (service) 
![kochi_bank_jpy](https://static.openfintech.io/payout_methods/kochi_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `kochi_bank_jpy` 
 
**Method:** `kochi_bank` [show -->](/payout-methods/kochi_bank/) 

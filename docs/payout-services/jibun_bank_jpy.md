...
# Jibun Bank (service) 
![jibun_bank_jpy](https://static.openfintech.io/payout_methods/jibun_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `jibun_bank_jpy` 
 
**Method:** `jibun_bank` [show -->](/payout-methods/jibun_bank/) 

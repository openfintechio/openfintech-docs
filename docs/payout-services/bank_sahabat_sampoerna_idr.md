...
# Bank Sahabat Sampoerna (service) 
![bank_sahabat_sampoerna_idr](https://static.openfintech.io/payout_methods/bank_sahabat_sampoerna_idr/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `bank_sahabat_sampoerna_idr` 
 
**Method:** `bank_sahabat_sampoerna` [show -->](/payout-methods/bank_sahabat_sampoerna/) 

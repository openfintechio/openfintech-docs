...
# Tomato Bank (service) 
![tomato_bank_jpy](https://static.openfintech.io/payout_methods/tomato_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `tomato_bank_jpy` 
 
**Method:** `tomato_bank` [show -->](/payout-methods/tomato_bank/) 

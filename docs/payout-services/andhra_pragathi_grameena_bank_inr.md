...
# Andhra Pragathi Grameena Bank (service) 
![andhra_pragathi_grameena_bank_inr](https://static.openfintech.io/payout_methods/andhra_pragathi_grameena_bank_inr/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `andhra_pragathi_grameena_bank_inr` 
 
**Method:** `andhra_pragathi_grameena_bank` [show -->](/payout-methods/andhra_pragathi_grameena_bank/) 

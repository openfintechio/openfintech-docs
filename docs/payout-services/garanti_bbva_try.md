...
# T. Garanti Bankası A.Ş. (service) 
![garanti_bbva_try](https://static.openfintech.io/payout_methods/garanti_bbva_try/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `garanti_bbva_try` 
 
**Method:** `garanti_bbva` [show -->](/payout-methods/garanti_bbva/) 

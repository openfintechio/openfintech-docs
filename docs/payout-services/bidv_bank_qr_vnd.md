...
![bidv_bank_qr_vnd](https://static.openfintech.io/payout_methods/bidv_bank_qr_vnd/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `bidv_bank_qr_vnd` 
 
**Method:** `bidv_bank_qr` [show -->](/payout-methods/bidv_bank_qr/) 

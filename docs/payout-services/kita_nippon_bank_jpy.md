...
# Kita-Nippon Bank (service) 
![kita_nippon_bank_jpy](https://static.openfintech.io/payout_methods/kita_nippon_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `kita_nippon_bank_jpy` 
 
**Method:** `kita_nippon_bank` [show -->](/payout-methods/kita_nippon_bank/) 

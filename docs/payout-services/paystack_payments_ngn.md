...
![paystack_payments_ngn](https://static.openfintech.io/payout_methods/paystack_payments_ngn/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `paystack_payments_ngn` 
 
**Method:** `paystack_payments` [show -->](/payout-methods/paystack_payments/) 

...
# RappiPay Compañía de Financiamiento S.A (service) 
![rappipay_cop](https://static.openfintech.io/payout_methods/rappipay_cop/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `rappipay_cop` 
 
**Method:** `rappipay` [show -->](/payout-methods/rappipay/) 

...
# Kiatnakin Bank (service) 
![kiatnakin_bank_thb](https://static.openfintech.io/payout_methods/kiatnakin_bank_thb/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `kiatnakin_bank_thb` 
 
**Method:** `kiatnakin_bank` [show -->](/payout-methods/kiatnakin_bank/) 

...
# Jin Shang Commercial Bank (service) 
![jin_shang_commercial_bank_cny](https://static.openfintech.io/payout_methods/jin_shang_commercial_bank_cny/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `jin_shang_commercial_bank_cny` 
 
**Method:** `jin_shang_commercial_bank` [show -->](/payout-methods/jin_shang_commercial_bank/) 

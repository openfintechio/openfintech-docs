...
# VBS Mutual Bank, South Africa (service) 
![vbs_mutual_bank_zar](https://static.openfintech.io/payout_methods/vbs_mutual_bank_zar/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `vbs_mutual_bank_zar` 
 
**Method:** `vbs_mutual_bank` [show -->](/payout-methods/vbs_mutual_bank/) 

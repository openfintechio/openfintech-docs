...
# Australia and New Zealand Banking (ANZ Bank) (service) 
![anz_bank_vnd](https://static.openfintech.io/payout_methods/anz_bank_vnd/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `anz_bank_vnd` 
 
**Method:** `anz_bank` [show -->](/payout-methods/anz_bank/) 

...
# Vietnam Maritime Commercial Joint Stock Bank (service) 
![maritime_bank_vnd](https://static.openfintech.io/payout_methods/maritime_bank_vnd/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `maritime_bank_vnd` 
 
**Method:** `maritime_bank` [show -->](/payout-methods/maritime_bank/) 

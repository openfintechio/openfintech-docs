...
# Tottori Bank (service) 
![tottori_bank_jpy](https://static.openfintech.io/payout_methods/tottori_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `tottori_bank_jpy` 
 
**Method:** `tottori_bank` [show -->](/payout-methods/tottori_bank/) 

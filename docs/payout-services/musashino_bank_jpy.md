...
# Musashino Bank (service) 
![musashino_bank_jpy](https://static.openfintech.io/payout_methods/musashino_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `musashino_bank_jpy` 
 
**Method:** `musashino_bank` [show -->](/payout-methods/musashino_bank/) 

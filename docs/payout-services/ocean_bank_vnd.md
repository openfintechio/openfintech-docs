...
# Ocean Commercial One Member Limited Liability Bank (service) 
![ocean_bank_vnd](https://static.openfintech.io/payout_methods/ocean_bank_vnd/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `ocean_bank_vnd` 
 
**Method:** `ocean_bank` [show -->](/payout-methods/ocean_bank/) 

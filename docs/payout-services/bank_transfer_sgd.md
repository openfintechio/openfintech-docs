...
![bank_transfer_sgd](https://static.openfintech.io/payout_methods/bank_transfer_sgd/logo.svg?w=400&c=v0.59.26#w24)  
...
**Amount limits:** from `0.01` to `1000000.00` SGD 

...
# Vietnam International Commercial Joint Stock Bank (service) 
![vib_bank_vnd](https://static.openfintech.io/payout_methods/vib_bank_vnd/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `vib_bank_vnd` 
 
**Method:** `vib_bank` [show -->](/payout-methods/vib_bank/) 

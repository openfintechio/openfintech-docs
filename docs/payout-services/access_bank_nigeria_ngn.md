...
# Access Bank Nigeria (service) 
![access_bank_nigeria_ngn](https://static.openfintech.io/payout_methods/access_bank_nigeria_ngn/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `access_bank_nigeria_ngn` 
 
**Method:** `access_bank_nigeria` [show -->](/payout-methods/access_bank_nigeria/) 

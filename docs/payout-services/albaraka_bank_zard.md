...
# Albaraka Bank, South Africa (service) 
![albaraka_bank_zard](https://static.openfintech.io/payout_methods/albaraka_bank_zard/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `albaraka_bank_zard` 
 
**Method:** `albaraka_bank` [show -->](/payout-methods/albaraka_bank/) 

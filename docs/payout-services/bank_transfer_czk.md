...
![bank_transfer_czk](https://static.openfintech.io/payout_methods/bank_transfer_czk/logo.svg?w=400&c=v0.59.26#w24)  
...
**Amount limits:** from `0.01` to `22000000.00` CZK 

...
# Shinsei Bank (service) 
![shinsei_bank_jpy](https://static.openfintech.io/payout_methods/shinsei_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `shinsei_bank_jpy` 
 
**Method:** `shinsei_bank` [show -->](/payout-methods/shinsei_bank/) 

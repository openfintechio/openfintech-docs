...
# Bank Of NanJing (service) 
![bank_of_nanjing_cny](https://static.openfintech.io/payout_methods/bank_of_nanjing_cny/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `bank_of_nanjing_cny` 
 
**Method:** `bank_of_nanjing` [show -->](/payout-methods/bank_of_nanjing/) 

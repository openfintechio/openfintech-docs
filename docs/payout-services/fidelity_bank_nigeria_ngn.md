...
# Fidelity Bank, Nigeria (service) 
![fidelity_bank_nigeria_ngn](https://static.openfintech.io/payout_methods/fidelity_bank_nigeria_ngn/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `fidelity_bank_nigeria_ngn` 
 
**Method:** `fidelity_bank_nigeria` [show -->](/payout-methods/fidelity_bank_nigeria/) 

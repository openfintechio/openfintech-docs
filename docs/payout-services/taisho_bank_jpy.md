...
# Taisho Bank (service) 
![taisho_bank_jpy](https://static.openfintech.io/payout_methods/taisho_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `taisho_bank_jpy` 
 
**Method:** `taisho_bank` [show -->](/payout-methods/taisho_bank/) 

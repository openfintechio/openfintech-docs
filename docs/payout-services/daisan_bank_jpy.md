...
# Daisan Bank (service) 
![daisan_bank_jpy](https://static.openfintech.io/payout_methods/daisan_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `daisan_bank_jpy` 
 
**Method:** `daisan_bank` [show -->](/payout-methods/daisan_bank/) 

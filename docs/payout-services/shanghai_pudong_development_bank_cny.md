...
![shanghai_pudong_development_bank_cny](https://static.openfintech.io/payout_methods/shanghai_pudong_development_bank_cny/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `shanghai_pudong_development_bank_cny` 
 
**Method:** `shanghai_pudong_development_bank` [show -->](/payout-methods/shanghai_pudong_development_bank/) 

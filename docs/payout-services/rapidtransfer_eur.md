...
![rapidtransfer_eur](https://static.openfintech.io/payout_methods/rapidtransfer_eur/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `rapidtransfer_eur` 
 
**Method:** `rapidtransfer` [show -->](/payout-methods/rapidtransfer/) 
...
**Amount limits:** from `1` to `90000` EUR 

...
# Fukushima Bank (service) 
![fukushima_bank_jpy](https://static.openfintech.io/payout_methods/fukushima_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `fukushima_bank_jpy` 
 
**Method:** `fukushima_bank` [show -->](/payout-methods/fukushima_bank/) 

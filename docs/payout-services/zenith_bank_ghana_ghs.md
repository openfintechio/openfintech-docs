...
# Zenith Bank Ghana (service) 
![zenith_bank_ghana_ghs](https://static.openfintech.io/payout_methods/zenith_bank_ghana_ghs/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `zenith_bank_ghana_ghs` 
 
**Method:** `zenith_bank_ghana` [show -->](/payout-methods/zenith_bank_ghana/) 

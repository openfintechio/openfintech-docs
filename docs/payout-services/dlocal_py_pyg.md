...
# dlocal (service) 
![dlocal_py_pyg](https://static.openfintech.io/payout_methods/dlocal_py_pyg/logo.svg?w=400&c=v0.59.26#w24)  
...
|:---:|:---:|:---:|:---:| 
|`document_id`|✔|`string`|`/^[0-9]{7,8}$/`| 
|`document_type`|✔|`string`|`/^(CI\|RUC)$/`| 
|`beneficiary_name`|✔|`string`|`/^[A-Z\-\sa-z]{2,100}$/`| 
|`beneficiary_lastname`|✔|`string`|`/^[A-Z\-\sa-z]{2,100}$/`| 
|`bank_account`|✔|`string`|`/^[0-9]{16}$/`| 
|`bank_code`|✗|`string`|`/^[1-9]{1}$\|^[1-3]{1}[0-9]{1}\|^(40){1}$/`| 

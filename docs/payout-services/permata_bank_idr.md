...
![permata_bank_idr](https://static.openfintech.io/payout_methods/permata_bank_idr/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `permata_bank_idr` 
 
**Method:** `permata_bank` [show -->](/payout-methods/permata_bank/) 

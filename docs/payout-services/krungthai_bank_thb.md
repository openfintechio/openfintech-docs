...
![krungthai_bank_thb](https://static.openfintech.io/payout_methods/krungthai_bank_thb/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `krungthai_bank_thb` 
 
**Method:** `krungthai_bank` [show -->](/payout-methods/krungthai_bank/) 

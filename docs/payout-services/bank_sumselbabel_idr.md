...
# Bank Sumselbabel (service) 
![bank_sumselbabel_idr](https://static.openfintech.io/payout_methods/bank_sumselbabel_idr/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `bank_sumselbabel_idr` 
 
**Method:** `bank_sumselbabel` [show -->](/payout-methods/bank_sumselbabel/) 

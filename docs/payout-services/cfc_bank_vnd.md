...
# VietCredit Finance Joint Stock Company (service) 
![cfc_bank_vnd](https://static.openfintech.io/payout_methods/cfc_bank_vnd/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `cfc_bank_vnd` 
 
**Method:** `cfc_bank` [show -->](/payout-methods/cfc_bank/) 

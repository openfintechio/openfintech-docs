...
# Yamaguchi Bank (service) 
![yamaguchi_bank_jpy](https://static.openfintech.io/payout_methods/yamaguchi_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `yamaguchi_bank_jpy` 
 
**Method:** `yamaguchi_bank` [show -->](/payout-methods/yamaguchi_bank/) 

...
# Steel Legion (service) 
![stalnoi-legion_uah](https://static.openfintech.io/payout_methods/stalnoi-legion_uah/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `stalnoi-legion_uah` 
 
**Method:** `stalnoi-legion` [show -->](/payout-methods/stalnoi-legion/) 

...
# Public Bank Berhad (service) 
![public_bank_berhad_myr](https://static.openfintech.io/payout_methods/public_bank_berhad_myr/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `public_bank_berhad_myr` 
 
**Method:** `public_bank_berhad` [show -->](/payout-methods/public_bank_berhad/) 

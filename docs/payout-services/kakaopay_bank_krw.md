...
# Kakaopay Securities Corp. (service) 
![kakaopay_bank_krw](https://static.openfintech.io/payout_methods/kakaopay_bank_krw/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `kakaopay_bank_krw` 
 
**Method:** `kakaopay_bank` [show -->](/payout-methods/kakaopay_bank/) 

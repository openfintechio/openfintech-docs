...
# Vietnam Bank for Agriculture and Rural Development (service) 
![agri_bank_vnd](https://static.openfintech.io/payout_methods/agri_bank_vnd/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `agri_bank_vnd` 
 
**Method:** `agri_bank` [show -->](/payout-methods/agri_bank/) 
...
|:---:|:---:|:---:|:---:| 
|`bank_branch`|✗|`string`|`/^[A-Za-zА-Яа-я\-\d\s]{2,100}$/`| 

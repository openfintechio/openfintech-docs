...
# Finbond EPE (service) 
![finbond_epe_zar](https://static.openfintech.io/payout_methods/finbond_epe_zar/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `finbond_epe_zar` 
 
**Method:** `finbond_epe` [show -->](/payout-methods/finbond_epe/) 

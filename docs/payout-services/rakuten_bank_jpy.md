...
# Rakuten Bank (service) 
![rakuten_bank_jpy](https://static.openfintech.io/payout_methods/rakuten_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `rakuten_bank_jpy` 
 
**Method:** `rakuten_bank` [show -->](/payout-methods/rakuten_bank/) 

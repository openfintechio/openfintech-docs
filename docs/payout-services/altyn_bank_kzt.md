...
# Altyn Bank (service) 
![altyn_bank_kzt](https://static.openfintech.io/payout_methods/altyn_bank_kzt/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `altyn_bank_kzt` 
 
**Method:** `altyn_bank` [show -->](/payout-methods/altyn_bank/) 

...
# EcoCash (service) 
![ecocash_bif](https://static.openfintech.io/payout_methods/ecocash_bif/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `ecocash_bif` 
 
**Method:** `ecocash` [show -->](/payout-methods/ecocash/) 
 
**Currency:** `BIF` [show -->](/currencies/BIF/) 
 
**Name:** 
 
:	[EN] EcoCash 
 
**Amount limits:** from `1` to `300000000` BIF 

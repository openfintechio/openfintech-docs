...
# African Bank, South Africa (service) 
![african_bank_zar](https://static.openfintech.io/payout_methods/african_bank_zar/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `african_bank_zar` 
 
**Method:** `african_bank` [show -->](/payout-methods/african_bank/) 

...
# Shiga Bank (service) 
![shiga_bank_jpy](https://static.openfintech.io/payout_methods/shiga_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `shiga_bank_jpy` 
 
**Method:** `shiga_bank` [show -->](/payout-methods/shiga_bank/) 

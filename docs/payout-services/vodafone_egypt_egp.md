...
# Vodafone Egypt (service) 
![vodafone_egypt_egp](https://static.openfintech.io/payout_methods/vodafone_egypt_egp/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `vodafone_egypt_egp` 
 
**Method:** `vodafone_egypt` [show -->](/payout-methods/vodafone_egypt/) 
...
**Amount limits:** from `0.05` to `5000000` EGP 

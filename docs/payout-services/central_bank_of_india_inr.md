...
![central_bank_of_india_inr](https://static.openfintech.io/payout_methods/central_bank_of_india_inr/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `central_bank_of_india_inr` 
 
**Method:** `central_bank_of_india` [show -->](/payout-methods/central_bank_of_india/) 

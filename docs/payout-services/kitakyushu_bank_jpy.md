...
# Kitakyushu Bank (service) 
![kitakyushu_bank_jpy](https://static.openfintech.io/payout_methods/kitakyushu_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `kitakyushu_bank_jpy` 
 
**Method:** `kitakyushu_bank` [show -->](/payout-methods/kitakyushu_bank/) 

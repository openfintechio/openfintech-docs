...
# Tether (service) 
![tether_polygon_usdt_hpp](https://static.openfintech.io/payout_methods/tether_polygon_usdt_hpp/logo.svg?w=400&c=v0.59.26#w24)  
...
**Amount limits:** from `0.00000001` to `100000` USDT 

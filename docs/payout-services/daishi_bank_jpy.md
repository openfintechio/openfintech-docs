...
# Daishi Bank (service) 
![daishi_bank_jpy](https://static.openfintech.io/payout_methods/daishi_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `daishi_bank_jpy` 
 
**Method:** `daishi_bank` [show -->](/payout-methods/daishi_bank/) 

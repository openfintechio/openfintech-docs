...
# KIWOOM SECURITIES CO LTD (service) 
![kiwoom_bank_krw](https://static.openfintech.io/payout_methods/kiwoom_bank_krw/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `kiwoom_bank_krw` 
 
**Method:** `kiwoom_bank` [show -->](/payout-methods/kiwoom_bank/) 

...
# Toyama Bank (service) 
![toyama_bank_jpy](https://static.openfintech.io/payout_methods/toyama_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `toyama_bank_jpy` 
 
**Method:** `toyama_bank` [show -->](/payout-methods/toyama_bank/) 

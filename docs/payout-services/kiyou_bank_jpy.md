...
# Kiyou Bank (service) 
![kiyou_bank_jpy](https://static.openfintech.io/payout_methods/kiyou_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `kiyou_bank_jpy` 
 
**Method:** `kiyou_bank` [show -->](/payout-methods/kiyou_bank/) 

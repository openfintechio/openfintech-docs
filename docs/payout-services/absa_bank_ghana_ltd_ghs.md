...
# Absa Bank Ghana Ltd (service) 
![absa_bank_ghana_ltd_ghs](https://static.openfintech.io/payout_methods/absa_bank_ghana_ltd_ghs/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `absa_bank_ghana_ltd_ghs` 
 
**Method:** `absa_bank_ghana_ltd` [show -->](/payout-methods/absa_bank_ghana_ltd/) 

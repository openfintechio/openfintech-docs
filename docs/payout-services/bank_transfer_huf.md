...
![bank_transfer_huf](https://static.openfintech.io/payout_methods/bank_transfer_huf/logo.svg?w=400&c=v0.59.26#w24)  
...
**Amount limits:** from `0.01` to `350000000.00` HUF 

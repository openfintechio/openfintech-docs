...
# PBCom (Philippine Bank of Communications) (service) 
![philippine_bank_of_communications_php](https://static.openfintech.io/payout_methods/philippine_bank_of_communications_php/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `philippine_bank_of_communications_php` 
 
**Method:** `philippine_bank_of_communications` [show -->](/payout-methods/philippine_bank_of_communications/) 

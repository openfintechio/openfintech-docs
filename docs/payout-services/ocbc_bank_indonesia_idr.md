...
# OCBC (OCBC Bank Indonesia) (service) 
![ocbc_bank_indonesia_idr](https://static.openfintech.io/payout_methods/ocbc_bank_indonesia_idr/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `ocbc_bank_indonesia_idr` 
 
**Method:** `ocbc_bank_indonesia` [show -->](/payout-methods/ocbc_bank_indonesia/) 

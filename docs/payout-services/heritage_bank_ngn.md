...
# Heritage Bank (service) 
![heritage_bank_ngn](https://static.openfintech.io/payout_methods/heritage_bank_ngn/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `heritage_bank_ngn` 
 
**Method:** `heritage_bank` [show -->](/payout-methods/heritage_bank/) 

...
# FCMB Plc, Nigeria (service) 
![fsmb_nigeria_ngn](https://static.openfintech.io/payout_methods/fsmb_nigeria_ngn/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `fsmb_nigeria_ngn` 
 
**Method:** `fsmb_nigeria` [show -->](/payout-methods/fsmb_nigeria/) 

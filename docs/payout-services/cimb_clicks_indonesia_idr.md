...
![cimb_clicks_indonesia_idr](https://static.openfintech.io/payout_methods/cimb_clicks_indonesia_idr/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `cimb_clicks_indonesia_idr` 
 
**Method:** `cimb_clicks_indonesia` [show -->](/payout-methods/cimb_clicks_indonesia/) 

...
# Sanin Goudou Bank (service) 
![san_in_godo_bank_jpy](https://static.openfintech.io/payout_methods/san_in_godo_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `san_in_godo_bank_jpy` 
 
**Method:** `san_in_godo_bank` [show -->](/payout-methods/san_in_godo_bank/) 

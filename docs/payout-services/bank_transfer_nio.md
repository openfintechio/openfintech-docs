...
![bank_transfer_nio](https://static.openfintech.io/payout_methods/bank_transfer_nio/logo.svg?w=400&c=v0.59.26#w24)  
...
**Currency:** `NIO` [show -->](/currencies/NIO/) 
...
**Amount limits:** from `1` to `3700000` NIO 

...
# Bank Papua (service) 
![bank_papua_idr](https://static.openfintech.io/payout_methods/bank_papua_idr/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `bank_papua_idr` 
 
**Method:** `bank_papua` [show -->](/payout-methods/bank_papua/) 

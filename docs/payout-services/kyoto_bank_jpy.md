...
# Kyoto Bank (service) 
![kyoto_bank_jpy](https://static.openfintech.io/payout_methods/kyoto_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `kyoto_bank_jpy` 
 
**Method:** `kyoto_bank` [show -->](/payout-methods/kyoto_bank/) 

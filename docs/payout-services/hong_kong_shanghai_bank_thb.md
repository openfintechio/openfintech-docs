...
# Hong Kong Shanghai Bank (service) 
![hong_kong_shanghai_bank_thb](https://static.openfintech.io/payout_methods/hong_kong_shanghai_bank_thb/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `hong_kong_shanghai_bank_thb` 
 
**Method:** `hong_kong_shanghai_bank` [show -->](/payout-methods/hong_kong_shanghai_bank/) 

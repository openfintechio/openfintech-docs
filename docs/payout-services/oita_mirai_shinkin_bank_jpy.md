...
# The Oita Mirai Shinkin Bank (service) 
![oita_mirai_shinkin_bank_jpy](https://static.openfintech.io/payout_methods/oita_mirai_shinkin_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `oita_mirai_shinkin_bank_jpy` 
 
**Method:** `oita_mirai_shinkin_bank` [show -->](/payout-methods/oita_mirai_shinkin_bank/) 

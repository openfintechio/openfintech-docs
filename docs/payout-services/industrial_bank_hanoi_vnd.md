...
# INDUSTRIAL BANK OF KOREA – HANOI BRANCH (service) 
![industrial_bank_hanoi_vnd](https://static.openfintech.io/payout_methods/industrial_bank_hanoi_vnd/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `industrial_bank_hanoi_vnd` 
 
**Method:** `industrial_bank_hanoi` [show -->](/payout-methods/industrial_bank_hanoi/) 

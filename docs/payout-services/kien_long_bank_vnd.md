...
# Kien Long Commercial Joint - Stock Bank (service) 
![kien_long_bank_vnd](https://static.openfintech.io/payout_methods/kien_long_bank_vnd/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `kien_long_bank_vnd` 
 
**Method:** `kien_long_bank` [show -->](/payout-methods/kien_long_bank/) 

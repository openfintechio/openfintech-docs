...
![capitec_bank_zar](https://static.openfintech.io/payout_methods/capitec_bank_zar/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `capitec_bank_zar` 
 
**Method:** `capitec_bank` [show -->](/payout-methods/capitec_bank/) 

...
# Turkey Is Bank (service) 
![turkey_is_bank_nok](https://static.openfintech.io/payout_methods/turkey_is_bank_nok/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `turkey_is_bank_nok` 
 
**Method:** `turkey_is_bank` [show -->](/payout-methods/turkey_is_bank/) 

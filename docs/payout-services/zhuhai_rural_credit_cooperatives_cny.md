...
# Zhuhai Rural Credit Cooperatives (service) 
![zhuhai_rural_credit_cooperatives_cny](https://static.openfintech.io/payout_methods/zhuhai_rural_credit_cooperatives_cny/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `zhuhai_rural_credit_cooperatives_cny` 
 
**Method:** `zhuhai_rural_credit_cooperatives` [show -->](/payout-methods/zhuhai_rural_credit_cooperatives/) 

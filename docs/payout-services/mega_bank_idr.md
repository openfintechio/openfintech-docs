...
# Mega International Commercial Bank (service) 
![mega_bank_idr](https://static.openfintech.io/payout_methods/mega_bank_idr/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `mega_bank_idr` 
 
**Method:** `mega_bank` [show -->](/payout-methods/mega_bank/) 

...
# Vodafone Ghana (service) 
![vodafone_ghana_ghs](https://static.openfintech.io/payout_methods/vodafone_ghana_ghs/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `vodafone_ghana_ghs` 
 
**Method:** `vodafone_ghana` [show -->](/payout-methods/vodafone_ghana/) 
...
**Amount limits:** from `0.01` to `1200000` GHS 

...
# Aichi Bank (service) 
![aichi_bank_jpy](https://static.openfintech.io/payout_methods/aichi_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `aichi_bank_jpy` 
 
**Method:** `aichi_bank` [show -->](/payout-methods/aichi_bank/) 

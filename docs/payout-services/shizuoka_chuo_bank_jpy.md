...
# Shizuoka Chuo Bank (service) 
![shizuoka_chuo_bank_jpy](https://static.openfintech.io/payout_methods/shizuoka_chuo_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `shizuoka_chuo_bank_jpy` 
 
**Method:** `shizuoka_chuo_bank` [show -->](/payout-methods/shizuoka_chuo_bank/) 

...
# Shimizu Bank (service) 
![shimizu_bank_jpy](https://static.openfintech.io/payout_methods/shimizu_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `shimizu_bank_jpy` 
 
**Method:** `shimizu_bank` [show -->](/payout-methods/shimizu_bank/) 

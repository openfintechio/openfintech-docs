...
![bangko_bank_thb](https://static.openfintech.io/payout_methods/bangko_bank_thb/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `bangko_bank_thb` 
 
**Method:** `bangko_bank` [show -->](/payout-methods/bangko_bank/) 

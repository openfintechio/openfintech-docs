...
# Alliance Bank Malaysia Berhad (service) 
![alliance_bank_myr](https://static.openfintech.io/payout_methods/alliance_bank_myr/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `alliance_bank_myr` 
 
**Method:** `alliance_bank` [show -->](/payout-methods/alliance_bank/) 

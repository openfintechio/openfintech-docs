...
# Akita Bank (service) 
![akita_bank_jpy](https://static.openfintech.io/payout_methods/akita_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `akita_bank_jpy` 
 
**Method:** `akita_bank` [show -->](/payout-methods/akita_bank/) 

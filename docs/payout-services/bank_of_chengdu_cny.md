...
# BANK OF CHENGDU (service) 
![bank_of_chengdu_cny](https://static.openfintech.io/payout_methods/bank_of_chengdu_cny/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `bank_of_chengdu_cny` 
 
**Method:** `bank_of_chengdu` [show -->](/payout-methods/bank_of_chengdu/) 

...
# K-Bank (service) 
![k_bank_south_korea_krw](https://static.openfintech.io/payout_methods/k_bank_south_korea_krw/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `k_bank_south_korea_krw` 
 
**Method:** `k_bank_south_korea` [show -->](/payout-methods/k_bank_south_korea/) 

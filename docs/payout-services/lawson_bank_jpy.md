...
# Lawson Bank (service) 
![lawson_bank_jpy](https://static.openfintech.io/payout_methods/lawson_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `lawson_bank_jpy` 
 
**Method:** `lawson_bank` [show -->](/payout-methods/lawson_bank/) 

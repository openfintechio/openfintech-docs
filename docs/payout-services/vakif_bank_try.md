...
# VakıfBank (service) 
![vakif_bank_try](https://static.openfintech.io/payout_methods/vakif_bank_try/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `vakif_bank_try` 
 
**Method:** `vakif_bank` [show -->](/payout-methods/vakif_bank/) 

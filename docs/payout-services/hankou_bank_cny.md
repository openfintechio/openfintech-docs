...
# Hankou Bank (service) 
![hankou_bank_cny](https://static.openfintech.io/payout_methods/hankou_bank_cny/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `hankou_bank_cny` 
 
**Method:** `hankou_bank` [show -->](/payout-methods/hankou_bank/) 

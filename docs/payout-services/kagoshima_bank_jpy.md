...
# Kagoshima Bank (service) 
![kagoshima_bank_jpy](https://static.openfintech.io/payout_methods/kagoshima_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `kagoshima_bank_jpy` 
 
**Method:** `kagoshima_bank` [show -->](/payout-methods/kagoshima_bank/) 

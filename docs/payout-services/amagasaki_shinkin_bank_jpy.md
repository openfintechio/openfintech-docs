...
# Amagasaki Shinkin Bank (service) 
![amagasaki_shinkin_bank_jpy](https://static.openfintech.io/payout_methods/amagasaki_shinkin_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `amagasaki_shinkin_bank_jpy` 
 
**Method:** `amagasaki_shinkin_bank` [show -->](/payout-methods/amagasaki_shinkin_bank/) 

...
# Kansai Mirai Bank (service) 
![kansai_mirai_bank_jpy](https://static.openfintech.io/payout_methods/kansai_mirai_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `kansai_mirai_bank_jpy` 
 
**Method:** `kansai_mirai_bank` [show -->](/payout-methods/kansai_mirai_bank/) 

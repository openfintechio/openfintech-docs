...
# The Hongkong and Shanghai Banking Corporation Limit (service) 
![hsbc_hong_kong_jpy](https://static.openfintech.io/payout_methods/hsbc_hong_kong_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `hsbc_hong_kong_jpy` 
 
**Method:** `hsbc_hong_kong` [show -->](/payout-methods/hsbc_hong_kong/) 

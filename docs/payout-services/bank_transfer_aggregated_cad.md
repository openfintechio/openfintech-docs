...
![bank_transfer_aggregated_cad](https://static.openfintech.io/payout_methods/bank_transfer_aggregated_cad/logo.svg?w=400&c=v0.59.26#w24)  
...
4. **`beneficiary_country_code_iso`** 

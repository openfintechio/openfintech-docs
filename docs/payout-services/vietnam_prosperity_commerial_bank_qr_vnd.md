...
![vietnam_prosperity_commerial_bank_qr_vnd](https://static.openfintech.io/payout_methods/vietnam_prosperity_commerial_bank_qr_vnd/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `vietnam_prosperity_commerial_bank_qr_vnd` 
 
**Method:** `vietnam_prosperity_commerial_bank_qr` [show -->](/payout-methods/vietnam_prosperity_commerial_bank_qr/) 

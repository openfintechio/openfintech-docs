...
# Seven Bank (service) 
![seven_bank_jpy](https://static.openfintech.io/payout_methods/seven_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `seven_bank_jpy` 
 
**Method:** `seven_bank` [show -->](/payout-methods/seven_bank/) 

...
# Bitcoin (service) 
![bitcoin_clp](https://static.openfintech.io/payout_methods/bitcoin_clp/logo.svg?w=400&c=v0.59.26#w24)  
...
**Amount limits:** from `9` to `90000000` CLP 
...
|:---:|:---:|:---:|:---:| 
|`wallet_id`|✔|`string`|`/^(bc1\|tb1\|[13])[a-zA-HJ-NP-Z0-9]{25,87}$/`| 
...
1. **`wallet_id`** 
	...
	Regexp: `/^(bc1|tb1|[13])[a-zA-HJ-NP-Z0-9]{25,87}$/` 

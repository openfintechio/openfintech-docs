...
# Bank Capital Indonesia (service) 
![bank_capital_indonesia_idr](https://static.openfintech.io/payout_methods/bank_capital_indonesia_idr/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `bank_capital_indonesia_idr` 
 
**Method:** `bank_capital_indonesia` [show -->](/payout-methods/bank_capital_indonesia/) 

...
# Juroku Banks (service) 
![juroku_banks_jpy](https://static.openfintech.io/payout_methods/juroku_banks_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `juroku_banks_jpy` 
 
**Method:** `juroku_banks` [show -->](/payout-methods/juroku_banks/) 

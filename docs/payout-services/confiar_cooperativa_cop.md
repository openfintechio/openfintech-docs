...
# CONFIAR COOPERATIVA FINANCIERA (service) 
![confiar_cooperativa_cop](https://static.openfintech.io/payout_methods/confiar_cooperativa_cop/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `confiar_cooperativa_cop` 
 
**Method:** `confiar_cooperativa` [show -->](/payout-methods/confiar_cooperativa/) 

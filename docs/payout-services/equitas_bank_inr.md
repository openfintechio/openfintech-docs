...
# Equitas Bank (service) 
![equitas_bank_inr](https://static.openfintech.io/payout_methods/equitas_bank_inr/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `equitas_bank_inr` 
 
**Method:** `equitas_bank` [show -->](/payout-methods/equitas_bank/) 

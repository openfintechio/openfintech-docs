...
![ping_an_bank_cny](https://static.openfintech.io/payout_methods/ping_an_bank_cny/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `ping_an_bank_cny` 
 
**Method:** `ping_an_bank` [show -->](/payout-methods/ping_an_bank/) 

...
# FirstRand Bank, South Africa (service) 
![first_rand_bank_zar](https://static.openfintech.io/payout_methods/first_rand_bank_zar/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `first_rand_bank_zar` 
 
**Method:** `first_rand_bank` [show -->](/payout-methods/first_rand_bank/) 

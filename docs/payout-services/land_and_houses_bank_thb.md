...
# Land and Houses Bank Public Company Limited (service) 
![land_and_houses_bank_thb](https://static.openfintech.io/payout_methods/land_and_houses_bank_thb/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `land_and_houses_bank_thb` 
 
**Method:** `land_and_houses_bank` [show -->](/payout-methods/land_and_houses_bank/) 

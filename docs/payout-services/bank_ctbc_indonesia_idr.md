...
# Bank CTBC Indonesia (service) 
![bank_ctbc_indonesia_idr](https://static.openfintech.io/payout_methods/bank_ctbc_indonesia_idr/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `bank_ctbc_indonesia_idr` 
 
**Method:** `bank_ctbc_indonesia` [show -->](/payout-methods/bank_ctbc_indonesia/) 

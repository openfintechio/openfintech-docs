...
# Daito Bank (service) 
![daito_bank_jpy](https://static.openfintech.io/payout_methods/daito_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `daito_bank_jpy` 
 
**Method:** `daito_bank` [show -->](/payout-methods/daito_bank/) 

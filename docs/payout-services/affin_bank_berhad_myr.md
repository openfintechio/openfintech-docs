...
# Affin Bank Berhad (service) 
![affin_bank_berhad_myr](https://static.openfintech.io/payout_methods/affin_bank_berhad_myr/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `affin_bank_berhad_myr` 
 
**Method:** `affin_bank_berhad` [show -->](/payout-methods/affin_bank_berhad/) 

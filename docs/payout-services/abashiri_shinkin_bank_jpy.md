...
# Abashiri Shinkin Bank (service) 
![abashiri_shinkin_bank_jpy](https://static.openfintech.io/payout_methods/abashiri_shinkin_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `abashiri_shinkin_bank_jpy` 
 
**Method:** `abashiri_shinkin_bank` [show -->](/payout-methods/abashiri_shinkin_bank/) 

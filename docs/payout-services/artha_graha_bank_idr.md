...
# Bank Artha Graha (service) 
![artha_graha_bank_idr](https://static.openfintech.io/payout_methods/artha_graha_bank_idr/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `artha_graha_bank_idr` 
 
**Method:** `artha_graha_bank` [show -->](/payout-methods/artha_graha_bank/) 

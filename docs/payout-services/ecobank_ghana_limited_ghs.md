...
# Ecobank Ghana Limited (service) 
![ecobank_ghana_limited_ghs](https://static.openfintech.io/payout_methods/ecobank_ghana_limited_ghs/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `ecobank_ghana_limited_ghs` 
 
**Method:** `ecobank_ghana_limited` [show -->](/payout-methods/ecobank_ghana_limited/) 

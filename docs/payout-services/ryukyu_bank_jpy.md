...
# Ryukyu Bank (service) 
![ryukyu_bank_jpy](https://static.openfintech.io/payout_methods/ryukyu_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `ryukyu_bank_jpy` 
 
**Method:** `ryukyu_bank` [show -->](/payout-methods/ryukyu_bank/) 

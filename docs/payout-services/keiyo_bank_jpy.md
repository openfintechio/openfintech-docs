...
# Keiyo Bank (service) 
![keiyo_bank_jpy](https://static.openfintech.io/payout_methods/keiyo_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `keiyo_bank_jpy` 
 
**Method:** `keiyo_bank` [show -->](/payout-methods/keiyo_bank/) 

...
![bank_central_asia_idr](https://static.openfintech.io/payout_methods/bank_central_asia_idr/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `bank_central_asia_idr` 
 
**Method:** `bank_central_asia` [show -->](/payout-methods/bank_central_asia/) 

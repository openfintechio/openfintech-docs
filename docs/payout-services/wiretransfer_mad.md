...
![wiretransfer_mad](https://static.openfintech.io/payout_methods/wiretransfer_mad/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `wiretransfer_mad` 
 
**Method:** `wiretransfer` [show -->](/payout-methods/wiretransfer/) 

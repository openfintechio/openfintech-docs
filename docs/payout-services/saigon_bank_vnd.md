...
# Saigon Bank For Industry And Trade (service) 
![saigon_bank_vnd](https://static.openfintech.io/payout_methods/saigon_bank_vnd/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `saigon_bank_vnd` 
 
**Method:** `saigon_bank` [show -->](/payout-methods/saigon_bank/) 

...
# Maybank (service) 
![maybank_berhad_idr](https://static.openfintech.io/payout_methods/maybank_berhad_idr/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `maybank_berhad_idr` 
 
**Method:** `maybank_berhad` [show -->](/payout-methods/maybank_berhad/) 

...
# Miyazaki Bank (service) 
![miyazaki_bank_jpy](https://static.openfintech.io/payout_methods/miyazaki_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `miyazaki_bank_jpy` 
 
**Method:** `miyazaki_bank` [show -->](/payout-methods/miyazaki_bank/) 

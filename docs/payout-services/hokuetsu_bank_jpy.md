...
# Hokuetsu Bank (service) 
![hokuetsu_bank_jpy](https://static.openfintech.io/payout_methods/hokuetsu_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `hokuetsu_bank_jpy` 
 
**Method:** `hokuetsu_bank` [show -->](/payout-methods/hokuetsu_bank/) 

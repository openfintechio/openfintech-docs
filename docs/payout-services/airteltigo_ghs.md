...
# AirtelTigo (service) 
![airteltigo_ghs](https://static.openfintech.io/payout_methods/airteltigo_ghs/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `airteltigo_ghs` 
 
**Method:** `airteltigo` [show -->](/payout-methods/airteltigo/) 

...
# Unity Bank (service) 
![unity_bank_ngn](https://static.openfintech.io/payout_methods/unity_bank_ngn/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `unity_bank_ngn` 
 
**Method:** `unity_bank` [show -->](/payout-methods/unity_bank/) 

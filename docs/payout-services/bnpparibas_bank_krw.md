...
# BNP Paribas for the Republic of Korea (service) 
![bnpparibas_bank_krw](https://static.openfintech.io/payout_methods/bnpparibas_bank_krw/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `bnpparibas_bank_krw` 
 
**Method:** `bnpparibas_bank` [show -->](/payout-methods/bnpparibas_bank/) 

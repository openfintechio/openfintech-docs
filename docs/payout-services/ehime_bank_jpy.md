...
# Ehime Bank (service) 
![ehime_bank_jpy](https://static.openfintech.io/payout_methods/ehime_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `ehime_bank_jpy` 
 
**Method:** `ehime_bank` [show -->](/payout-methods/ehime_bank/) 

...
# Bank Kalteng (service) 
![bank_kalteng_idr](https://static.openfintech.io/payout_methods/bank_kalteng_idr/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `bank_kalteng_idr` 
 
**Method:** `bank_kalteng` [show -->](/payout-methods/bank_kalteng/) 

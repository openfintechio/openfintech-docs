...
# Hachijuni Banks (service) 
![hachijuni_bank_jpy](https://static.openfintech.io/payout_methods/hachijuni_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `hachijuni_bank_jpy` 
 
**Method:** `hachijuni_bank` [show -->](/payout-methods/hachijuni_bank/) 

...
# Bank Muamalat (service) 
![bank_muamalat_idr](https://static.openfintech.io/payout_methods/bank_muamalat_idr/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `bank_muamalat_idr` 
 
**Method:** `bank_muamalat` [show -->](/payout-methods/bank_muamalat/) 

...
![community_bank_try](https://static.openfintech.io/payout_methods/community_bank_try/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `community_bank_try` 
 
**Method:** `community_bank` [show -->](/payout-methods/community_bank/) 

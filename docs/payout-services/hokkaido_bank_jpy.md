...
# Hokkaido Bank (service) 
![hokkaido_bank_jpy](https://static.openfintech.io/payout_methods/hokkaido_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `hokkaido_bank_jpy` 
 
**Method:** `hokkaido_bank` [show -->](/payout-methods/hokkaido_bank/) 

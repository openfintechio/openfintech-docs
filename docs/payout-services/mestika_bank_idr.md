...
# Bank Mestika (service) 
![mestika_bank_idr](https://static.openfintech.io/payout_methods/mestika_bank_idr/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `mestika_bank_idr` 
 
**Method:** `mestika_bank` [show -->](/payout-methods/mestika_bank/) 

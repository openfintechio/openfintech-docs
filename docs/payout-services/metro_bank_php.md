...
# Metrobank (service) 
![metro_bank_php](https://static.openfintech.io/payout_methods/metro_bank_php/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `metro_bank_php` 
 
**Method:** `metro_bank` [show -->](/payout-methods/metro_bank/) 

...
# Shikoku Bank (service) 
![shikoku_bank_jpy](https://static.openfintech.io/payout_methods/shikoku_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `shikoku_bank_jpy` 
 
**Method:** `shikoku_bank` [show -->](/payout-methods/shikoku_bank/) 

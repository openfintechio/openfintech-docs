...
# LienVietPostBank (service) 
![lien_viet_post_bank_vnd](https://static.openfintech.io/payout_methods/lien_viet_post_bank_vnd/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `lien_viet_post_bank_vnd` 
 
**Method:** `lien_viet_post_bank` [show -->](/payout-methods/lien_viet_post_bank/) 

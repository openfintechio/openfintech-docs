...
# Bidvest Bank, South Africa (service) 
![bidvest_bank_zar](https://static.openfintech.io/payout_methods/bidvest_bank_zar/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `bidvest_bank_zar` 
 
**Method:** `bidvest_bank` [show -->](/payout-methods/bidvest_bank/) 

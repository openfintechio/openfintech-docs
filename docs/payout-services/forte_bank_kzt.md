...
# Forte Bank (service) 
![forte_bank_kzt](https://static.openfintech.io/payout_methods/forte_bank_kzt/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `forte_bank_kzt` 
 
**Method:** `forte_bank` [show -->](/payout-methods/forte_bank/) 

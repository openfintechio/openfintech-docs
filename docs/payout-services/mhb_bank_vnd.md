...
# Mekong Housing Bank (MHB Bank) (service) 
![mhb_bank_vnd](https://static.openfintech.io/payout_methods/mhb_bank_vnd/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `mhb_bank_vnd` 
 
**Method:** `mhb_bank` [show -->](/payout-methods/mhb_bank/) 

...
# Sbanken (service) 
![sbanken_bank_nok](https://static.openfintech.io/payout_methods/sbanken_bank_nok/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `sbanken_bank_nok` 
 
**Method:** `sbanken_bank` [show -->](/payout-methods/sbanken_bank/) 

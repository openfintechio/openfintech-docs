...
# Chikubo Bank (service) 
![chikubo_bank_jpy](https://static.openfintech.io/payout_methods/chikubo_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `chikubo_bank_jpy` 
 
**Method:** `chikubo_bank` [show -->](/payout-methods/chikubo_bank/) 

...
# Bank Maspion (service) 
![maspion_bank_idr](https://static.openfintech.io/payout_methods/maspion_bank_idr/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `maspion_bank_idr` 
 
**Method:** `maspion_bank` [show -->](/payout-methods/maspion_bank/) 

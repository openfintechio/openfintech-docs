...
# South African Bank of Athens (service) 
![south_african_bank_of_athens_zar](https://static.openfintech.io/payout_methods/south_african_bank_of_athens_zar/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `south_african_bank_of_athens_zar` 
 
**Method:** `south_african_bank_of_athens` [show -->](/payout-methods/south_african_bank_of_athens/) 

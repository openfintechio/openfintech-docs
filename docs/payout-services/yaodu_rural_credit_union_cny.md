...
# YAODU RURAL CREDIT UNION (service) 
![yaodu_rural_credit_union_cny](https://static.openfintech.io/payout_methods/yaodu_rural_credit_union_cny/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `yaodu_rural_credit_union_cny` 
 
**Method:** `yaodu_rural_credit_union` [show -->](/payout-methods/yaodu_rural_credit_union/) 

...
# Sumishin SBI Net Bank (service) 
![sumishin_sbi_net_bank_jpy](https://static.openfintech.io/payout_methods/sumishin_sbi_net_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `sumishin_sbi_net_bank_jpy` 
 
**Method:** `sumishin_sbi_net_bank` [show -->](/payout-methods/sumishin_sbi_net_bank/) 

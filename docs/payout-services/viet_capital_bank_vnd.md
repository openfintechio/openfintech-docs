...
# Viet Capital Commercial (service) 
![viet_capital_bank_vnd](https://static.openfintech.io/payout_methods/viet_capital_bank_vnd/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `viet_capital_bank_vnd` 
 
**Method:** `viet_capital_bank` [show -->](/payout-methods/viet_capital_bank/) 

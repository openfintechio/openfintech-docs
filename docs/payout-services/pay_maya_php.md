...
# Maya Philippines (service) 
![pay_maya_php](https://static.openfintech.io/payout_methods/pay_maya_php/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `pay_maya_php` 
 
**Method:** `pay_maya` [show -->](/payout-methods/pay_maya/) 

...
# AmBank (service) 
![ambank_berhad_myr](https://static.openfintech.io/payout_methods/ambank_berhad_myr/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `ambank_berhad_myr` 
 
**Method:** `ambank_berhad` [show -->](/payout-methods/ambank_berhad/) 

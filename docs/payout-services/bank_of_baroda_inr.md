...
![bank_of_baroda_inr](https://static.openfintech.io/payout_methods/bank_of_baroda_inr/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `bank_of_baroda_inr` 
 
**Method:** `bank_of_baroda` [show -->](/payout-methods/bank_of_baroda/) 

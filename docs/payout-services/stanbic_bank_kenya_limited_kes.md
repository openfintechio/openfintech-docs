...
# Stanbic Bank Kenya Limited (service) 
![stanbic_bank_kenya_limited_kes](https://static.openfintech.io/payout_methods/stanbic_bank_kenya_limited_kes/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `stanbic_bank_kenya_limited_kes` 
 
**Method:** `stanbic_bank_kenya_limited` [show -->](/payout-methods/stanbic_bank_kenya_limited/) 

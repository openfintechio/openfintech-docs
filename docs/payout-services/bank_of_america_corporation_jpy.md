...
# Bank of America Corporation (service) 
![bank_of_america_corporation_jpy](https://static.openfintech.io/payout_methods/bank_of_america_corporation_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `bank_of_america_corporation_jpy` 
 
**Method:** `bank_of_america_corporation` [show -->](/payout-methods/bank_of_america_corporation/) 

...
# Minami Nippon Bank (service) 
![minami_nippon_bank_jpy](https://static.openfintech.io/payout_methods/minami_nippon_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `minami_nippon_bank_jpy` 
 
**Method:** `minami_nippon_bank` [show -->](/payout-methods/minami_nippon_bank/) 

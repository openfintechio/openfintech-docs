...
# Vietnam Construction Joint Stock Commercial Bank (service) 
![omllvcb_bank_vnd](https://static.openfintech.io/payout_methods/omllvcb_bank_vnd/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `omllvcb_bank_vnd` 
 
**Method:** `omllvcb_bank` [show -->](/payout-methods/omllvcb_bank/) 

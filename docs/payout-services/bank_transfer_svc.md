...
![bank_transfer_svc](https://static.openfintech.io/payout_methods/bank_transfer_svc/logo.svg?w=400&c=v0.59.26#w24)  
...
**Currency:** `SVC` [show -->](/currencies/SVC/) 
...
**Amount limits:** from `1` to `900000` SVC 

...
# Yokohama Bank (service) 
![yokohama_bank_jpy](https://static.openfintech.io/payout_methods/yokohama_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `yokohama_bank_jpy` 
 
**Method:** `yokohama_bank` [show -->](/payout-methods/yokohama_bank/) 

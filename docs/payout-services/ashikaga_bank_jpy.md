...
# Ashikaga Bank (service) 
![ashikaga_bank_jpy](https://static.openfintech.io/payout_methods/ashikaga_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `ashikaga_bank_jpy` 
 
**Method:** `ashikaga_bank` [show -->](/payout-methods/ashikaga_bank/) 

...
![mandiri_bank_idr](https://static.openfintech.io/payout_methods/mandiri_bank_idr/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `mandiri_bank_idr` 
 
**Method:** `mandiri_bank` [show -->](/payout-methods/mandiri_bank/) 

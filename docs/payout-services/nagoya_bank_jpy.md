...
# Nagoya Bank (service) 
![nagoya_bank_jpy](https://static.openfintech.io/payout_methods/nagoya_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `nagoya_bank_jpy` 
 
**Method:** `nagoya_bank` [show -->](/payout-methods/nagoya_bank/) 

...
# Daiwa Next Bank (service) 
![daiwa_next_bank_jpy](https://static.openfintech.io/payout_methods/daiwa_next_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `daiwa_next_bank_jpy` 
 
**Method:** `daiwa_next_bank` [show -->](/payout-methods/daiwa_next_bank/) 

...
![banco_agrario_cop](https://static.openfintech.io/payout_methods/banco_agrario_cop/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `banco_agrario_cop` 
 
**Method:** `banco_agrario` [show -->](/payout-methods/banco_agrario/) 

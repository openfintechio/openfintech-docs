...
# Industrial Bank Of Korea (IBK) - Ho Chi Minh City Branch (service) 
![industrial_bank_ho_chi_minh_krw](https://static.openfintech.io/payout_methods/industrial_bank_ho_chi_minh_krw/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `industrial_bank_ho_chi_minh_krw` 
 
**Method:** `industrial_bank_ho_chi_minh` [show -->](/payout-methods/industrial_bank_ho_chi_minh/) 
...
**Amount limits:** from `30000` to `130000000` KRW 

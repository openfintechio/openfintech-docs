...
# Kiraboshi Bank (service) 
![kiraboshi_bank_jpy](https://static.openfintech.io/payout_methods/kiraboshi_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `kiraboshi_bank_jpy` 
 
**Method:** `kiraboshi_bank` [show -->](/payout-methods/kiraboshi_bank/) 

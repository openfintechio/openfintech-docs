...
# Tajima Bank (service) 
![tajima_bank_jpy](https://static.openfintech.io/payout_methods/tajima_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `tajima_bank_jpy` 
 
**Method:** `tajima_bank` [show -->](/payout-methods/tajima_bank/) 

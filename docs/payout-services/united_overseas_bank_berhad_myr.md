...
# United Overseas Bank Malaysia (service) 
![united_overseas_bank_berhad_myr](https://static.openfintech.io/payout_methods/united_overseas_bank_berhad_myr/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `united_overseas_bank_berhad_myr` 
 
**Method:** `united_overseas_bank_berhad` [show -->](/payout-methods/united_overseas_bank_berhad/) 

...
# Zenith Bank (service) 
![zenith_bank_ngn](https://static.openfintech.io/payout_methods/zenith_bank_ngn/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `zenith_bank_ngn` 
 
**Method:** `zenith_bank` [show -->](/payout-methods/zenith_bank/) 

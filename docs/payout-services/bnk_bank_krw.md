...
# BNK Securities Co. Ltd (service) 
![bnk_bank_krw](https://static.openfintech.io/payout_methods/bnk_bank_krw/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `bnk_bank_krw` 
 
**Method:** `bnk_bank` [show -->](/payout-methods/bnk_bank/) 

...
# Bank Jateng (service) 
![bank_jateng_idr](https://static.openfintech.io/payout_methods/bank_jateng_idr/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `bank_jateng_idr` 
 
**Method:** `bank_jateng` [show -->](/payout-methods/bank_jateng/) 

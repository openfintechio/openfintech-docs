...
# Bank National Nobu (service) 
![bank_nationalnobu_idr](https://static.openfintech.io/payout_methods/bank_nationalnobu_idr/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `bank_nationalnobu_idr` 
 
**Method:** `bank_nationalnobu` [show -->](/payout-methods/bank_nationalnobu/) 

...
# Saga Kyoei Bank (service) 
![saga_kyoei_bank_jpy](https://static.openfintech.io/payout_methods/saga_kyoei_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `saga_kyoei_bank_jpy` 
 
**Method:** `saga_kyoei_bank` [show -->](/payout-methods/saga_kyoei_bank/) 

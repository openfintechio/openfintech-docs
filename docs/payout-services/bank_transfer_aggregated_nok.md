...
![bank_transfer_aggregated_nok](https://static.openfintech.io/payout_methods/bank_transfer_aggregated_nok/logo.svg?w=400&c=v0.59.26#w24)  
...
|`account_number`|✗|`string`|`/^NO[A-Z0-9]{13}$/`| 

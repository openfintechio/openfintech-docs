...
# Bank Index Selindo (service) 
![bank_index_idr](https://static.openfintech.io/payout_methods/bank_index_idr/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `bank_index_idr` 
 
**Method:** `bank_index` [show -->](/payout-methods/bank_index/) 

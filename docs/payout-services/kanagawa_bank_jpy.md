...
# Kanagawa Bank (service) 
![kanagawa_bank_jpy](https://static.openfintech.io/payout_methods/kanagawa_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `kanagawa_bank_jpy` 
 
**Method:** `kanagawa_bank` [show -->](/payout-methods/kanagawa_bank/) 

...
# Hyakugo Banks (service) 
![hyakugo_banks_jpy](https://static.openfintech.io/payout_methods/hyakugo_banks_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `hyakugo_banks_jpy` 
 
**Method:** `hyakugo_banks` [show -->](/payout-methods/hyakugo_banks/) 

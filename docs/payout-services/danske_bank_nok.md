...
# Danske Bank (service) 
![danske_bank_nok](https://static.openfintech.io/payout_methods/danske_bank_nok/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `danske_bank_nok` 
 
**Method:** `danske_bank` [show -->](/payout-methods/danske_bank/) 

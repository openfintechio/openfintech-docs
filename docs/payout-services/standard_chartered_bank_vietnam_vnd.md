...
# Standard Chartered Bank (Vietnam) Limited (service) 
![standard_chartered_bank_vietnam_vnd](https://static.openfintech.io/payout_methods/standard_chartered_bank_vietnam_vnd/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `standard_chartered_bank_vietnam_vnd` 
 
**Method:** `standard_chartered_bank_vietnam` [show -->](/payout-methods/standard_chartered_bank_vietnam/) 

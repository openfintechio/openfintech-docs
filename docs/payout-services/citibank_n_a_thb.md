...
# Citibank (service) 
![citibank_n_a_thb](https://static.openfintech.io/payout_methods/citibank_n_a_thb/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `citibank_n_a_thb` 
 
**Method:** `citibank_n_a` [show -->](/payout-methods/citibank_n_a/) 

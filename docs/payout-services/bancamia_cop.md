...
# BANCAMIA S.A. (service) 
![bancamia_cop](https://static.openfintech.io/payout_methods/bancamia_cop/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `bancamia_cop` 
 
**Method:** `bancamia` [show -->](/payout-methods/bancamia/) 

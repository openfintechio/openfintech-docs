...
# Totens Sparebank (service) 
![totens_sparebank_nok](https://static.openfintech.io/payout_methods/totens_sparebank_nok/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `totens_sparebank_nok` 
 
**Method:** `totens_sparebank` [show -->](/payout-methods/totens_sparebank/) 

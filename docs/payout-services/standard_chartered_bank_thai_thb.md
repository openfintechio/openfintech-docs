...
# Standard Chartered Bank (Thai) PCL (service) 
![standard_chartered_bank_thai_thb](https://static.openfintech.io/payout_methods/standard_chartered_bank_thai_thb/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `standard_chartered_bank_thai_thb` 
 
**Method:** `standard_chartered_bank_thai` [show -->](/payout-methods/standard_chartered_bank_thai/) 

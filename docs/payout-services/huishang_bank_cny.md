...
# HuiShang Bank (service) 
![huishang_bank_cny](https://static.openfintech.io/payout_methods/huishang_bank_cny/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `huishang_bank_cny` 
 
**Method:** `huishang_bank` [show -->](/payout-methods/huishang_bank/) 

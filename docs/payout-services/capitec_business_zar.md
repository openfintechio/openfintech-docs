...
# Capitec Business (service) 
![capitec_business_zar](https://static.openfintech.io/payout_methods/capitec_business_zar/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `capitec_business_zar` 
 
**Method:** `capitec_business` [show -->](/payout-methods/capitec_business/) 

...
![standard_bank_zar](https://static.openfintech.io/payout_methods/standard_bank_zar/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `standard_bank_zar` 
 
**Method:** `standard_bank` [show -->](/payout-methods/standard_bank/) 

...
# Keystone Bank (service) 
![keystone_bank_ngn](https://static.openfintech.io/payout_methods/keystone_bank_ngn/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `keystone_bank_ngn` 
 
**Method:** `keystone_bank` [show -->](/payout-methods/keystone_bank/) 

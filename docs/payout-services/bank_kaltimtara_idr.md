...
# Bank Kaltimtara (service) 
![bank_kaltimtara_idr](https://static.openfintech.io/payout_methods/bank_kaltimtara_idr/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `bank_kaltimtara_idr` 
 
**Method:** `bank_kaltimtara` [show -->](/payout-methods/bank_kaltimtara/) 

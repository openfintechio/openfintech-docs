...
# SANTANDER (service) 
![banco_santander_mxn](https://static.openfintech.io/payout_methods/banco_santander_mxn/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `banco_santander_mxn` 
 
**Method:** `banco_santander` [show -->](/payout-methods/banco_santander/) 

...
![kookmin_bank_krw](https://static.openfintech.io/payout_methods/kookmin_bank_krw/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `kookmin_bank_krw` 
 
**Method:** `kookmin_bank` [show -->](/payout-methods/kookmin_bank/) 

...
# Bank Jatim (service) 
![bank_jatim_idr](https://static.openfintech.io/payout_methods/bank_jatim_idr/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `bank_jatim_idr` 
 
**Method:** `bank_jatim` [show -->](/payout-methods/bank_jatim/) 

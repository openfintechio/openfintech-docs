...
# Bank Negara Indonesia (VA) (service) 
![bank_negara_indonesia_va_idr](https://static.openfintech.io/payout_methods/bank_negara_indonesia_va_idr/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `bank_negara_indonesia_va_idr` 
 
**Method:** `bank_negara_indonesia_va` [show -->](/payout-methods/bank_negara_indonesia_va/) 
...
**Amount limits:** from `50000` to `25000000` IDR 

...
# Oogaki Kyoritsu Bank (service) 
![ogaki_kyoritsu_bank_jpy](https://static.openfintech.io/payout_methods/ogaki_kyoritsu_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `ogaki_kyoritsu_bank_jpy` 
 
**Method:** `ogaki_kyoritsu_bank` [show -->](/payout-methods/ogaki_kyoritsu_bank/) 

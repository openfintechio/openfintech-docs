...
# Bank Banten (service) 
![bank_banten_idr](https://static.openfintech.io/payout_methods/bank_banten_idr/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `bank_banten_idr` 
 
**Method:** `bank_banten` [show -->](/payout-methods/bank_banten/) 

...
# Rizal Commercial Banking Corporation (service) 
![rcbc_php](https://static.openfintech.io/payout_methods/rcbc_php/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `rcbc_php` 
 
**Method:** `rcbc` [show -->](/payout-methods/rcbc/) 

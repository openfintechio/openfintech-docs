...
![indusind_bank_inr](https://static.openfintech.io/payout_methods/indusind_bank_inr/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `indusind_bank_inr` 
 
**Method:** `indusind_bank` [show -->](/payout-methods/indusind_bank/) 

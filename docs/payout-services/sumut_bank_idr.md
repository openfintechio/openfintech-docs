...
# Sumut Bank (service) 
![sumut_bank_idr](https://static.openfintech.io/payout_methods/sumut_bank_idr/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `sumut_bank_idr` 
 
**Method:** `sumut_bank` [show -->](/payout-methods/sumut_bank/) 

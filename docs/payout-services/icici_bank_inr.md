...
# ICICI Bank (service) 
![icici_bank_inr](https://static.openfintech.io/payout_methods/icici_bank_inr/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `icici_bank_inr` 
 
**Method:** `icici_bank` [show -->](/payout-methods/icici_bank/) 

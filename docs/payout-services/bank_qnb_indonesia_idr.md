...
# Bank QNB Indonesia (service) 
![bank_qnb_indonesia_idr](https://static.openfintech.io/payout_methods/bank_qnb_indonesia_idr/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `bank_qnb_indonesia_idr` 
 
**Method:** `bank_qnb_indonesia` [show -->](/payout-methods/bank_qnb_indonesia/) 

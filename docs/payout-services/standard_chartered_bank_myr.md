...
# Standard Chartered Bank (service) 
![standard_chartered_bank_myr](https://static.openfintech.io/payout_methods/standard_chartered_bank_myr/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `standard_chartered_bank_myr` 
 
**Method:** `standard_chartered_bank` [show -->](/payout-methods/standard_chartered_bank/) 
...
**Amount limits:** from `0.01` to `3800000` MYR 

...
# Meritz Securities Co. Ltd (service) 
![meritz_bank_krw](https://static.openfintech.io/payout_methods/meritz_bank_krw/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `meritz_bank_krw` 
 
**Method:** `meritz_bank` [show -->](/payout-methods/meritz_bank/) 

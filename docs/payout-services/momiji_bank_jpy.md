...
# Momiji Bank (service) 
![momiji_bank_jpy](https://static.openfintech.io/payout_methods/momiji_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `momiji_bank_jpy` 
 
**Method:** `momiji_bank` [show -->](/payout-methods/momiji_bank/) 

...
# United Overseas Bank (service) 
![united_overseas_bank_thb](https://static.openfintech.io/payout_methods/united_overseas_bank_thb/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `united_overseas_bank_thb` 
 
**Method:** `united_overseas_bank` [show -->](/payout-methods/united_overseas_bank/) 
...
**Amount limits:** from `60` to `49000` THB 

...
![vietin_bank_qr_vnd](https://static.openfintech.io/payout_methods/vietin_bank_qr_vnd/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `vietin_bank_qr_vnd` 
 
**Method:** `vietin_bank_qr` [show -->](/payout-methods/vietin_bank_qr/) 

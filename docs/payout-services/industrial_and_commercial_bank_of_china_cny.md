...
![industrial_and_commercial_bank_of_china_cny](https://static.openfintech.io/payout_methods/industrial_and_commercial_bank_of_china_cny/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `industrial_and_commercial_bank_of_china_cny` 
 
**Method:** `industrial_and_commercial_bank_of_china` [show -->](/payout-methods/industrial_and_commercial_bank_of_china/) 

...
# Access Bank Plc (Diamond), Nigeria (service) 
![diamond_bank_nigeria_ngn](https://static.openfintech.io/payout_methods/diamond_bank_nigeria_ngn/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `diamond_bank_nigeria_ngn` 
 
**Method:** `diamond_bank_nigeria` [show -->](/payout-methods/diamond_bank_nigeria/) 
...
**Amount limits:** from `0.01` to `500000000` NGN 

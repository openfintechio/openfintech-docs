...
# Bank Multiarta Sentosa (service) 
![bank_multiarta_sentosa_idr](https://static.openfintech.io/payout_methods/bank_multiarta_sentosa_idr/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `bank_multiarta_sentosa_idr` 
 
**Method:** `bank_multiarta_sentosa` [show -->](/payout-methods/bank_multiarta_sentosa/) 

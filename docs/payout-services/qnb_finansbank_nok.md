...
![qnb_finansbank_nok](https://static.openfintech.io/payout_methods/qnb_finansbank_nok/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `qnb_finansbank_nok` 
 
**Method:** `qnb_finansbank` [show -->](/payout-methods/qnb_finansbank/) 

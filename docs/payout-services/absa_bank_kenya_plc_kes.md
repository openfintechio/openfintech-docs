...
# Absa Bank Kenya Plc (service) 
![absa_bank_kenya_plc_kes](https://static.openfintech.io/payout_methods/absa_bank_kenya_plc_kes/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `absa_bank_kenya_plc_kes` 
 
**Method:** `absa_bank_kenya_plc` [show -->](/payout-methods/absa_bank_kenya_plc/) 

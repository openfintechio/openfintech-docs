...
# ACLEDA Bank (service) 
![acleda_bank_cambodia_usd](https://static.openfintech.io/payout_methods/acleda_bank_cambodia_usd/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `acleda_bank_cambodia_usd` 
 
**Method:** `acleda_bank_cambodia` [show -->](/payout-methods/acleda_bank_cambodia/) 

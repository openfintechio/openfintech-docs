...
# BBVA Bancomer S.A. (service) 
![bbva_bancomer_mxn](https://static.openfintech.io/payout_methods/bbva_bancomer_mxn/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `bbva_bancomer_mxn` 
 
**Method:** `bbva_bancomer` [show -->](/payout-methods/bbva_bancomer/) 

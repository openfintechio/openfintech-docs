...
# RMB Private Bank, South Africa (service) 
![rmb_private_bank_zar](https://static.openfintech.io/payout_methods/rmb_private_bank_zar/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `rmb_private_bank_zar` 
 
**Method:** `rmb_private_bank` [show -->](/payout-methods/rmb_private_bank/) 

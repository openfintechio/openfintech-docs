...
# Hegra Sparebank (service) 
![hegra_sparebank_nok](https://static.openfintech.io/payout_methods/hegra_sparebank_nok/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `hegra_sparebank_nok` 
 
**Method:** `hegra_sparebank` [show -->](/payout-methods/hegra_sparebank/) 

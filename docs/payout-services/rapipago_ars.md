...
# Rapipago (service) 
![rapipago_ars](https://static.openfintech.io/payout_methods/rapipago_ars/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `rapipago_ars` 
 
**Method:** `rapipago` [show -->](/payout-methods/rapipago/) 

...
![china_merchants_bank_cny](https://static.openfintech.io/payout_methods/china_merchants_bank_cny/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `china_merchants_bank_cny` 
 
**Method:** `china_merchants_bank` [show -->](/payout-methods/china_merchants_bank/) 

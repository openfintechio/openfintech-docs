...
# Michinoku Bank (service) 
![michinoku_bank_jpy](https://static.openfintech.io/payout_methods/michinoku_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `michinoku_bank_jpy` 
 
**Method:** `michinoku_bank` [show -->](/payout-methods/michinoku_bank/) 

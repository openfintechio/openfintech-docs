...
# Sumitomo Mitsui Banking Corporation (service) 
![sumitomo_mitsui_banking_corporation_jpy](https://static.openfintech.io/payout_methods/sumitomo_mitsui_banking_corporation_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `sumitomo_mitsui_banking_corporation_jpy` 
 
**Method:** `sumitomo_mitsui_banking_corporation` [show -->](/payout-methods/sumitomo_mitsui_banking_corporation/) 

...
# Bandhan Bank (service) 
![bandhan_bank_inr](https://static.openfintech.io/payout_methods/bandhan_bank_inr/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `bandhan_bank_inr` 
 
**Method:** `bandhan_bank` [show -->](/payout-methods/bandhan_bank/) 

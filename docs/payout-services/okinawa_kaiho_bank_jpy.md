...
# Okinawa Kaiho Bank (service) 
![okinawa_kaiho_bank_jpy](https://static.openfintech.io/payout_methods/okinawa_kaiho_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `okinawa_kaiho_bank_jpy` 
 
**Method:** `okinawa_kaiho_bank` [show -->](/payout-methods/okinawa_kaiho_bank/) 

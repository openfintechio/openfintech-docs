...
# PagoMóvil (service) 
![pagomovil_ves](https://static.openfintech.io/payout_methods/pagomovil_ves/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `pagomovil_ves` 
 
**Method:** `pagomovil` [show -->](/payout-methods/pagomovil/) 
...
**Amount limits:** from `1` to `9000000` VES 

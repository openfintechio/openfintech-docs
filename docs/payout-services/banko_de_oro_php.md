...
# Banko de Oro (service) 
![banko_de_oro_php](https://static.openfintech.io/payout_methods/banko_de_oro_php/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `banko_de_oro_php` 
 
**Method:** `banko_de_oro` [show -->](/payout-methods/banko_de_oro/) 

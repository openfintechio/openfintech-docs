...
# Jyuhachi Bank (service) 
![jyuhachi_bank_jpy](https://static.openfintech.io/payout_methods/jyuhachi_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `jyuhachi_bank_jpy` 
 
**Method:** `jyuhachi_bank` [show -->](/payout-methods/jyuhachi_bank/) 

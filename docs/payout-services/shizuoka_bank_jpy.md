...
# Shizuoka Bank (service) 
![shizuoka_bank_jpy](https://static.openfintech.io/payout_methods/shizuoka_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `shizuoka_bank_jpy` 
 
**Method:** `shizuoka_bank` [show -->](/payout-methods/shizuoka_bank/) 

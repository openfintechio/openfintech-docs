...
![bank_transfer_ars](https://static.openfintech.io/payout_methods/bank_transfer_ars/logo.svg?w=400&c=v0.59.26#w24)  
...
**Amount limits:** from `1` to `99000000` ARS 
...
|:---:|:---:|:---:|:---:| 
|`account_type`|✗|`string`|`/^[A-Za-z_]{1,50}$/`| 
...
|`beneficiary_dob`|✗|`string`|`/^([0-2][0-9]\|(3)[0-1])(\/)(((0)[0-9])\|((1)[0-2]))(\/)\d{4}\|\|((19\|20)\d{2}(0[1-9]\|1[0-2])(0[1-9]\|[12]\d\|3[01]))\|(19\|20)\d{2}-(0[1-9]\|1[0-2])-(0[1-9]\|[12]\d\|3[01])$/`| 
|`beneficiary_city`|✗|`string`|`/^.{1,100}$/`| 
|`beneficiary_postcode`|✗|`string`|`/^.{1,255}$/`| 
|`account_number`|✗|`string`|`/^[A-Z]{2}[A-Z0-9]{13,32}$\|^[0-9]{3,34}$/`| 
...
16. **`account_number`** 
	...
	Regexp: `/^[A-Z]{2}[A-Z0-9]{13,32}$|^[0-9]{3,34}$/` 

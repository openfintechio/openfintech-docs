...
# Wing Bank (service) 
![wing_bank_cambodia_usd](https://static.openfintech.io/payout_methods/wing_bank_cambodia_usd/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `wing_bank_cambodia_usd` 
 
**Method:** `wing_bank_cambodia` [show -->](/payout-methods/wing_bank_cambodia/) 

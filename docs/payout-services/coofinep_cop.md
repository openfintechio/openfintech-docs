...
# COOFINEP COOPERATIVA FINANCIERA (service) 
![coofinep_cop](https://static.openfintech.io/payout_methods/coofinep_cop/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `coofinep_cop` 
 
**Method:** `coofinep` [show -->](/payout-methods/coofinep/) 

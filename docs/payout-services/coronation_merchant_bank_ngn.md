...
# Coronation Merchant Bank (service) 
![coronation_merchant_bank_ngn](https://static.openfintech.io/payout_methods/coronation_merchant_bank_ngn/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `coronation_merchant_bank_ngn` 
 
**Method:** `coronation_merchant_bank` [show -->](/payout-methods/coronation_merchant_bank/) 

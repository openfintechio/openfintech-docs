...
![sepa_transfer_omr](https://static.openfintech.io/payout_methods/sepa_transfer_omr/logo.svg?w=400&c=v0.59.26#w24)  
...
**Amount limits:** from `0.001` to `38400` OMR 
...
|`beneficiary_full_name`|✗|`string`|`/^[A-Za-z\-\ ]{2,100}$/`| 

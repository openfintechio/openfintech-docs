...
# Ziraat Bank (service) 
![ziraat_bank_nok](https://static.openfintech.io/payout_methods/ziraat_bank_nok/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `ziraat_bank_nok` 
 
**Method:** `ziraat_bank` [show -->](/payout-methods/ziraat_bank/) 

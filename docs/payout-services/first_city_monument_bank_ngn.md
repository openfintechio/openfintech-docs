...
![first_city_monument_bank_ngn](https://static.openfintech.io/payout_methods/first_city_monument_bank_ngn/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `first_city_monument_bank_ngn` 
 
**Method:** `first_city_monument_bank` [show -->](/payout-methods/first_city_monument_bank/) 

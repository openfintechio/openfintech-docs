...
# Taiko Bank (service) 
![taiko_bank_jpy](https://static.openfintech.io/payout_methods/taiko_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `taiko_bank_jpy` 
 
**Method:** `taiko_bank` [show -->](/payout-methods/taiko_bank/) 

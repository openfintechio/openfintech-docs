...
![hong_leong_bank_myr](https://static.openfintech.io/payout_methods/hong_leong_bank_myr/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `hong_leong_bank_myr` 
 
**Method:** `hong_leong_bank` [show -->](/payout-methods/hong_leong_bank/) 

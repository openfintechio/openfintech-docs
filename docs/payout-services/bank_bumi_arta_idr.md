...
# Bank Bumi Arta (service) 
![bank_bumi_arta_idr](https://static.openfintech.io/payout_methods/bank_bumi_arta_idr/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `bank_bumi_arta_idr` 
 
**Method:** `bank_bumi_arta` [show -->](/payout-methods/bank_bumi_arta/) 

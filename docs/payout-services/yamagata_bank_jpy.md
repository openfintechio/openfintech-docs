...
# Yamagata Bank (service) 
![yamagata_bank_jpy](https://static.openfintech.io/payout_methods/yamagata_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `yamagata_bank_jpy` 
 
**Method:** `yamagata_bank` [show -->](/payout-methods/yamagata_bank/) 

...
# Chukyo Bank (service) 
![chukyo_bank_jpy](https://static.openfintech.io/payout_methods/chukyo_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `chukyo_bank_jpy` 
 
**Method:** `chukyo_bank` [show -->](/payout-methods/chukyo_bank/) 

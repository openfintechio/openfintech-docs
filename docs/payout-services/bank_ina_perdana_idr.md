...
# Bank Ina Perdana (service) 
![bank_ina_perdana_idr](https://static.openfintech.io/payout_methods/bank_ina_perdana_idr/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `bank_ina_perdana_idr` 
 
**Method:** `bank_ina_perdana` [show -->](/payout-methods/bank_ina_perdana/) 

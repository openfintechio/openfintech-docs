...
# Gunma Bank (service) 
![gunma_bank_jpy](https://static.openfintech.io/payout_methods/gunma_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `gunma_bank_jpy` 
 
**Method:** `gunma_bank` [show -->](/payout-methods/gunma_bank/) 

...
![pvcom_bank_vnd](https://static.openfintech.io/payout_methods/pvcom_bank_vnd/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `pvcom_bank_vnd` 
 
**Method:** `pvcom_bank` [show -->](/payout-methods/pvcom_bank/) 

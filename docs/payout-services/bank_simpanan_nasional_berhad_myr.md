...
# Bank Simpanan Nasional (service) 
![bank_simpanan_nasional_berhad_myr](https://static.openfintech.io/payout_methods/bank_simpanan_nasional_berhad_myr/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `bank_simpanan_nasional_berhad_myr` 
 
**Method:** `bank_simpanan_nasional_berhad` [show -->](/payout-methods/bank_simpanan_nasional_berhad/) 

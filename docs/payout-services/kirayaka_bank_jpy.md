...
# Kirayaka Bank (service) 
![kirayaka_bank_jpy](https://static.openfintech.io/payout_methods/kirayaka_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `kirayaka_bank_jpy` 
 
**Method:** `kirayaka_bank` [show -->](/payout-methods/kirayaka_bank/) 

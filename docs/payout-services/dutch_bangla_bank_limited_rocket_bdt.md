...
![dutch_bangla_bank_limited_rocket_bdt](https://static.openfintech.io/payout_methods/dutch_bangla_bank_limited_rocket_bdt/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `dutch_bangla_bank_limited_rocket_bdt` 
 
**Method:** `dutch_bangla_bank_limited_rocket` [show -->](/payout-methods/dutch_bangla_bank_limited_rocket/) 

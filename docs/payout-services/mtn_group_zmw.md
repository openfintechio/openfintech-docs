...
# MTN Group (service) 
![mtn_group_zmw](https://static.openfintech.io/payout_methods/mtn_group_zmw/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `mtn_group_zmw` 
 
**Method:** `mtn_group` [show -->](/payout-methods/mtn_group/) 
...
**Amount limits:** from `0.01` to `2000000` ZMW 

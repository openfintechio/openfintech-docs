...
# ADAMANT-TELECOM - UPU and Collocation (service) 
![adamant-telekom-vps-i-kolokeishn_uah](https://static.openfintech.io/payout_methods/adamant-telekom-vps-i-kolokeishn_uah/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `adamant-telekom-vps-i-kolokeishn_uah` 
 
**Method:** `adamant-telekom-vps-i-kolokeishn` [show -->](/payout-methods/adamant-telekom-vps-i-kolokeishn/) 

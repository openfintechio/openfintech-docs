...
![city_union_bank_inr](https://static.openfintech.io/payout_methods/city_union_bank_inr/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `city_union_bank_inr` 
 
**Method:** `city_union_bank` [show -->](/payout-methods/city_union_bank/) 

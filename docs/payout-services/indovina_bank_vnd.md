...
# Indovina Bank Ltd. (service) 
![indovina_bank_vnd](https://static.openfintech.io/payout_methods/indovina_bank_vnd/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `indovina_bank_vnd` 
 
**Method:** `indovina_bank` [show -->](/payout-methods/indovina_bank/) 

...
# Discovery Bank Limited, South Africa (service) 
![discovery_bank_zar](https://static.openfintech.io/payout_methods/discovery_bank_zar/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `discovery_bank_zar` 
 
**Method:** `discovery_bank` [show -->](/payout-methods/discovery_bank/) 

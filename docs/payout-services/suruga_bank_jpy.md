...
# Suruga Bank (service) 
![suruga_bank_jpy](https://static.openfintech.io/payout_methods/suruga_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `suruga_bank_jpy` 
 
**Method:** `suruga_bank` [show -->](/payout-methods/suruga_bank/) 

...
# SASFIN Bank, South Africa (service) 
![sasfin_bank_zar](https://static.openfintech.io/payout_methods/sasfin_bank_zar/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `sasfin_bank_zar` 
 
**Method:** `sasfin_bank` [show -->](/payout-methods/sasfin_bank/) 

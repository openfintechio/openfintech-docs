...
![promsvyaz_bank_rub](https://static.openfintech.io/payout_methods/promsvyaz_bank_rub/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `promsvyaz_bank_rub` 
 
**Method:** `promsvyaz_bank` [show -->](/payout-methods/promsvyaz_bank/) 

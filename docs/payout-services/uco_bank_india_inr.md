...
# UCO Bank (service) 
![uco_bank_india_inr](https://static.openfintech.io/payout_methods/uco_bank_india_inr/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `uco_bank_india_inr` 
 
**Method:** `uco_bank_india` [show -->](/payout-methods/uco_bank_india/) 

...
![bank_transfer_cad](https://static.openfintech.io/payout_methods/bank_transfer_cad/logo.svg?w=400&c=v0.59.26#w24)  
...
**Amount limits:** from `0.01` to `1000000.00` CAD 
...
|`beneficiary_state`|✗|`string`|`/^[\s\p{L}\p{N}\p{P}]{2,100}$/u`| 
|`beneficiary_address`|✗|`string`|`/^[\s\p{L}\p{N}\p{P}]{2,100}$/u`| 

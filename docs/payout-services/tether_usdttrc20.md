...
# Tether (service) 
![tether_usdttrc20](https://static.openfintech.io/payout_methods/tether_usdttrc20/logo.svg?w=400&c=v0.59.26#w24)  
...
**Amount limits:** from `0.00000001` to `100000` USDTTRC20 

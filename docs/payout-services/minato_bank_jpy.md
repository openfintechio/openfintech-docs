...
# Minato Bank (service) 
![minato_bank_jpy](https://static.openfintech.io/payout_methods/minato_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `minato_bank_jpy` 
 
**Method:** `minato_bank` [show -->](/payout-methods/minato_bank/) 

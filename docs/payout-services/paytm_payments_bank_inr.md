...
# Paytm Payments Bank (service) 
![paytm_payments_bank_inr](https://static.openfintech.io/payout_methods/paytm_payments_bank_inr/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `paytm_payments_bank_inr` 
 
**Method:** `paytm_payments_bank` [show -->](/payout-methods/paytm_payments_bank/) 

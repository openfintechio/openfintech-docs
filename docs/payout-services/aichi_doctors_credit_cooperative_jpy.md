...
# Aichi Doctors Credit Cooperative (service) 
![aichi_doctors_credit_cooperative_jpy](https://static.openfintech.io/payout_methods/aichi_doctors_credit_cooperative_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `aichi_doctors_credit_cooperative_jpy` 
 
**Method:** `aichi_doctors_credit_cooperative` [show -->](/payout-methods/aichi_doctors_credit_cooperative/) 

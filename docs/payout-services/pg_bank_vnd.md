...
# PG Bank (service) 
![pg_bank_vnd](https://static.openfintech.io/payout_methods/pg_bank_vnd/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `pg_bank_vnd` 
 
**Method:** `pg_bank` [show -->](/payout-methods/pg_bank/) 
...
**Amount limits:** from `1` to `2350000000` VND 

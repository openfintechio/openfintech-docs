...
# Kuveyt Türk Participation Bank (service) 
![kuveyt_turk_katilim_bank_try](https://static.openfintech.io/payout_methods/kuveyt_turk_katilim_bank_try/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `kuveyt_turk_katilim_bank_try` 
 
**Method:** `kuveyt_turk_katilim_bank` [show -->](/payout-methods/kuveyt_turk_katilim_bank/) 

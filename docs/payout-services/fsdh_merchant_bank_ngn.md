...
# FSDH Merchant Bank (service) 
![fsdh_merchant_bank_ngn](https://static.openfintech.io/payout_methods/fsdh_merchant_bank_ngn/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `fsdh_merchant_bank_ngn` 
 
**Method:** `fsdh_merchant_bank` [show -->](/payout-methods/fsdh_merchant_bank/) 

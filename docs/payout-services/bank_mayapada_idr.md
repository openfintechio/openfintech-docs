...
# Bank Mayapada (service) 
![bank_mayapada_idr](https://static.openfintech.io/payout_methods/bank_mayapada_idr/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `bank_mayapada_idr` 
 
**Method:** `bank_mayapada` [show -->](/payout-methods/bank_mayapada/) 

...
# Standard Chartered Korea (service) 
![sc_first_bank_krw](https://static.openfintech.io/payout_methods/sc_first_bank_krw/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `sc_first_bank_krw` 
 
**Method:** `sc_first_bank` [show -->](/payout-methods/sc_first_bank/) 

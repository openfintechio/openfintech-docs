...
# Investec (service) 
![investec_bank_zar](https://static.openfintech.io/payout_methods/investec_bank_zar/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `investec_bank_zar` 
 
**Method:** `investec_bank` [show -->](/payout-methods/investec_bank/) 

...
# Touhou Bank (service) 
![touhou_bank_jpy](https://static.openfintech.io/payout_methods/touhou_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `touhou_bank_jpy` 
 
**Method:** `touhou_bank` [show -->](/payout-methods/touhou_bank/) 

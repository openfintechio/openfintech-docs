...
# First Bank of Toyama (service) 
![first_bank_of_toyama_jpy](https://static.openfintech.io/payout_methods/first_bank_of_toyama_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `first_bank_of_toyama_jpy` 
 
**Method:** `first_bank_of_toyama` [show -->](/payout-methods/first_bank_of_toyama/) 

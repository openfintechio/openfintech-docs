...
![gnb_sudameris_bank_cop](https://static.openfintech.io/payout_methods/gnb_sudameris_bank_cop/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `gnb_sudameris_bank_cop` 
 
**Method:** `gnb_sudameris_bank` [show -->](/payout-methods/gnb_sudameris_bank/) 

...
# Turkiye Finans Katilim Bank (service) 
![turkey_finans_katilim_bank_nok](https://static.openfintech.io/payout_methods/turkey_finans_katilim_bank_nok/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `turkey_finans_katilim_bank_nok` 
 
**Method:** `turkey_finans_katilim_bank` [show -->](/payout-methods/turkey_finans_katilim_bank/) 
...
**Amount limits:** from `0.01` to `10000000` NOK 

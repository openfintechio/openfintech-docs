...
# Local Cooperative Federation (service) 
![local_cooperative_federation_bank_krw](https://static.openfintech.io/payout_methods/local_cooperative_federation_bank_krw/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `local_cooperative_federation_bank_krw` 
 
**Method:** `local_cooperative_federation_bank` [show -->](/payout-methods/local_cooperative_federation_bank/) 

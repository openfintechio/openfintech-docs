...
# Nam A Commercial Joint Stock Bank (service) 
![nam_a_bank_vnd](https://static.openfintech.io/payout_methods/nam_a_bank_vnd/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `nam_a_bank_vnd` 
 
**Method:** `nam_a_bank` [show -->](/payout-methods/nam_a_bank/) 

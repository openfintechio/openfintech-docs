...
# Kumamoto Bank (service) 
![kumamoto_bank_jpy](https://static.openfintech.io/payout_methods/kumamoto_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `kumamoto_bank_jpy` 
 
**Method:** `kumamoto_bank` [show -->](/payout-methods/kumamoto_bank/) 

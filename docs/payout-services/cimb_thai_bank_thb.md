...
# CIMB Thai Bank Public Company Limited (service) 
![cimb_thai_bank_thb](https://static.openfintech.io/payout_methods/cimb_thai_bank_thb/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `cimb_thai_bank_thb` 
 
**Method:** `cimb_thai_bank` [show -->](/payout-methods/cimb_thai_bank/) 

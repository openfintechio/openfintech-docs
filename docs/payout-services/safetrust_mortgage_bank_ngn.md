...
# Safetrust Mortgage Bank (service) 
![safetrust_mortgage_bank_ngn](https://static.openfintech.io/payout_methods/safetrust_mortgage_bank_ngn/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `safetrust_mortgage_bank_ngn` 
 
**Method:** `safetrust_mortgage_bank` [show -->](/payout-methods/safetrust_mortgage_bank/) 

...
# Vietnam - Russia Joint Venture Bank (service) 
![vrb_bank_vnd](https://static.openfintech.io/payout_methods/vrb_bank_vnd/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `vrb_bank_vnd` 
 
**Method:** `vrb_bank` [show -->](/payout-methods/vrb_bank/) 

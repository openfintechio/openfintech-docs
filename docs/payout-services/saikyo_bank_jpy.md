...
# Saikyo Bank (service) 
![saikyo_bank_jpy](https://static.openfintech.io/payout_methods/saikyo_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `saikyo_bank_jpy` 
 
**Method:** `saikyo_bank` [show -->](/payout-methods/saikyo_bank/) 

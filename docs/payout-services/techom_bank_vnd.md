...
# Techom Bank (service) 
![techom_bank_vnd](https://static.openfintech.io/payout_methods/techom_bank_vnd/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `techom_bank_vnd` 
 
**Method:** `techom_bank` [show -->](/payout-methods/techom_bank/) 

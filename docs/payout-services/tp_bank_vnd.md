...
# Tien Phong Commercial Joint Stock Bank (service) 
![tp_bank_vnd](https://static.openfintech.io/payout_methods/tp_bank_vnd/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `tp_bank_vnd` 
 
**Method:** `tp_bank` [show -->](/payout-methods/tp_bank/) 

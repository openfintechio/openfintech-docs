...
# GCB Bank Limited (service) 
![gcb_bank_limited_ghana_ghs](https://static.openfintech.io/payout_methods/gcb_bank_limited_ghana_ghs/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `gcb_bank_limited_ghana_ghs` 
 
**Method:** `gcb_bank_limited_ghana` [show -->](/payout-methods/gcb_bank_limited_ghana/) 

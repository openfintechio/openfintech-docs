...
# PSBank (Philippine Savings Bank) (service) 
![ps_bank_php](https://static.openfintech.io/payout_methods/ps_bank_php/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `ps_bank_php` 
 
**Method:** `ps_bank` [show -->](/payout-methods/ps_bank/) 

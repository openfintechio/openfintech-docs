...
# Bank Victoria (service) 
![bank_victoria_idr](https://static.openfintech.io/payout_methods/bank_victoria_idr/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `bank_victoria_idr` 
 
**Method:** `bank_victoria` [show -->](/payout-methods/bank_victoria/) 

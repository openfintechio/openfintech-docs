...
![guaranty_trust_bank_ngn](https://static.openfintech.io/payout_methods/guaranty_trust_bank_ngn/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `guaranty_trust_bank_ngn` 
 
**Method:** `guaranty_trust_bank` [show -->](/payout-methods/guaranty_trust_bank/) 

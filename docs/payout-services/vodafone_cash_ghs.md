...
![vodafone_cash_ghs](https://static.openfintech.io/payout_methods/vodafone_cash_ghs/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `vodafone_cash_ghs` 
 
**Method:** `vodafone_cash` [show -->](/payout-methods/vodafone_cash/) 

...
# Bank Zero, South Africa (service) 
![bank_zero_zar](https://static.openfintech.io/payout_methods/bank_zero_zar/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `bank_zero_zar` 
 
**Method:** `bank_zero` [show -->](/payout-methods/bank_zero/) 

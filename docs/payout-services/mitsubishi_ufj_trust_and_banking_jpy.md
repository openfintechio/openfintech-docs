...
# Mitsubishi UFJ Trust and Banking Corporation (service) 
![mitsubishi_ufj_trust_and_banking_jpy](https://static.openfintech.io/payout_methods/mitsubishi_ufj_trust_and_banking_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `mitsubishi_ufj_trust_and_banking_jpy` 
 
**Method:** `mitsubishi_ufj_trust_and_banking` [show -->](/payout-methods/mitsubishi_ufj_trust_and_banking/) 

...
# Grindrod Bank, South Africa (service) 
![grindrod_bank_zar](https://static.openfintech.io/payout_methods/grindrod_bank_zar/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `grindrod_bank_zar` 
 
**Method:** `grindrod_bank` [show -->](/payout-methods/grindrod_bank/) 

...
# Bank of Beijing (service) 
![bank_of_beijing_cny](https://static.openfintech.io/payout_methods/bank_of_beijing_cny/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `bank_of_beijing_cny` 
 
**Method:** `bank_of_beijing` [show -->](/payout-methods/bank_of_beijing/) 

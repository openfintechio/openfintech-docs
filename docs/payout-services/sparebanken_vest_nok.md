...
# Sparebanken Vest (service) 
![sparebanken_vest_nok](https://static.openfintech.io/payout_methods/sparebanken_vest_nok/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `sparebanken_vest_nok` 
 
**Method:** `sparebanken_vest` [show -->](/payout-methods/sparebanken_vest/) 

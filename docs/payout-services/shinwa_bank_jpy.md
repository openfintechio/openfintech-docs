...
# Shinwa Bank (service) 
![shinwa_bank_jpy](https://static.openfintech.io/payout_methods/shinwa_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `shinwa_bank_jpy` 
 
**Method:** `shinwa_bank` [show -->](/payout-methods/shinwa_bank/) 

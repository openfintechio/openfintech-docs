...
# Tokyo Star Bank (service) 
![tokyo_star_bank_jpy](https://static.openfintech.io/payout_methods/tokyo_star_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `tokyo_star_bank_jpy` 
 
**Method:** `tokyo_star_bank` [show -->](/payout-methods/tokyo_star_bank/) 

...
# Center Credit (service) 
![centercredit_bank_kzt](https://static.openfintech.io/payout_methods/centercredit_bank_kzt/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `centercredit_bank_kzt` 
 
**Method:** `centercredit_bank` [show -->](/payout-methods/centercredit_bank/) 

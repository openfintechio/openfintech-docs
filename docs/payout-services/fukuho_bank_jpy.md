...
# Fukuho Bank (service) 
![fukuho_bank_jpy](https://static.openfintech.io/payout_methods/fukuho_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `fukuho_bank_jpy` 
 
**Method:** `fukuho_bank` [show -->](/payout-methods/fukuho_bank/) 

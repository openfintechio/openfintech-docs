...
# Osaka Shinkin Bank (service) 
![osaka_shinkin_bank_jpy](https://static.openfintech.io/payout_methods/osaka_shinkin_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `osaka_shinkin_bank_jpy` 
 
**Method:** `osaka_shinkin_bank` [show -->](/payout-methods/osaka_shinkin_bank/) 

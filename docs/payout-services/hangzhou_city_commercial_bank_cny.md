...
# Hangzhou City Commercial Bank (service) 
![hangzhou_city_commercial_bank_cny](https://static.openfintech.io/payout_methods/hangzhou_city_commercial_bank_cny/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `hangzhou_city_commercial_bank_cny` 
 
**Method:** `hangzhou_city_commercial_bank` [show -->](/payout-methods/hangzhou_city_commercial_bank/) 

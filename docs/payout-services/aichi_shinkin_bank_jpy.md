...
# Aichi Shinkin Bank (service) 
![aichi_shinkin_bank_jpy](https://static.openfintech.io/payout_methods/aichi_shinkin_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `aichi_shinkin_bank_jpy` 
 
**Method:** `aichi_shinkin_bank` [show -->](/payout-methods/aichi_shinkin_bank/) 

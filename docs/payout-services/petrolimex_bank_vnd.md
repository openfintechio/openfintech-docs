...
# Petrolimex Group Commercial Joint Stock Bank (service) 
![petrolimex_bank_vnd](https://static.openfintech.io/payout_methods/petrolimex_bank_vnd/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `petrolimex_bank_vnd` 
 
**Method:** `petrolimex_bank` [show -->](/payout-methods/petrolimex_bank/) 

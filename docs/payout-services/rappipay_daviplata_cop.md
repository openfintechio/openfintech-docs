...
# Rappipay Daviplata (service) 
![rappipay_daviplata_cop](https://static.openfintech.io/payout_methods/rappipay_daviplata_cop/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `rappipay_daviplata_cop` 
 
**Method:** `rappipay_daviplata` [show -->](/payout-methods/rappipay_daviplata/) 

...
# Panin Bank (service) 
![panin_bank_idr](https://static.openfintech.io/payout_methods/panin_bank_idr/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `panin_bank_idr` 
 
**Method:** `panin_bank` [show -->](/payout-methods/panin_bank/) 

...
# First Bank of Nigeria (service) 
![first_bank_of_nigeria_nigeria_ngn](https://static.openfintech.io/payout_methods/first_bank_of_nigeria_nigeria_ngn/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `first_bank_of_nigeria_nigeria_ngn` 
 
**Method:** `first_bank_of_nigeria_nigeria` [show -->](/payout-methods/first_bank_of_nigeria_nigeria/) 
...
**Amount limits:** from `14` to `14411200` NGN 
...
{
  "code":"first_bank_of_nigeria_nigeria_ngn",
  "method":"first_bank_of_nigeria_nigeria",
  "currency":"NGN",
  "fields":[
    {
      "key":"account_number",

...
# Bank Harda Internasional (service) 
![bank_harda_internasional_idr](https://static.openfintech.io/payout_methods/bank_harda_internasional_idr/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `bank_harda_internasional_idr` 
 
**Method:** `bank_harda_internasional` [show -->](/payout-methods/bank_harda_internasional/) 

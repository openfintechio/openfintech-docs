...
# KakaoBank Corp. (service) 
![kakao_bank_krw](https://static.openfintech.io/payout_methods/kakao_bank_krw/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `kakao_bank_krw` 
 
**Method:** `kakao_bank` [show -->](/payout-methods/kakao_bank/) 

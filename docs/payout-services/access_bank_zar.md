...
# Access Bank (service) 
![access_bank_zar](https://static.openfintech.io/payout_methods/access_bank_zar/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `access_bank_zar` 
 
**Method:** `access_bank` [show -->](/payout-methods/access_bank/) 

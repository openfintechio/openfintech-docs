...
# SHUNDE RURAL CREDIT UNION (service) 
![shude_rural_credit_union_cny](https://static.openfintech.io/payout_methods/shude_rural_credit_union_cny/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `shude_rural_credit_union_cny` 
 
**Method:** `shude_rural_credit_union` [show -->](/payout-methods/shude_rural_credit_union/) 

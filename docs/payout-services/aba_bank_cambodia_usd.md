...
# Advanced Bank of Asia (service) 
![aba_bank_cambodia_usd](https://static.openfintech.io/payout_methods/aba_bank_cambodia_usd/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `aba_bank_cambodia_usd` 
 
**Method:** `aba_bank_cambodia` [show -->](/payout-methods/aba_bank_cambodia/) 

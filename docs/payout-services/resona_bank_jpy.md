...
# Resona Bank (service) 
![resona_bank_jpy](https://static.openfintech.io/payout_methods/resona_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `resona_bank_jpy` 
 
**Method:** `resona_bank` [show -->](/payout-methods/resona_bank/) 

...
# Co-operative Bank of Kenya Ltd (service) 
![cooperative_bank_of_kenya_ltd_kes](https://static.openfintech.io/payout_methods/cooperative_bank_of_kenya_ltd_kes/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `cooperative_bank_of_kenya_ltd_kes` 
 
**Method:** `cooperative_bank_of_kenya_ltd` [show -->](/payout-methods/cooperative_bank_of_kenya_ltd/) 

...
# Bank Nagari (service) 
![bank_nagari_idr](https://static.openfintech.io/payout_methods/bank_nagari_idr/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `bank_nagari_idr` 
 
**Method:** `bank_nagari` [show -->](/payout-methods/bank_nagari/) 

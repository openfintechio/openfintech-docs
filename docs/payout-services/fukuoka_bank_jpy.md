...
# Fukuoka Bank (service) 
![fukuoka_bank_jpy](https://static.openfintech.io/payout_methods/fukuoka_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `fukuoka_bank_jpy` 
 
**Method:** `fukuoka_bank` [show -->](/payout-methods/fukuoka_bank/) 

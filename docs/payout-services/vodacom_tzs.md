...
# Vodacom Mpesa (service) 
![vodacom_tzs](https://static.openfintech.io/payout_methods/vodacom_tzs/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `vodacom_tzs` 
 
**Method:** `vodacom` [show -->](/payout-methods/vodacom/) 

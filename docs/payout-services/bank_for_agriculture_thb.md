...
# Bank for Agriculture (service) 
![bank_for_agriculture_thb](https://static.openfintech.io/payout_methods/bank_for_agriculture_thb/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `bank_for_agriculture_thb` 
 
**Method:** `bank_for_agriculture` [show -->](/payout-methods/bank_for_agriculture/) 
...
|`beneficiary_last_name`|✔|`string`|`/^[A-Za-zА-Яа-я\-\d\s]{2,100}$/`| 

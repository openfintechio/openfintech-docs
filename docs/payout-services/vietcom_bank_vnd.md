...
![vietcom_bank_vnd](https://static.openfintech.io/payout_methods/vietcom_bank_vnd/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `vietcom_bank_vnd` 
 
**Method:** `vietcom_bank` [show -->](/payout-methods/vietcom_bank/) 

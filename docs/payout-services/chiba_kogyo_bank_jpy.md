...
# Chiba Kogyo Bank (service) 
![chiba_kogyo_bank_jpy](https://static.openfintech.io/payout_methods/chiba_kogyo_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `chiba_kogyo_bank_jpy` 
 
**Method:** `chiba_kogyo_bank` [show -->](/payout-methods/chiba_kogyo_bank/) 

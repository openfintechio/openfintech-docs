...
# Aozora Bank (service) 
![aozora_bank_jpy](https://static.openfintech.io/payout_methods/aozora_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `aozora_bank_jpy` 
 
**Method:** `aozora_bank` [show -->](/payout-methods/aozora_bank/) 

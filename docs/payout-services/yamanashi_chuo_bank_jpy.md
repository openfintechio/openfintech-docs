...
# Yamanashi Chuo Bank (service) 
![yamanashi_chuo_bank_jpy](https://static.openfintech.io/payout_methods/yamanashi_chuo_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `yamanashi_chuo_bank_jpy` 
 
**Method:** `yamanashi_chuo_bank` [show -->](/payout-methods/yamanashi_chuo_bank/) 

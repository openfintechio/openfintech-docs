...
# Canara Bank (service) 
![canara_bank_inr](https://static.openfintech.io/payout_methods/canara_bank_inr/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `canara_bank_inr` 
 
**Method:** `canara_bank` [show -->](/payout-methods/canara_bank/) 

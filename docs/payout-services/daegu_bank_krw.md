...
# DGB Daegu Bank (service) 
![daegu_bank_krw](https://static.openfintech.io/payout_methods/daegu_bank_krw/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `daegu_bank_krw` 
 
**Method:** `daegu_bank` [show -->](/payout-methods/daegu_bank/) 

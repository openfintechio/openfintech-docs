...
# Moniepoint MFB (service) 
![moniepoint_mfb_nigeria_ngn](https://static.openfintech.io/payout_methods/moniepoint_mfb_nigeria_ngn/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `moniepoint_mfb_nigeria_ngn` 
 
**Method:** `moniepoint_mfb_nigeria` [show -->](/payout-methods/moniepoint_mfb_nigeria/) 

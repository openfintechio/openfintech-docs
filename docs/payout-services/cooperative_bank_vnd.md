...
# Co-operative Bank of Viet Nam (service) 
![cooperative_bank_vnd](https://static.openfintech.io/payout_methods/cooperative_bank_vnd/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `cooperative_bank_vnd` 
 
**Method:** `cooperative_bank` [show -->](/payout-methods/cooperative_bank/) 

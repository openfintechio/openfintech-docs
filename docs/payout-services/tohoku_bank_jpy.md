...
# Tohoku Bank (service) 
![tohoku_bank_jpy](https://static.openfintech.io/payout_methods/tohoku_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `tohoku_bank_jpy` 
 
**Method:** `tohoku_bank` [show -->](/payout-methods/tohoku_bank/) 

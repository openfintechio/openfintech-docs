...
# National Credit Union Federation of Korea (service) 
![credit_union_bank_krw](https://static.openfintech.io/payout_methods/credit_union_bank_krw/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `credit_union_bank_krw` 
 
**Method:** `credit_union_bank` [show -->](/payout-methods/credit_union_bank/) 

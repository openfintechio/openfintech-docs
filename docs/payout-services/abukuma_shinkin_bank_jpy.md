...
# Abukuma Shinkin Bank (service) 
![abukuma_shinkin_bank_jpy](https://static.openfintech.io/payout_methods/abukuma_shinkin_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `abukuma_shinkin_bank_jpy` 
 
**Method:** `abukuma_shinkin_bank` [show -->](/payout-methods/abukuma_shinkin_bank/) 

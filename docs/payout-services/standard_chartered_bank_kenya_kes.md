...
# Standard Chartered Bank Kenya (service) 
![standard_chartered_bank_kenya_kes](https://static.openfintech.io/payout_methods/standard_chartered_bank_kenya_kes/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `standard_chartered_bank_kenya_kes` 
 
**Method:** `standard_chartered_bank_kenya` [show -->](/payout-methods/standard_chartered_bank_kenya/) 

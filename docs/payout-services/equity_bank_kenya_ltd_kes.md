...
# Equity Bank Kenya Ltd (service) 
![equity_bank_kenya_ltd_kes](https://static.openfintech.io/payout_methods/equity_bank_kenya_ltd_kes/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `equity_bank_kenya_ltd_kes` 
 
**Method:** `equity_bank_kenya_ltd` [show -->](/payout-methods/equity_bank_kenya_ltd/) 

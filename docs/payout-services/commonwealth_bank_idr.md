...
![commonwealth_bank_idr](https://static.openfintech.io/payout_methods/commonwealth_bank_idr/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `commonwealth_bank_idr` 
 
**Method:** `commonwealth_bank` [show -->](/payout-methods/commonwealth_bank/) 

...
# Aomori Bank (service) 
![aomori_bank_jpy](https://static.openfintech.io/payout_methods/aomori_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `aomori_bank_jpy` 
 
**Method:** `aomori_bank` [show -->](/payout-methods/aomori_bank/) 

...
# Banko de Oro Corporate Account (service) 
![banko_de_oro_corporate_php](https://static.openfintech.io/payout_methods/banko_de_oro_corporate_php/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `banko_de_oro_corporate_php` 
 
**Method:** `banko_de_oro_corporate` [show -->](/payout-methods/banko_de_oro_corporate/) 

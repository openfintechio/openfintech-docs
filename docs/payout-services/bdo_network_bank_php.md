...
# BDO Network Bank (service) 
![bdo_network_bank_php](https://static.openfintech.io/payout_methods/bdo_network_bank_php/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `bdo_network_bank_php` 
 
**Method:** `bdo_network_bank` [show -->](/payout-methods/bdo_network_bank/) 

...
# Ikeda Senshu Bank (service) 
![ikeda_senshu_bank_jpy](https://static.openfintech.io/payout_methods/ikeda_senshu_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `ikeda_senshu_bank_jpy` 
 
**Method:** `ikeda_senshu_bank` [show -->](/payout-methods/ikeda_senshu_bank/) 

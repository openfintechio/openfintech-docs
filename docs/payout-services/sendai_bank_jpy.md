...
# Sendai Bank (service) 
![sendai_bank_jpy](https://static.openfintech.io/payout_methods/sendai_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `sendai_bank_jpy` 
 
**Method:** `sendai_bank` [show -->](/payout-methods/sendai_bank/) 

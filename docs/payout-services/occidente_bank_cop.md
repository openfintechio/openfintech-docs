...
![occidente_bank_cop](https://static.openfintech.io/payout_methods/occidente_bank_cop/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `occidente_bank_cop` 
 
**Method:** `occidente_bank` [show -->](/payout-methods/occidente_bank/) 

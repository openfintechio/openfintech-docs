...
# Miyazaki Taiyo Bank (service) 
![miyazaki_taiyo_bank_jpy](https://static.openfintech.io/payout_methods/miyazaki_taiyo_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `miyazaki_taiyo_bank_jpy` 
 
**Method:** `miyazaki_taiyo_bank` [show -->](/payout-methods/miyazaki_taiyo_bank/) 

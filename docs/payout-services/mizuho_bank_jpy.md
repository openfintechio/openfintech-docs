...
# Mizuho Bank (service) 
![mizuho_bank_jpy](https://static.openfintech.io/payout_methods/mizuho_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `mizuho_bank_jpy` 
 
**Method:** `mizuho_bank` [show -->](/payout-methods/mizuho_bank/) 

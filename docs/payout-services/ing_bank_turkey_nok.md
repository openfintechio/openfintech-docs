...
# ING Bank Turkey (service) 
![ing_bank_turkey_nok](https://static.openfintech.io/payout_methods/ing_bank_turkey_nok/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `ing_bank_turkey_nok` 
 
**Method:** `ing_bank_turkey` [show -->](/payout-methods/ing_bank_turkey/) 

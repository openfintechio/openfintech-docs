...
# Stanbic Bank Ghana Limited (service) 
![stanbic_bank_ghana_limited_ghs](https://static.openfintech.io/payout_methods/stanbic_bank_ghana_limited_ghs/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `stanbic_bank_ghana_limited_ghs` 
 
**Method:** `stanbic_bank_ghana_limited` [show -->](/payout-methods/stanbic_bank_ghana_limited/) 

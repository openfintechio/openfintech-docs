...
# Fukui Bank (service) 
![fukui_bank_jpy](https://static.openfintech.io/payout_methods/fukui_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `fukui_bank_jpy` 
 
**Method:** `fukui_bank` [show -->](/payout-methods/fukui_bank/) 

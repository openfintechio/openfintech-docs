...
![industrial_bank_of_korea_krw_hpp](https://static.openfintech.io/payout_methods/industrial_bank_of_korea_krw_hpp/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `industrial_bank_of_korea_krw_hpp` 
 
**Method:** `industrial_bank_of_korea` [show -->](/payout-methods/industrial_bank_of_korea/) 

...
# Kagawa Bank (service) 
![kagawa_bank_jpy](https://static.openfintech.io/payout_methods/kagawa_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `kagawa_bank_jpy` 
 
**Method:** `kagawa_bank` [show -->](/payout-methods/kagawa_bank/) 

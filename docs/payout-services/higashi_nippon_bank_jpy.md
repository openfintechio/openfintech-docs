...
# Higashi-Nippon Bank (service) 
![higashi_nippon_bank_jpy](https://static.openfintech.io/payout_methods/higashi_nippon_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `higashi_nippon_bank_jpy` 
 
**Method:** `higashi_nippon_bank` [show -->](/payout-methods/higashi_nippon_bank/) 

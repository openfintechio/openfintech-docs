...
# Tsukuba Bank (service) 
![tsukuba_bank_jpy](https://static.openfintech.io/payout_methods/tsukuba_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `tsukuba_bank_jpy` 
 
**Method:** `tsukuba_bank` [show -->](/payout-methods/tsukuba_bank/) 

...
# Hokkoku Bank (service) 
![hokkoku_bank_jpy](https://static.openfintech.io/payout_methods/hokkoku_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `hokkoku_bank_jpy` 
 
**Method:** `hokkoku_bank` [show -->](/payout-methods/hokkoku_bank/) 

...
![coopcentral_cop](https://static.openfintech.io/payout_methods/coopcentral_cop/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `coopcentral_cop` 
 
**Method:** `coopcentral` [show -->](/payout-methods/coopcentral/) 

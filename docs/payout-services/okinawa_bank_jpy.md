...
# Okinawa Bank (service) 
![okinawa_bank_jpy](https://static.openfintech.io/payout_methods/okinawa_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `okinawa_bank_jpy` 
 
**Method:** `okinawa_bank` [show -->](/payout-methods/okinawa_bank/) 

...
# Union Bank of Nigeria (service) 
![union_bankof_nigeria_ngn](https://static.openfintech.io/payout_methods/union_bankof_nigeria_ngn/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `union_bankof_nigeria_ngn` 
 
**Method:** `union_bankof_nigeria` [show -->](/payout-methods/union_bankof_nigeria/) 

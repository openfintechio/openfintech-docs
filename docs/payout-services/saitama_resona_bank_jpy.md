...
# Saitama Resona Bank (service) 
![saitama_resona_bank_jpy](https://static.openfintech.io/payout_methods/saitama_resona_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `saitama_resona_bank_jpy` 
 
**Method:** `saitama_resona_bank` [show -->](/payout-methods/saitama_resona_bank/) 

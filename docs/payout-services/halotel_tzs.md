...
# Halotel (service) 
![halotel_tzs](https://static.openfintech.io/payout_methods/halotel_tzs/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `halotel_tzs` 
 
**Method:** `halotel` [show -->](/payout-methods/halotel/) 
...
**Amount limits:** from `1` to `1000000` TZS 

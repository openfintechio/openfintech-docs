...
# Robinsons Bank CA/SA (service) 
![robinsons_bank_php](https://static.openfintech.io/payout_methods/robinsons_bank_php/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `robinsons_bank_php` 
 
**Method:** `robinsons_bank` [show -->](/payout-methods/robinsons_bank/) 

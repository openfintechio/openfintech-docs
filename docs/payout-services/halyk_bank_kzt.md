...
# Halyk Bank (service) 
![halyk_bank_kzt](https://static.openfintech.io/payout_methods/halyk_bank_kzt/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `halyk_bank_kzt` 
 
**Method:** `halyk_bank` [show -->](/payout-methods/halyk_bank/) 

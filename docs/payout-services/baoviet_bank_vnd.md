...
# Baoviet Joint Stock Commercial Bank (service) 
![baoviet_bank_vnd](https://static.openfintech.io/payout_methods/baoviet_bank_vnd/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `baoviet_bank_vnd` 
 
**Method:** `baoviet_bank` [show -->](/payout-methods/baoviet_bank/) 

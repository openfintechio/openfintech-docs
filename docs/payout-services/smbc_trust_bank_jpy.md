...
# SMBC Trust Bank Ltd. (service) 
![smbc_trust_bank_jpy](https://static.openfintech.io/payout_methods/smbc_trust_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `smbc_trust_bank_jpy` 
 
**Method:** `smbc_trust_bank` [show -->](/payout-methods/smbc_trust_bank/) 

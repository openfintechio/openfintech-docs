...
# Tisco Bank (service) 
![tisco_bank_thb](https://static.openfintech.io/payout_methods/tisco_bank_thb/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `tisco_bank_thb` 
 
**Method:** `tisco_bank` [show -->](/payout-methods/tisco_bank/) 

...
# Tama Shinkin Bank (service) 
![tama_shinkin_bank_jpy](https://static.openfintech.io/payout_methods/tama_shinkin_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `tama_shinkin_bank_jpy` 
 
**Method:** `tama_shinkin_bank` [show -->](/payout-methods/tama_shinkin_bank/) 

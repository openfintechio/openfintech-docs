...
# Iwate Bank (service) 
![iwate_bank_jpy](https://static.openfintech.io/payout_methods/iwate_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `iwate_bank_jpy` 
 
**Method:** `iwate_bank` [show -->](/payout-methods/iwate_bank/) 

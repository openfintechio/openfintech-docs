...
# Shonai Bank (service) 
![shonai_bank_jpy](https://static.openfintech.io/payout_methods/shonai_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `shonai_bank_jpy` 
 
**Method:** `shonai_bank` [show -->](/payout-methods/shonai_bank/) 

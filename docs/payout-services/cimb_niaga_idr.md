...
# Bank CIMB Niaga (service) 
![cimb_niaga_idr](https://static.openfintech.io/payout_methods/cimb_niaga_idr/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `cimb_niaga_idr` 
 
**Method:** `cimb_niaga` [show -->](/payout-methods/cimb_niaga/) 

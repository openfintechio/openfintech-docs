...
# Rand Merchant Bank (service) 
![rand_merchant_bank_zar](https://static.openfintech.io/payout_methods/rand_merchant_bank_zar/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `rand_merchant_bank_zar` 
 
**Method:** `rand_merchant_bank` [show -->](/payout-methods/rand_merchant_bank/) 

...
# The Kyoto Shinkin Bank (service) 
![kyoto_shinkin_bank_jpy](https://static.openfintech.io/payout_methods/kyoto_shinkin_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `kyoto_shinkin_bank_jpy` 
 
**Method:** `kyoto_shinkin_bank` [show -->](/payout-methods/kyoto_shinkin_bank/) 

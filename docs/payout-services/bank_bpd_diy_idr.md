...
# Bank BPD DIY (service) 
![bank_bpd_diy_idr](https://static.openfintech.io/payout_methods/bank_bpd_diy_idr/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `bank_bpd_diy_idr` 
 
**Method:** `bank_bpd_diy` [show -->](/payout-methods/bank_bpd_diy/) 

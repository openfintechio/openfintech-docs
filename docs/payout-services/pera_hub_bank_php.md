...
# PeraHub (service) 
![pera_hub_bank_php](https://static.openfintech.io/payout_methods/pera_hub_bank_php/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `pera_hub_bank_php` 
 
**Method:** `pera_hub_bank` [show -->](/payout-methods/pera_hub_bank/) 

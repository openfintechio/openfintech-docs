...
# KB Financial Group (service) 
![kbfg_bank_krw](https://static.openfintech.io/payout_methods/kbfg_bank_krw/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `kbfg_bank_krw` 
 
**Method:** `kbfg_bank` [show -->](/payout-methods/kbfg_bank/) 

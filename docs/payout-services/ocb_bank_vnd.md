...
# Orient Commercial Joint Stock Bank (service) 
![ocb_bank_vnd](https://static.openfintech.io/payout_methods/ocb_bank_vnd/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `ocb_bank_vnd` 
 
**Method:** `ocb_bank` [show -->](/payout-methods/ocb_bank/) 

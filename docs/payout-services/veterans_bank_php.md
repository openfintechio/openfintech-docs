...
# Veterans Bank (Philippine Veterans Bank) (service) 
![veterans_bank_php](https://static.openfintech.io/payout_methods/veterans_bank_php/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `veterans_bank_php` 
 
**Method:** `veterans_bank` [show -->](/payout-methods/veterans_bank/) 

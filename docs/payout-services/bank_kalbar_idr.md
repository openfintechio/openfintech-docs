...
# Bank Kalbar (service) 
![bank_kalbar_idr](https://static.openfintech.io/payout_methods/bank_kalbar_idr/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `bank_kalbar_idr` 
 
**Method:** `bank_kalbar` [show -->](/payout-methods/bank_kalbar/) 

...
# IDFC BANK (service) 
![idfc_bank_india_inr](https://static.openfintech.io/payout_methods/idfc_bank_india_inr/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `idfc_bank_india_inr` 
 
**Method:** `idfc_bank_india` [show -->](/payout-methods/idfc_bank_india/) 

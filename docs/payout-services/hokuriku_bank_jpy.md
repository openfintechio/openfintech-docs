...
# Hokuriku Bank (service) 
![hokuriku_bank_jpy](https://static.openfintech.io/payout_methods/hokuriku_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `hokuriku_bank_jpy` 
 
**Method:** `hokuriku_bank` [show -->](/payout-methods/hokuriku_bank/) 

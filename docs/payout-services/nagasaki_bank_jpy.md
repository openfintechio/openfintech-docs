...
# Nagasaki Bank (service) 
![nagasaki_bank_jpy](https://static.openfintech.io/payout_methods/nagasaki_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `nagasaki_bank_jpy` 
 
**Method:** `nagasaki_bank` [show -->](/payout-methods/nagasaki_bank/) 

...
# Olympus Mobile Bank, South Africa (service) 
![olympus_mobile_bank_zar](https://static.openfintech.io/payout_methods/olympus_mobile_bank_zar/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `olympus_mobile_bank_zar` 
 
**Method:** `olympus_mobile_bank` [show -->](/payout-methods/olympus_mobile_bank/) 

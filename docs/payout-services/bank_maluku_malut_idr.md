...
# Bank Maluku Malut (service) 
![bank_maluku_malut_idr](https://static.openfintech.io/payout_methods/bank_maluku_malut_idr/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `bank_maluku_malut_idr` 
 
**Method:** `bank_maluku_malut` [show -->](/payout-methods/bank_maluku_malut/) 

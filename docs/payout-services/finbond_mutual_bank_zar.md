...
# Finbond Mutual Bank, South Africa (service) 
![finbond_mutual_bank_zar](https://static.openfintech.io/payout_methods/finbond_mutual_bank_zar/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `finbond_mutual_bank_zar` 
 
**Method:** `finbond_mutual_bank` [show -->](/payout-methods/finbond_mutual_bank/) 

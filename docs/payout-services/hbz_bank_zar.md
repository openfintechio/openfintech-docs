...
# HBZ Bank (Westville) (service) 
![hbz_bank_zar](https://static.openfintech.io/payout_methods/hbz_bank_zar/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `hbz_bank_zar` 
 
**Method:** `hbz_bank` [show -->](/payout-methods/hbz_bank/) 

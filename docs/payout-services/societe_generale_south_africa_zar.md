...
# Société Générale South Africa (service) 
![societe_generale_south_africa_zar](https://static.openfintech.io/payout_methods/societe_generale_south_africa_zar/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `societe_generale_south_africa_zar` 
 
**Method:** `societe_generale_south_africa` [show -->](/payout-methods/societe_generale_south_africa/) 
...
**Amount limits:** from `1` to `10000000` ZAR 

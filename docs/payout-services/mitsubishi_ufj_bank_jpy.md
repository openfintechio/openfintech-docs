...
# Mitsubishi UFJ Bank (service) 
![mitsubishi_ufj_bank_jpy](https://static.openfintech.io/payout_methods/mitsubishi_ufj_bank_jpy/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `mitsubishi_ufj_bank_jpy` 
 
**Method:** `mitsubishi_ufj_bank` [show -->](/payout-methods/mitsubishi_ufj_bank/) 

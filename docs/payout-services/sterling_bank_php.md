...
# Sterling Bank (service) 
![sterling_bank_php](https://static.openfintech.io/payout_methods/sterling_bank_php/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `sterling_bank_php` 
 
**Method:** `sterling_bank` [show -->](/payout-methods/sterling_bank/) 

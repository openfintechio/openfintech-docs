...
# DenizBank (service) 
![deniz_bank_try](https://static.openfintech.io/payout_methods/deniz_bank_try/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `deniz_bank_try` 
 
**Method:** `deniz_bank` [show -->](/payout-methods/deniz_bank/) 

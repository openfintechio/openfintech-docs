...
# OCBC (OCBC Bank) (service) 
![ocbc_bank_myr](https://static.openfintech.io/payout_methods/ocbc_bank_myr/logo.svg?w=400&c=v0.59.26#w24)  

## General 
 
**Code:** `ocbc_bank_myr` 
 
**Method:** `ocbc_bank` [show -->](/payout-methods/ocbc_bank/) 

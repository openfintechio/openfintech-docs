...
# payD 
![payd](https://static.openfintech.io/payment_methods/payd/logo.svg?w=400&c=v0.59.26#w200)  

## General 
**Code:** `payd` 
 
**Vendor:** `payd` [show -->](/vendors/payd/) 
...
```
https://static.openfintech.io/payment_methods/payd/logo.svg?w=400&c=v0.59.26#w200
```  

### Icon 
![payd](https://static.openfintech.io/payment_methods/payd/icon.svg?w=278&c=v0.59.26#w100)  

```
https://static.openfintech.io/payment_methods/payd/icon.svg?w=278&c=v0.59.26#w100
```  

## Payment Providers 
 
The list of [Payment Providers](/payment-providers/) that support the _payD_ 

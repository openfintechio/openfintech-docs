...
# Ceská Sporitelna 
![ceskasporitelna](https://static.openfintech.io/payment_methods/ceskasporitelna/logo.png?w=400&c=v0.59.26#w200)  

## General 
**Code:** `ceskasporitelna` 
 
**Vendor:** `ceskasporitelna` [show -->](/vendors/ceskasporitelna/) 
...
```
https://static.openfintech.io/payment_methods/ceskasporitelna/logo.png?w=400&c=v0.59.26#w200
```  

### Icon 
![ceskasporitelna](https://static.openfintech.io/payment_methods/ceskasporitelna/icon.png?w=278&c=v0.59.26#w100)  

```
https://static.openfintech.io/payment_methods/ceskasporitelna/icon.png?w=278&c=v0.59.26#w100
```  

## Payment Providers 
 
The list of [Payment Providers](/payment-providers/) that support the _Ceská Sporitelna_ 

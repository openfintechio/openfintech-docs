...
# Klarna 
![klarna](https://static.openfintech.io/payment_methods/klarna/logo.svg?w=400&c=v0.59.26#w200)  
...
```
https://static.openfintech.io/payment_methods/klarna/logo.svg?w=400&c=v0.59.26#w200
```  

### Icon 
![klarna](https://static.openfintech.io/payment_methods/klarna/icon.svg?w=278&c=v0.59.26#w100)  

```
https://static.openfintech.io/payment_methods/klarna/icon.svg?w=278&c=v0.59.26#w100
```  

## Payment Services 
 
The list of [Payment Services](#) based on the _Klarna_ 

|Icon|Name|Code| 
|:---:|:---:|:---:| 
|![klarna](https://static.openfintech.io/payment_methods/klarna/icon.svg?w=278&c=v0.59.26#w100) |[klarna_eur_hpp](#)|`klarna_eur_hpp`| 
 

## Payment Providers 
 
The list of [Payment Providers](/providers) that support the _Klarna_ 

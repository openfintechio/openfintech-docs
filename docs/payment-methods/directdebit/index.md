...
The list of [Payment Services](#) based on the _Direct Debit_ 

|Icon|Name|Code| 
|:---:|:---:|:---:| 
|![directdebit](https://static.openfintech.io/payment_methods/directdebit/icon.png?w=278&c=v0.59.26#w100) |[directdebit_eur_hpp](#)|`directdebit_eur_hpp`| 
 

## Payment Providers 
 
The list of [Payment Providers](/providers) that support the _Direct Debit_ 

...
The list of [Payment Services](#) based on the _Skrill Wallet_ 

|Icon|Name|Code| 
|:---:|:---:|:---:| 
|![skrill](https://static.openfintech.io/payment_methods/skrill/icon.svg?w=278&c=v0.59.26#w100) |[skrill_eur_hpp](#)|`skrill_eur_hpp`| 
 

## Payment Providers 
 
The list of [Payment Providers](/providers) that support the _Skrill Wallet_ 

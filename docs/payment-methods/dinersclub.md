...
![dinersclub](https://static.openfintech.io/payment_methods/dinersclub/logo.svg?w=400&c=v0.59.26#w200)  

## General 
**Code:** `dinersclub` 
 
**Vendor:** `dinersclub` [show -->](/vendors/dinersclub/) 
...
```
https://static.openfintech.io/payment_methods/dinersclub/logo.svg?w=400&c=v0.59.26#w200
```  

### Icon 
![dinersclub](https://static.openfintech.io/payment_methods/dinersclub/icon.svg?w=278&c=v0.59.26#w100)  

```
https://static.openfintech.io/payment_methods/dinersclub/icon.svg?w=278&c=v0.59.26#w100
```  

## Payment Services 
 
The list of [Payment Services](/payment-services/) based on the _Diners Club International_ 
...
The list of [Payment Providers](/payment-providers/) that support the _Diners Club International_ 

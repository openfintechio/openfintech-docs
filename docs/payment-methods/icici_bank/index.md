...
The list of [Payment Services](#) based on the _ICICI Bank_ 

|Icon|Name|Code| 
|:---:|:---:|:---:| 
|![icici_bank](https://static.openfintech.io/payment_methods/icici_bank/icon.svg?w=278&c=v0.59.26#w100) |[icici_bank_inr_hpp](#)|`icici_bank_inr_hpp`| 
 

## Payment Providers 
 
The list of [Payment Providers](/providers) that support the _ICICI Bank_ 

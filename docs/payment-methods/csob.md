...
# CSOB 
![csob](https://static.openfintech.io/payment_methods/csob/logo.png?w=400&c=v0.59.26#w200)  

## General 
**Code:** `csob` 
 
**Vendor:** `csob` [show -->](/vendors/csob/) 
...
```
https://static.openfintech.io/payment_methods/csob/logo.png?w=400&c=v0.59.26#w200
```  

### Icon 
![csob](https://static.openfintech.io/payment_methods/csob/icon.png?w=278&c=v0.59.26#w100)  

```
https://static.openfintech.io/payment_methods/csob/icon.png?w=278&c=v0.59.26#w100
```  

## Payment Providers 
 
The list of [Payment Providers](/payment-providers/) that support the _CSOB_ 

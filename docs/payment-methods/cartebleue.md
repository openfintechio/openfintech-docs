...
# Carte Bleue 
![cartebleue](https://static.openfintech.io/payment_methods/cartebleue/logo.png?w=400&c=v0.59.26#w200)  

## General 
**Code:** `cartebleue` 
 
**Vendor:** `cartebleue` [show -->](/vendors/cartebleue/) 
...
```
https://static.openfintech.io/payment_methods/cartebleue/logo.png?w=400&c=v0.59.26#w200
```  

### Icon 
![cartebleue](https://static.openfintech.io/payment_methods/cartebleue/icon.png?w=278&c=v0.59.26#w100)  

```
https://static.openfintech.io/payment_methods/cartebleue/icon.png?w=278&c=v0.59.26#w100
```  

## Payment Services 
 
The list of [Payment Services](/payment-services/) based on the _Carte Bleue_ 

|Icon|Name|Code| 
|:---:|:---:|:---:| 
|![cartebleue](https://static.openfintech.io/payment_methods/cartebleue/icon.png?w=278&c=v0.59.26#w100) |[cartebleue_eur_hpp](/payment-services/cartebleue_eur_hpp/)|`cartebleue_eur_hpp`| 
 

## Payment Providers 
 
The list of [Payment Providers](/payment-providers/) that support the _Carte Bleue_ 

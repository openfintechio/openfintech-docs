...
# Aktia 
![aktia](https://static.openfintech.io/payment_methods/aktia/logo.png?w=400&c=v0.59.26#w200)  

## General 
**Code:** `aktia` 
 
**Vendor:** `aktia` [show -->](/vendors/aktia/) 
...
```
https://static.openfintech.io/payment_methods/aktia/logo.png?w=400&c=v0.59.26#w200
```  

### Icon 
![aktia](https://static.openfintech.io/payment_methods/aktia/icon.png?w=278&c=v0.59.26#w100)  

```
https://static.openfintech.io/payment_methods/aktia/icon.png?w=278&c=v0.59.26#w100
```  

## Payment Providers 
 
The list of [Payment Providers](/payment-providers/) that support the _Aktia_ 

...
# Discover 
![discover](https://static.openfintech.io/payment_methods/discover/logo.svg?w=400&c=v0.59.26#w200)  

## General 
**Code:** `discover` 
 
**Vendor:** `discover` [show -->](/vendors/discover/) 
...
```
https://static.openfintech.io/payment_methods/discover/logo.svg?w=400&c=v0.59.26#w200
```  

### Icon 
![discover](https://static.openfintech.io/payment_methods/discover/icon.svg?w=278&c=v0.59.26#w100)  

```
https://static.openfintech.io/payment_methods/discover/icon.svg?w=278&c=v0.59.26#w100
```  

## Payment Providers 
 
The list of [Payment Providers](/payment-providers/) that support the _Discover_ 

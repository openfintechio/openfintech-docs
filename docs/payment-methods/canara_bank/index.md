...
The list of [Payment Services](#) based on the _Canara Bank_ 

|Icon|Name|Code| 
|:---:|:---:|:---:| 
|![canara_bank](https://static.openfintech.io/payment_methods/canara_bank/icon.svg?w=278&c=v0.59.26#w100) |[canara_bank_inr_hpp](#)|`canara_bank_inr_hpp`| 
 

## Payment Providers 
 
The list of [Payment Providers](/providers) that support the _Canara Bank_ 

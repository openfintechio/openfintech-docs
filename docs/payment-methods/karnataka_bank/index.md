...
The list of [Payment Services](#) based on the _Karnataka Bank_ 

|Icon|Name|Code| 
|:---:|:---:|:---:| 
|![karnataka_bank](https://static.openfintech.io/payment_methods/karnataka_bank/icon.svg?w=278&c=v0.59.26#w100) |[karnataka_bank_inr_hpp](#)|`karnataka_bank_inr_hpp`| 
 

## Payment Providers 
 
The list of [Payment Providers](/providers) that support the _Karnataka Bank_ 

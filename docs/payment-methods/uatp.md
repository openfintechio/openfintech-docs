...
# UATP 
![uatp](https://static.openfintech.io/payment_methods/uatp/logo.png?w=400&c=v0.59.26#w200)  

## General 
**Code:** `uatp` 
 
**Vendor:** `uatp` [show -->](/vendors/uatp/) 
...
```
https://static.openfintech.io/payment_methods/uatp/logo.png?w=400&c=v0.59.26#w200
```  

### Icon 
![uatp](https://static.openfintech.io/payment_methods/uatp/icon.png?w=278&c=v0.59.26#w100)  

```
https://static.openfintech.io/payment_methods/uatp/icon.png?w=278&c=v0.59.26#w100
```  

## Payment Providers 
 
The list of [Payment Providers](/payment-providers/) that support the _UATP_ 

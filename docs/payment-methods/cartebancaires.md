...
# Carte Bancaires 
![cartebancaires](https://static.openfintech.io/payment_methods/cartebancaires/logo.svg?w=400&c=v0.59.26#w200)  

## General 
**Code:** `cartebancaires` 
 
**Vendor:** `cartebancaires` [show -->](/vendors/cartebancaires/) 
...
```
https://static.openfintech.io/payment_methods/cartebancaires/logo.svg?w=400&c=v0.59.26#w200
```  

### Icon 
![cartebancaires](https://static.openfintech.io/payment_methods/cartebancaires/icon.svg?w=278&c=v0.59.26#w100)  

```
https://static.openfintech.io/payment_methods/cartebancaires/icon.svg?w=278&c=v0.59.26#w100
```  

## Payment Providers 
 
The list of [Payment Providers](/payment-providers/) that support the _Carte Bancaires_ 

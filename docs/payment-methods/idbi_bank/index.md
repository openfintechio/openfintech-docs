...
The list of [Payment Services](#) based on the _IDBI Bank_ 

|Icon|Name|Code| 
|:---:|:---:|:---:| 
|![idbi_bank](https://static.openfintech.io/payment_methods/idbi_bank/icon.png?w=278&c=v0.59.26#w100) |[idbi_bank_inr_hpp](#)|`idbi_bank_inr_hpp`| 
 

## Payment Providers 
 
The list of [Payment Providers](/providers) that support the _IDBI Bank_ 

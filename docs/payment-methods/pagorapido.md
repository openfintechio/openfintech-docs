...
# PagoRapido 
![pagorapido](https://static.openfintech.io/payment_methods/pagorapido/logo.svg?w=400&c=v0.59.26#w200)  

## General 
**Code:** `pagorapido` 
 
**Vendor:** `pagorapido` [show -->](/vendors/pagorapido/) 
...
```
https://static.openfintech.io/payment_methods/pagorapido/logo.svg?w=400&c=v0.59.26#w200
```  

### Icon 
![pagorapido](https://static.openfintech.io/payment_methods/pagorapido/icon.svg?w=278&c=v0.59.26#w100)  

```
https://static.openfintech.io/payment_methods/pagorapido/icon.svg?w=278&c=v0.59.26#w100
```  

## Payment Providers 
 
The list of [Payment Providers](/payment-providers/) that support the _PagoRapido_ 

...
The list of [Payment Services](#) based on the _Bank Central Asia_ 

|Icon|Name|Code| 
|:---:|:---:|:---:| 
|![bank_central_asia](https://static.openfintech.io/payment_methods/bank_central_asia/icon.svg?w=278&c=v0.59.26#w100) |[bank_central_asia_idr_hpp](#)|`bank_central_asia_idr_hpp`| 
 

## Payment Providers 
 
The list of [Payment Providers](/providers) that support the _Bank Central Asia_ 

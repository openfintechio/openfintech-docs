...
# Hipercard 
![hipercard](https://static.openfintech.io/payment_methods/hipercard/logo.png?w=400&c=v0.59.26#w200)  

## General 
**Code:** `hipercard` 
 
**Vendor:** `hipercard` [show -->](/vendors/hipercard/) 
...
```
https://static.openfintech.io/payment_methods/hipercard/logo.png?w=400&c=v0.59.26#w200
```  

### Icon 
![hipercard](https://static.openfintech.io/payment_methods/hipercard/icon.png?w=278&c=v0.59.26#w100)  

```
https://static.openfintech.io/payment_methods/hipercard/icon.png?w=278&c=v0.59.26#w100
```  

## Payment Providers 
 
The list of [Payment Providers](/payment-providers/) that support the _Hipercard_ 

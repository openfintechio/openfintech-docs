...
The list of [Payment Services](#) based on the _Carte Bleue_ 

|Icon|Name|Code| 
|:---:|:---:|:---:| 
|![cartebleue](https://static.openfintech.io/payment_methods/cartebleue/icon.png?w=278&c=v0.59.26#w100) |[cartebleue_eur_hpp](#)|`cartebleue_eur_hpp`| 
 

## Payment Providers 
 
The list of [Payment Providers](/providers) that support the _Carte Bleue_ 

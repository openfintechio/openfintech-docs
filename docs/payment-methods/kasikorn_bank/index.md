...
The list of [Payment Services](#) based on the _Kasikorn Bank_ 

|Icon|Name|Code| 
|:---:|:---:|:---:| 
|![kasikorn_bank](https://static.openfintech.io/payment_methods/kasikorn_bank/icon.svg?w=278&c=v0.59.26#w100) |[kasikorn_bank_thb_hpp](#)|`kasikorn_bank_thb_hpp`| 
 

## Payment Providers 
 
The list of [Payment Providers](/providers) that support the _Kasikorn Bank_ 

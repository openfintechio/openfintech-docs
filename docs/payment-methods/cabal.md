...
# Cabal 
![cabal](https://static.openfintech.io/payment_methods/cabal/logo.png?w=400&c=v0.59.26#w200)  

## General 
**Code:** `cabal` 
 
**Vendor:** `cabal` [show -->](/vendors/cabal/) 
...
```
https://static.openfintech.io/payment_methods/cabal/logo.png?w=400&c=v0.59.26#w200
```  

### Icon 
![cabal](https://static.openfintech.io/payment_methods/cabal/icon.png?w=278&c=v0.59.26#w100)  

```
https://static.openfintech.io/payment_methods/cabal/icon.png?w=278&c=v0.59.26#w100
```  

## Payment Providers 
 
The list of [Payment Providers](/payment-providers/) that support the _Cabal_ 

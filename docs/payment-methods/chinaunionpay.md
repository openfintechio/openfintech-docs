...
# China UnionPay 
![chinaunionpay](https://static.openfintech.io/payment_methods/chinaunionpay/logo.svg?w=400&c=v0.59.26#w200)  

## General 
**Code:** `chinaunionpay` 
 
**Vendor:** `chinaunionpay` [show -->](/vendors/chinaunionpay/) 
...
```
https://static.openfintech.io/payment_methods/chinaunionpay/logo.svg?w=400&c=v0.59.26#w200
```  

### Icon 
![chinaunionpay](https://static.openfintech.io/payment_methods/chinaunionpay/icon.svg?w=278&c=v0.59.26#w100)  

```
https://static.openfintech.io/payment_methods/chinaunionpay/icon.svg?w=278&c=v0.59.26#w100
```  

## Payment Providers 
 
The list of [Payment Providers](/payment-providers/) that support the _China UnionPay_ 

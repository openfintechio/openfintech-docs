...
**Vendor:** `giropay` [show -->](/vendors/giropay/) 
...
The list of [Payment Services](/payment-services/) based on the _Giropay_ 
...
The list of [Payment Providers](/payment-providers/) that support the _Giropay_ 

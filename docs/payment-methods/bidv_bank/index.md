...
The list of [Payment Services](#) based on the _BIDV Bank_ 

|Icon|Name|Code| 
|:---:|:---:|:---:| 
|![bidv_bank](https://static.openfintech.io/payment_methods/bidv_bank/icon.svg?w=278&c=v0.59.26#w100) |[bidv_bank_vnd_hpp](#)|`bidv_bank_vnd_hpp`| 
 

## Payment Providers 
 
The list of [Payment Providers](/providers) that support the _BIDV Bank_ 

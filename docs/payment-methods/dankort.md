...
# Dankort 
![dankort](https://static.openfintech.io/payment_methods/dankort/logo.png?w=400&c=v0.59.26#w200)  

## General 
**Code:** `dankort` 
 
**Vendor:** `dankort` [show -->](/vendors/dankort/) 
...
```
https://static.openfintech.io/payment_methods/dankort/logo.png?w=400&c=v0.59.26#w200
```  

### Icon 
![dankort](https://static.openfintech.io/payment_methods/dankort/icon.png?w=278&c=v0.59.26#w100)  

```
https://static.openfintech.io/payment_methods/dankort/icon.png?w=278&c=v0.59.26#w100
```  

## Payment Services 
 
The list of [Payment Services](/payment-services/) based on the _Dankort_ 

|Icon|Name|Code| 
|:---:|:---:|:---:| 
|![dankort](https://static.openfintech.io/payment_methods/dankort/icon.png?w=278&c=v0.59.26#w100) |[dankort_eur_hpp](/payment-services/dankort_eur_hpp/)|`dankort_eur_hpp`| 
 

## Payment Providers 
 
The list of [Payment Providers](/payment-providers/) that support the _Dankort_ 

...
The list of [Payment Services](#) based on the _Megafon_ 

|Icon|Name|Code| 
|:---:|:---:|:---:| 
|![megafon](https://static.openfintech.io/payment_methods/megafon/icon.png?w=278&c=v0.59.26#w100) |[megafon_rub_hpp](#)|`megafon_rub_hpp`| 
 

## Payment Providers 
 
The list of [Payment Providers](/providers) that support the _Megafon_ 

...
The list of [Payment Services](#) based on the _Standard Charter Bank_ 

|Icon|Name|Code| 
|:---:|:---:|:---:| 
|![standard_charter_bank](https://static.openfintech.io/payment_methods/standard_charter_bank/icon.svg?w=278&c=v0.59.26#w100) |[standard_charter_bank_inr_hpp](#)|`standard_charter_bank_inr_hpp`| 
 

## Payment Providers 
 
The list of [Payment Providers](/providers) that support the _Standard Charter Bank_ 

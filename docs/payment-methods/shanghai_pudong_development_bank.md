...
The list of [Payment Services](/payment-services/) based on the _Shanghai Pudong Development Bank_ 

|Icon|Name|Code| 
|:---:|:---:|:---:| 
|![shanghai_pudong_development_bank](https://static.openfintech.io/payment_methods/shanghai_pudong_development_bank/icon.svg?w=278&c=v0.59.26#w100) |[shanghai_pudong_development_bank_cny_hpp](/payment-services/shanghai_pudong_development_bank_cny_hpp/)|`shanghai_pudong_development_bank_cny_hpp`| 

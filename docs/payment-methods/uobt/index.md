...
The list of [Payment Services](#) based on the _UOBT_ 

|Icon|Name|Code| 
|:---:|:---:|:---:| 
|![uobt](https://static.openfintech.io/payment_methods/uobt/icon.svg?w=278&c=v0.59.26#w100) |[uobt_thb_hpp](#)|`uobt_thb_hpp`| 
 

## Payment Providers 
 
The list of [Payment Providers](/providers) that support the _UOBT_ 

...
The list of [Payment Services](#) based on the _BRI Bank_ 

|Icon|Name|Code| 
|:---:|:---:|:---:| 
|![bri_bank](https://static.openfintech.io/payment_methods/bri_bank/icon.svg?w=278&c=v0.59.26#w100) |[bri_bank_cny_hpp](#)|`bri_bank_cny_hpp`| 
 

## Payment Providers 
 
The list of [Payment Providers](/providers) that support the _BRI Bank_ 
